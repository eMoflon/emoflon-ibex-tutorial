 ...
 * @generated
 */
public class AdministrationExampleSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public AdministrationExampleSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case AdministrationExamplePackage.SHIFTPLAN: {
			Shiftplan shiftplan = (Shiftplan) theEObject;
			T result = caseShiftplan(shiftplan);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Shiftplan</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Shiftplan</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseShiftplan(Shiftplan object) {
		return null;
	}
