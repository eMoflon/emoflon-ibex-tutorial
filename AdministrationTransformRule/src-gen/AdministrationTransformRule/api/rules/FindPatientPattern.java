...
import AdministrationTransformRule.api.matches.FindPatientMatch;
...
/**
 * The pattern [org.emoflon.ibex.patternmodel.IBeXPatternModel.impl.IBeXNodeImpl@fdebd6c (name: patient)] which does the following:
...
public class FindPatientPattern extends GraphTransformationPattern<FindPatientMatch, FindPatientPattern> {
	...
	public FindPatientPattern(final AdministrationTransformRuleAPI api, final GraphTransformationInterpreter interpreter) {
