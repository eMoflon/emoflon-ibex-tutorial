...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Nurse To Staff Rule Marker</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link Hospital2Administration.impl.NurseToStaffRule__MarkerImpl#getCONTEXT__SRC__d <em>CONTEXT SRC d</em>}</li>
 *   <li>{@link Hospital2Administration.impl.NurseToStaffRule__MarkerImpl#getCONTEXT__SRC__h <em>CONTEXT SRC h</em>}</li>
 *   <li>{@link Hospital2Administration.impl.NurseToStaffRule__MarkerImpl#getCREATE__SRC__s1 <em>CREATE SRC s1</em>}</li>
 *   <li>{@link Hospital2Administration.impl.NurseToStaffRule__MarkerImpl#getCREATE__TRG__s2 <em>CREATE TRG s2</em>}</li>
 *   <li>{@link Hospital2Administration.impl.NurseToStaffRule__MarkerImpl#getCREATE__TRG__sh <em>CREATE TRG sh</em>}</li>
 *   <li>{@link Hospital2Administration.impl.NurseToStaffRule__MarkerImpl#getCREATE__TRG__sp <em>CREATE TRG sp</em>}</li>
 *   <li>{@link Hospital2Administration.impl.NurseToStaffRule__MarkerImpl#getCONTEXT__TRG__v <em>CONTEXT TRG v</em>}</li>
 *   <li>{@link Hospital2Administration.impl.NurseToStaffRule__MarkerImpl#getCONTEXT__CORR__htov <em>CONTEXT CORR htov</em>}</li>
 *   <li>{@link Hospital2Administration.impl.NurseToStaffRule__MarkerImpl#getCREATE__CORR__stot <em>CREATE CORR stot</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NurseToStaffRule__MarkerImpl extends TGGRuleApplicationImpl implements NurseToStaffRule__Marker {
	/**
	 ...
	 * @ordered
	 */
	protected Nurse creatE__SRC__s1;
	...
	protected EClass eStaticClass() {
		return Hospital2AdministrationPackage.Literals.NURSE_TO_STAFF_RULE_MARKER;
	}
		...
		if (contexT__SRC__d != null && contexT__SRC__d.eIsProxy()) {
			...
			if (contexT__SRC__d != oldCONTEXT__SRC__d) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Hospital2AdministrationPackage.NURSE_TO_STAFF_RULE_MARKER__CONTEXT_SRC_D, oldCONTEXT__SRC__d, contexT__SRC__d));
			}
		}
	...
	public void setCONTEXT__SRC__d(Department newCONTEXT__SRC__d) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hospital2AdministrationPackage.NURSE_TO_STAFF_RULE_MARKER__CONTEXT_SRC_D, oldCONTEXT__SRC__d, contexT__SRC__d));
	}
	...
	public Hospital getCONTEXT__SRC__h() {
		if (contexT__SRC__h != null && contexT__SRC__h.eIsProxy()) {
			...
			if (contexT__SRC__h != oldCONTEXT__SRC__h) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Hospital2AdministrationPackage.NURSE_TO_STAFF_RULE_MARKER__CONTEXT_SRC_H, oldCONTEXT__SRC__h, contexT__SRC__h));
			}
		}
	...
	public void setCONTEXT__SRC__h(Hospital newCONTEXT__SRC__h) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hospital2AdministrationPackage.NURSE_TO_STAFF_RULE_MARKER__CONTEXT_SRC_H, oldCONTEXT__SRC__h, contexT__SRC__h));
	}
	 ...
	 * @generated
	 */
	public Nurse getCREATE__SRC__s1() {
		if (creatE__SRC__s1 != null && creatE__SRC__s1.eIsProxy()) {
			InternalEObject oldCREATE__SRC__s1 = (InternalEObject)creatE__SRC__s1;
			creatE__SRC__s1 = (Nurse)eResolveProxy(oldCREATE__SRC__s1);
			if (creatE__SRC__s1 != oldCREATE__SRC__s1) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Hospital2AdministrationPackage.NURSE_TO_STAFF_RULE_MARKER__CREATE_SRC_S1, oldCREATE__SRC__s1, creatE__SRC__s1));
			}
		}
	 ...
	 * @generated
	 */
	public Nurse basicGetCREATE__SRC__s1() {
		return creatE__SRC__s1;
	}
	 ...
	 * @generated
	 */
	public void setCREATE__SRC__s1(Nurse newCREATE__SRC__s1) {
		Nurse oldCREATE__SRC__s1 = creatE__SRC__s1;
		creatE__SRC__s1 = newCREATE__SRC__s1;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hospital2AdministrationPackage.NURSE_TO_STAFF_RULE_MARKER__CREATE_SRC_S1, oldCREATE__SRC__s1, creatE__SRC__s1));
	}
	...
	public Staff getCREATE__TRG__s2() {
		if (creatE__TRG__s2 != null && creatE__TRG__s2.eIsProxy()) {
			...
			if (creatE__TRG__s2 != oldCREATE__TRG__s2) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Hospital2AdministrationPackage.NURSE_TO_STAFF_RULE_MARKER__CREATE_TRG_S2, oldCREATE__TRG__s2, creatE__TRG__s2));
			}
		}
	...
	public void setCREATE__TRG__s2(Staff newCREATE__TRG__s2) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hospital2AdministrationPackage.NURSE_TO_STAFF_RULE_MARKER__CREATE_TRG_S2, oldCREATE__TRG__s2, creatE__TRG__s2));
	}
	...
	public Shift getCREATE__TRG__sh() {
		if (creatE__TRG__sh != null && creatE__TRG__sh.eIsProxy()) {
			...
			if (creatE__TRG__sh != oldCREATE__TRG__sh) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Hospital2AdministrationPackage.NURSE_TO_STAFF_RULE_MARKER__CREATE_TRG_SH, oldCREATE__TRG__sh, creatE__TRG__sh));
			}
		}
	...
	public void setCREATE__TRG__sh(Shift newCREATE__TRG__sh) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hospital2AdministrationPackage.NURSE_TO_STAFF_RULE_MARKER__CREATE_TRG_SH, oldCREATE__TRG__sh, creatE__TRG__sh));
	}
	...
	public Shiftplan getCREATE__TRG__sp() {
		if (creatE__TRG__sp != null && creatE__TRG__sp.eIsProxy()) {
			...
			if (creatE__TRG__sp != oldCREATE__TRG__sp) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Hospital2AdministrationPackage.NURSE_TO_STAFF_RULE_MARKER__CREATE_TRG_SP, oldCREATE__TRG__sp, creatE__TRG__sp));
			}
		}
	...
	public void setCREATE__TRG__sp(Shiftplan newCREATE__TRG__sp) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hospital2AdministrationPackage.NURSE_TO_STAFF_RULE_MARKER__CREATE_TRG_SP, oldCREATE__TRG__sp, creatE__TRG__sp));
	}
	...
	public Administration getCONTEXT__TRG__v() {
		if (contexT__TRG__v != null && contexT__TRG__v.eIsProxy()) {
			...
			if (contexT__TRG__v != oldCONTEXT__TRG__v) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Hospital2AdministrationPackage.NURSE_TO_STAFF_RULE_MARKER__CONTEXT_TRG_V, oldCONTEXT__TRG__v, contexT__TRG__v));
			}
		}
	...
	public void setCONTEXT__TRG__v(Administration newCONTEXT__TRG__v) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hospital2AdministrationPackage.NURSE_TO_STAFF_RULE_MARKER__CONTEXT_TRG_V, oldCONTEXT__TRG__v, contexT__TRG__v));
	}
	...
	public HospitalToAdministration getCONTEXT__CORR__htov() {
		if (contexT__CORR__htov != null && contexT__CORR__htov.eIsProxy()) {
			...
			if (contexT__CORR__htov != oldCONTEXT__CORR__htov) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Hospital2AdministrationPackage.NURSE_TO_STAFF_RULE_MARKER__CONTEXT_CORR_HTOV, oldCONTEXT__CORR__htov, contexT__CORR__htov));
			}
		}
	...
	public void setCONTEXT__CORR__htov(HospitalToAdministration newCONTEXT__CORR__htov) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hospital2AdministrationPackage.NURSE_TO_STAFF_RULE_MARKER__CONTEXT_CORR_HTOV, oldCONTEXT__CORR__htov, contexT__CORR__htov));
	}
	...
	public StaffToStaff getCREATE__CORR__stot() {
		if (creatE__CORR__stot != null && creatE__CORR__stot.eIsProxy()) {
			...
			if (creatE__CORR__stot != oldCREATE__CORR__stot) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Hospital2AdministrationPackage.NURSE_TO_STAFF_RULE_MARKER__CREATE_CORR_STOT, oldCREATE__CORR__stot, creatE__CORR__stot));
			}
		}
	...
	public void setCREATE__CORR__stot(StaffToStaff newCREATE__CORR__stot) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hospital2AdministrationPackage.NURSE_TO_STAFF_RULE_MARKER__CREATE_CORR_STOT, oldCREATE__CORR__stot, creatE__CORR__stot));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Hospital2AdministrationPackage.NURSE_TO_STAFF_RULE_MARKER__CONTEXT_SRC_D:
				if (resolve) return getCONTEXT__SRC__d();
				return basicGetCONTEXT__SRC__d();
			case Hospital2AdministrationPackage.NURSE_TO_STAFF_RULE_MARKER__CONTEXT_SRC_H:
				if (resolve) return getCONTEXT__SRC__h();
				return basicGetCONTEXT__SRC__h();
			case Hospital2AdministrationPackage.NURSE_TO_STAFF_RULE_MARKER__CREATE_SRC_S1:
				if (resolve) return getCREATE__SRC__s1();
				return basicGetCREATE__SRC__s1();
			case Hospital2AdministrationPackage.NURSE_TO_STAFF_RULE_MARKER__CREATE_TRG_S2:
				if (resolve) return getCREATE__TRG__s2();
				return basicGetCREATE__TRG__s2();
			case Hospital2AdministrationPackage.NURSE_TO_STAFF_RULE_MARKER__CREATE_TRG_SH:
				if (resolve) return getCREATE__TRG__sh();
				return basicGetCREATE__TRG__sh();
			case Hospital2AdministrationPackage.NURSE_TO_STAFF_RULE_MARKER__CREATE_TRG_SP:
				if (resolve) return getCREATE__TRG__sp();
				return basicGetCREATE__TRG__sp();
			case Hospital2AdministrationPackage.NURSE_TO_STAFF_RULE_MARKER__CONTEXT_TRG_V:
				if (resolve) return getCONTEXT__TRG__v();
				return basicGetCONTEXT__TRG__v();
			case Hospital2AdministrationPackage.NURSE_TO_STAFF_RULE_MARKER__CONTEXT_CORR_HTOV:
				if (resolve) return getCONTEXT__CORR__htov();
				return basicGetCONTEXT__CORR__htov();
			case Hospital2AdministrationPackage.NURSE_TO_STAFF_RULE_MARKER__CREATE_CORR_STOT:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case Hospital2AdministrationPackage.NURSE_TO_STAFF_RULE_MARKER__CONTEXT_SRC_H:
				...
				return;
			case Hospital2AdministrationPackage.NURSE_TO_STAFF_RULE_MARKER__CREATE_SRC_S1:
				setCREATE__SRC__s1((Nurse)newValue);
				return;
			case Hospital2AdministrationPackage.NURSE_TO_STAFF_RULE_MARKER__CREATE_TRG_S2:
