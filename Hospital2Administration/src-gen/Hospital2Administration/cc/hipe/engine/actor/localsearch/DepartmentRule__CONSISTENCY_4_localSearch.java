...
public class DepartmentRule__CONSISTENCY_4_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> ((Hospital2Administration.DepartmentRule__Marker) o).getCREATE__SRC__d();
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> ((Hospital2Administration.DepartmentRule__Marker) o).getCONTEXT__SRC__h();
			...
			case "Department_object_SP1": 
				{
					...
					// d
					HMatch match_0 = new LocalSearchMatch("DepartmentRule__CONSISTENCY_4_localSearch", 3);
			...
			case "Hospital_object_SP1": 
				{
					...
					// h
					HMatch match_1 = new LocalSearchMatch("DepartmentRule__CONSISTENCY_4_localSearch", 3);
			...
			case "DepartmentRule__Marker_object": 
				{
					...
					HMatch match_2 = new LocalSearchMatch("DepartmentRule__CONSISTENCY_4_localSearch", 3);
		...
		case "DepartmentRule__Marker_CREATE__SRC__d_Department": 
			{
				...
				HMatch match = new LocalSearchMatch("DepartmentRule__CONSISTENCY_4_localSearch", 3);
				Object[] objs = match.getNodes();
				objs[2] = msg.source;
				objs[0] = msg.target;
				currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_incrementingDepartmentID csp_2 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_incrementingDepartmentID();
		csp_2.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, d.getDID(), "int"));
		csp_2.solve();
	...
	public boolean constraint_checker_0_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.SetDefaultNumber csp_3 = new org.emoflon.ibex.tgg.operational.csp.constraints.SetDefaultNumber();
		csp_3.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, d.getMaxRoomCount(), "int"));
		csp_3.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, 10, "java.lang.String"));
		csp_3.solve();
