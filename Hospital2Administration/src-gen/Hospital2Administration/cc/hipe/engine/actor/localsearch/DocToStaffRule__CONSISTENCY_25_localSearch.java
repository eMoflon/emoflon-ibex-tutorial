...
public class DocToStaffRule__CONSISTENCY_25_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> ((Hospital2Administration.DocToStaffRule__Marker) o).getCREATE__TRG__sh();
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> ((Hospital2Administration.DocToStaffRule__Marker) o).getCONTEXT__SRC__d();
						edge_explorer_4 = new CachedEdgeExplorer(this, 9, 0, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> ((Hospital2Administration.DocToStaffRule__Marker) o).getCREATE__TRG__sp();
						edge_explorer_5 = new CachedEdgeExplorer(this, 9, 5, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> ((Hospital2Administration.HospitalToAdministration) o).getSource();
						edge_explorer_6 = new CachedEdgeExplorer(this, 7, 1, edge_explorer_6_methods);
		name2explorer.put("edge_explorer_6", edge_explorer_6);
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> ((Hospital2Administration.DocToStaffRule__Marker) o).getCREATE__SRC__s1();
						edge_explorer_7 = new CachedEdgeExplorer(this, 9, 2, edge_explorer_7_methods);
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						...
						edge_explorer_8 = new EdgeExplorer(this, 3, 5, edge_explorer_8_methods);
		name2explorer.put("edge_explorer_8", edge_explorer_8);
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> ((HospitalExample.Staff) o).getWorks();
						edge_explorer_9_methods.multi_opposite_lookup = (o) -> ((HospitalExample.Department) o).getStaff().stream().filter(obj -> obj instanceof HospitalExample.Doctor).collect(Collectors.toList());
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> ((Hospital2Administration.DocToStaffRule__Marker) o).getCONTEXT__SRC__h();
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> ((Hospital2Administration.DocToStaffRule__Marker) o).getCREATE__TRG__s2();
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> ((Hospital2Administration.StaffToStaff) o).getTarget();
		...
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.multi_lookup = (o) -> ((HospitalExample.Hospital) o).getStaff().stream().filter(obj -> obj instanceof HospitalExample.Doctor).collect(Collectors.toList());
		...
		EdgeLookupMethods edge_explorer_14_methods = new EdgeLookupMethods();
						edge_explorer_14_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.StaffToStaff) o).getSource(); return (result instanceof HospitalExample.Doctor ? result : null);};
						edge_explorer_14 = new CachedEdgeExplorer(this, 8, 2, edge_explorer_14_methods);
		name2explorer.put("edge_explorer_14", edge_explorer_14);
		EdgeLookupMethods edge_explorer_15_methods = new EdgeLookupMethods();
						edge_explorer_15_methods.unique_lookup = (o) -> ((Hospital2Administration.DocToStaffRule__Marker) o).getCONTEXT__CORR__htov();
						edge_explorer_15 = new CachedEdgeExplorer(this, 9, 7, edge_explorer_15_methods);
		name2explorer.put("edge_explorer_15", edge_explorer_15);
		EdgeLookupMethods edge_explorer_16_methods = new EdgeLookupMethods();
						edge_explorer_16_methods.unique_lookup = (o) -> ((Hospital2Administration.HospitalToAdministration) o).getTarget();
						edge_explorer_16 = new CachedEdgeExplorer(this, 7, 6, edge_explorer_16_methods);
		name2explorer.put("edge_explorer_16", edge_explorer_16);
		EdgeLookupMethods edge_explorer_17_methods = new EdgeLookupMethods();
						edge_explorer_17_methods.unique_lookup = (o) -> ((Hospital2Administration.DocToStaffRule__Marker) o).getCONTEXT__TRG__v();
		...
		EdgeLookupMethods edge_explorer_18_methods = new EdgeLookupMethods();
						edge_explorer_18_methods.multi_lookup = (o) -> ((AdministrationExample.Administration) o).getStaff();
						edge_explorer_18_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof AdministrationExample.Administration) return edge_explorer_18_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
						edge_explorer_18 = new EdgeExplorer(this, 6, 3, edge_explorer_18_methods);
		name2explorer.put("edge_explorer_18", edge_explorer_18);
		EdgeLookupMethods edge_explorer_19_methods = new EdgeLookupMethods();
						edge_explorer_19_methods.unique_lookup = (o) -> ((Hospital2Administration.DocToStaffRule__Marker) o).getCREATE__CORR__stot();
						edge_explorer_19 = new CachedEdgeExplorer(this, 9, 8, edge_explorer_19_methods);
			...
			case "Department_object_SP3": 
				{
					...
					// d
					HMatch match_0 = new LocalSearchMatch("DocToStaffRule__CONSISTENCY_25_localSearch", 10);
			...
			case "Hospital_object_SP3": 
				{
					...
					// h
					HMatch match_1 = new LocalSearchMatch("DocToStaffRule__CONSISTENCY_25_localSearch", 10);
			...
			case "Doctor_object_SP1": 
				{
					...
					// s1
					HMatch match_2 = new LocalSearchMatch("DocToStaffRule__CONSISTENCY_25_localSearch", 10);
			...
			case "Staff_object_SP2": 
				{
					...
					// s2
					HMatch match_3 = new LocalSearchMatch("DocToStaffRule__CONSISTENCY_25_localSearch", 10);
			...
			case "Shift_object_SP2": 
				{
					...
					// sh
					HMatch match_4 = new LocalSearchMatch("DocToStaffRule__CONSISTENCY_25_localSearch", 10);
			...
			case "Shiftplan_object_SP0": 
				{
					...
					// sp
					HMatch match_5 = new LocalSearchMatch("DocToStaffRule__CONSISTENCY_25_localSearch", 10);
			...
			case "Administration_object_SP1": 
				{
					...
					// v
					HMatch match_6 = new LocalSearchMatch("DocToStaffRule__CONSISTENCY_25_localSearch", 10);
					match_6.getNodes()[6] = objs[0];
					start(edge_explorer_16_1_orchestration, match_6);
				}
				break;
			case "HospitalToAdministration_object_SP1": 
				{
					...
					// htov
					HMatch match_7 = new LocalSearchMatch("DocToStaffRule__CONSISTENCY_25_localSearch", 10);
					match_7.getNodes()[7] = objs[0];
					start(edge_explorer_6_1_orchestration, match_7);
				}
				break;
			case "StaffToStaff_object_SP0": 
				{
					...
					// stot
					HMatch match_8 = new LocalSearchMatch("DocToStaffRule__CONSISTENCY_25_localSearch", 10);
					match_8.getNodes()[8] = objs[0];
					start(edge_explorer_12_1_orchestration, match_8);
				}
				break;
			case "DocToStaffRule__Marker_object": 
				{
					...
					HMatch match_9 = new LocalSearchMatch("DocToStaffRule__CONSISTENCY_25_localSearch", 10);
		...
		switch(match.creator) {
			...
			case "DocToStaffRule_s2_shiftPlan_outgoing_TRG__FILTER_NAC_TRG_8_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("DocToStaffRule__CONSISTENCY_25_localSearch", 10);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
			...
			case "DocToStaffRule_sp_shifts_outgoing_TRG__FILTER_NAC_TRG_12_localSearch": 
				if(nac_checker_0.deregister(match)) {
					HMatch acMatch_1 = new LocalSearchMatch("DocToStaffRule__CONSISTENCY_25_localSearch", 10);
					Object[] acMatch_nodes_1 = acMatch_1.getNodes();
		...
		case "DocToStaffRule__Marker_CREATE__TRG__sh_Shift": 
			{
				...
				HMatch match = new LocalSearchMatch("DocToStaffRule__CONSISTENCY_25_localSearch", 10);
				Object[] objs = match.getNodes();
				objs[9] = msg.source;
				objs[4] = msg.target;
				currentDepth++;
	...
	public boolean constraint_checker_0_method(HMatch match) {
		...
		csp_9.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, d.getDID(), "int"));
		csp_9.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, s2.getDInt(), "int"));
		csp_9.solve();
	...
	public boolean constraint_checker_1_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_incrementingStaffID csp_10 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_incrementingStaffID();
		csp_10.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, s1.getStaffID(), "int"));
		csp_10.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, s2.getStaffID(), "int"));
		csp_10.solve();
	...
	public boolean constraint_checker_2_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_nametoname csp_11 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_nametoname();
		csp_11.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, " ", "java.lang.String"));
		csp_11.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, s2.getFirstName(), "java.lang.String"));
		csp_11.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, s2.getLastName(), "java.lang.String"));
		csp_11.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, s1.getName(), "java.lang.String"));
		csp_11.solve();
