...
public class DoctorShiftplanRule__CC_36_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> ((HospitalExample.Patient) o).getDoctor();
						edge_explorer_methods.multi_opposite_lookup = (o) -> ((HospitalExample.Doctor) o).getCaresfor();
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						...
						edge_explorer_3 = new EdgeExplorer(this, 4, 7, edge_explorer_3_methods);
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						...
						edge_explorer_4 = new EdgeExplorer(this, 7, 1, edge_explorer_4_methods);
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						...
						edge_explorer_6 = new CachedEdgeExplorer(this, 5, 4, edge_explorer_6_methods);
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						...
						edge_explorer_9 = new CachedEdgeExplorer(this, 2, 0, edge_explorer_9_methods);
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("DoctorShiftplanRule__CC_production"), this::returnTrue  , false ));
	}
			...
			case "Patient_object_SP0": 
				{
					...
					// p1
					HMatch match_0 = new LocalSearchMatch("DoctorShiftplanRule__CC_36_localSearch", 8);
			...
			case "Patient_1_object_SP0": 
				{
					...
					// p2
					HMatch match_1 = new LocalSearchMatch("DoctorShiftplanRule__CC_36_localSearch", 8);
			...
			case "PatientToPatient_object_SP0": 
				{
					...
					// pToP
					HMatch match_2 = new LocalSearchMatch("DoctorShiftplanRule__CC_36_localSearch", 8);
			...
			case "Doctor_object_SP0": 
				{
					...
					// s1
					HMatch match_3 = new LocalSearchMatch("DoctorShiftplanRule__CC_36_localSearch", 8);
			...
			case "Staff_object_SP3": 
				{
					...
					// s2
					HMatch match_4 = new LocalSearchMatch("DoctorShiftplanRule__CC_36_localSearch", 8);
			...
			case "StaffToStaff_object_SP1": 
				{
					...
					// sToS
					HMatch match_5 = new LocalSearchMatch("DoctorShiftplanRule__CC_36_localSearch", 8);
			...
			case "Shift_object_SP0": 
				{
					...
					// sh
					HMatch match_6 = new LocalSearchMatch("DoctorShiftplanRule__CC_36_localSearch", 8);
			...
			case "Shiftplan_object_SP1": 
				{
					...
					// sp
					HMatch match_7 = new LocalSearchMatch("DoctorShiftplanRule__CC_36_localSearch", 8);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "Patient_doctor_Doctor": 
			{
				HMatch match = new LocalSearchMatch("DoctorShiftplanRule__CC_36_localSearch", 8);
				Object[] objs = match.getNodes();
				objs[0] = msg.source;
				objs[3] = msg.target;
				currentDepth++;
