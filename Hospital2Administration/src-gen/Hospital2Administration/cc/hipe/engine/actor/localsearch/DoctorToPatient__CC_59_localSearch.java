...
public class DoctorToPatient__CC_59_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						...
						edge_explorer = new EdgeExplorer(this, 6, 3, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> ((Hospital2Administration.StaffToStaff) o).getTarget();
						edge_explorer_3 = new CachedEdgeExplorer(this, 1, 7, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> ((AdministrationExample.Patient) o).getTreatment();
						edge_explorer_4_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof AdministrationExample.Patient) return o.equals(edge_explorer_4_methods.unique_lookup.apply(result)) ? result : null; else return null;};
						edge_explorer_4 = new EdgeExplorer(this, 4, 8, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.StaffToStaff) o).getSource(); return (result instanceof HospitalExample.Doctor ? result : null);};
						edge_explorer_5 = new CachedEdgeExplorer(this, 1, 0, edge_explorer_5_methods);
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.multi_lookup = (o) -> ((HospitalExample.Department) o).getRooms();
						edge_explorer_8_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof HospitalExample.Department) return edge_explorer_8_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
						edge_explorer_8 = new EdgeExplorer(this, 2, 6, edge_explorer_8_methods);
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						...
						edge_explorer_9 = new CachedEdgeExplorer(this, 5, 3, edge_explorer_9_methods);
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						...
						edge_explorer_10 = new EdgeExplorer(this, 3, 0, edge_explorer_10_methods);
		name2explorer.put("edge_explorer_10", edge_explorer_10);
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.multi_lookup = (o) -> ((AdministrationExample.Staff) o).getTreatment();
						edge_explorer_11 = new CachedEdgeExplorer(this, 7, 8, edge_explorer_11_methods);
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("DoctorToPatient__CC_production"), this::returnTrue , 0  , false ));
	}
			...
			case "Doctor_object_SP0": 
				{
					...
					// d
					HMatch match_0 = new LocalSearchMatch("DoctorToPatient__CC_59_localSearch", 9);
			...
			case "StaffToStaff_object_SP0": 
				{
					...
					// dToS
					HMatch match_1 = new LocalSearchMatch("DoctorToPatient__CC_59_localSearch", 9);
			...
			case "Department_object_SP0": 
				{
					...
					// dep
					HMatch match_2 = new LocalSearchMatch("DoctorToPatient__CC_59_localSearch", 9);
			...
			case "Patient_object_SP2": 
				{
					...
					// p1
					HMatch match_3 = new LocalSearchMatch("DoctorToPatient__CC_59_localSearch", 9);
			...
			case "Patient_1_object_SP2": 
				{
					...
					// p2
					HMatch match_4 = new LocalSearchMatch("DoctorToPatient__CC_59_localSearch", 9);
			...
			case "PatientToPatient_object_SP2": 
				{
					...
					// pToP
					HMatch match_5 = new LocalSearchMatch("DoctorToPatient__CC_59_localSearch", 9);
			...
			case "Room_object_SP0": 
				{
					...
					// ro
					HMatch match_6 = new LocalSearchMatch("DoctorToPatient__CC_59_localSearch", 9);
			...
			case "Staff_object_SP1": 
				{
					...
					// s
					HMatch match_7 = new LocalSearchMatch("DoctorToPatient__CC_59_localSearch", 9);
					match_7.getNodes()[7] = objs[0];
					start(edge_explorer_3_2_orchestration, match_7);
				}
				break;
			case "Treatment_object": 
				{
					...
					// t
					HMatch match_8 = new LocalSearchMatch("DoctorToPatient__CC_59_localSearch", 9);
					match_8.getNodes()[8] = objs[0];
					start(edge_explorer_4_2_orchestration, match_8);
				}
				break;
		...
		switch(match.creator) {
			...
			case "DoctorToPatient_t_treatment_incoming_TRG__FILTER_NAC_TRG_55_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("DoctorToPatient__CC_59_localSearch", 9);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "Room_lies_Patient": 
			{
				HMatch match = new LocalSearchMatch("DoctorToPatient__CC_59_localSearch", 9);
				Object[] objs = match.getNodes();
				objs[6] = msg.source;
				objs[3] = msg.target;
				currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_carelevelToMedication csp_12 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_carelevelToMedication();
		csp_12.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, p1.getLevel(), "Enum::Carelevel"));
		csp_12.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, t.getMedication(), "Enum::Medication"));
		csp_12.solve();
