...
public class DoctorToPatient__CONSISTENCY_69_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> ((Hospital2Administration.DoctorToPatient__Marker) o).getCONTEXT__TRG__p2();
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						...
						edge_explorer_3 = new CachedEdgeExplorer(this, 7, 5, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> ((Hospital2Administration.DoctorToPatient__Marker) o).getCONTEXT__TRG__s();
						edge_explorer_4 = new CachedEdgeExplorer(this, 9, 5, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> ((AdministrationExample.Patient) o).getTreatment();
						edge_explorer_5_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof AdministrationExample.Patient) return o.equals(edge_explorer_5_methods.unique_lookup.apply(result)) ? result : null; else return null;};
						edge_explorer_5 = new EdgeExplorer(this, 4, 6, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> ((Hospital2Administration.DoctorToPatient__Marker) o).getCONTEXT__SRC__d();
						edge_explorer_6 = new CachedEdgeExplorer(this, 9, 0, edge_explorer_6_methods);
		name2explorer.put("edge_explorer_6", edge_explorer_6);
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> ((Hospital2Administration.PatientToPatient) o).getSource();
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> ((Hospital2Administration.DoctorToPatient__Marker) o).getCREATE__TRG__t();
						edge_explorer_8 = new CachedEdgeExplorer(this, 9, 6, edge_explorer_8_methods);
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> ((Hospital2Administration.DoctorToPatient__Marker) o).getCONTEXT__CORR__pToP();
						edge_explorer_10 = new CachedEdgeExplorer(this, 9, 8, edge_explorer_10_methods);
		name2explorer.put("edge_explorer_10", edge_explorer_10);
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.StaffToStaff) o).getSource(); return (result instanceof HospitalExample.Doctor ? result : null);};
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.multi_lookup = (o) -> ((HospitalExample.Room) o).getLies();
						edge_explorer_12_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof HospitalExample.Room) return edge_explorer_12_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
						edge_explorer_12 = new EdgeExplorer(this, 3, 2, edge_explorer_12_methods);
		name2explorer.put("edge_explorer_12", edge_explorer_12);
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> ((Hospital2Administration.DoctorToPatient__Marker) o).getCONTEXT__SRC__ro();
		...
		EdgeLookupMethods edge_explorer_14_methods = new EdgeLookupMethods();
						edge_explorer_14_methods.multi_lookup = (o) -> ((AdministrationExample.Staff) o).getTreatment();
						edge_explorer_14 = new CachedEdgeExplorer(this, 5, 6, edge_explorer_14_methods);
		name2explorer.put("edge_explorer_14", edge_explorer_14);
		EdgeLookupMethods edge_explorer_15_methods = new EdgeLookupMethods();
						edge_explorer_15_methods.unique_lookup = (o) -> ((Hospital2Administration.DoctorToPatient__Marker) o).getCONTEXT__SRC__p1();
						edge_explorer_15 = new CachedEdgeExplorer(this, 9, 2, edge_explorer_15_methods);
		name2explorer.put("edge_explorer_15", edge_explorer_15);
		EdgeLookupMethods edge_explorer_16_methods = new EdgeLookupMethods();
						edge_explorer_16_methods.unique_lookup = (o) -> ((HospitalExample.Staff) o).getWorks();
						edge_explorer_16_methods.multi_opposite_lookup = (o) -> ((HospitalExample.Department) o).getStaff().stream().filter(obj -> obj instanceof HospitalExample.Doctor).collect(Collectors.toList());
						edge_explorer_16 = new EdgeExplorer(this, 0, 1, edge_explorer_16_methods);
		name2explorer.put("edge_explorer_16", edge_explorer_16);
		EdgeLookupMethods edge_explorer_17_methods = new EdgeLookupMethods();
						edge_explorer_17_methods.multi_lookup = (o) -> ((HospitalExample.Department) o).getRooms();
						edge_explorer_17_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof HospitalExample.Department) return edge_explorer_17_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
						edge_explorer_17 = new EdgeExplorer(this, 1, 3, edge_explorer_17_methods);
		name2explorer.put("edge_explorer_17", edge_explorer_17);
		EdgeLookupMethods edge_explorer_18_methods = new EdgeLookupMethods();
						edge_explorer_18_methods.unique_lookup = (o) -> ((Hospital2Administration.DoctorToPatient__Marker) o).getCONTEXT__SRC__dep();
						edge_explorer_18 = new CachedEdgeExplorer(this, 9, 1, edge_explorer_18_methods);
		name2explorer.put("edge_explorer_18", edge_explorer_18);
		EdgeLookupMethods edge_explorer_19_methods = new EdgeLookupMethods();
						edge_explorer_19_methods.unique_lookup = (o) -> ((Hospital2Administration.PatientToPatient) o).getTarget();
						edge_explorer_19 = new CachedEdgeExplorer(this, 8, 4, edge_explorer_19_methods);
		name2explorer.put("edge_explorer_19", edge_explorer_19);
		EdgeLookupMethods edge_explorer_20_methods = new EdgeLookupMethods();
						edge_explorer_20_methods.unique_lookup = (o) -> ((Hospital2Administration.DoctorToPatient__Marker) o).getCONTEXT__CORR__dToS();
						edge_explorer_20 = new CachedEdgeExplorer(this, 9, 7, edge_explorer_20_methods);
			...
			case "Doctor_object_SP1": 
				{
					...
					// d
					HMatch match_0 = new LocalSearchMatch("DoctorToPatient__CONSISTENCY_69_localSearch", 10);
			...
			case "Department_object_SP1": 
				{
					...
					// dep
					HMatch match_1 = new LocalSearchMatch("DoctorToPatient__CONSISTENCY_69_localSearch", 10);
			...
			case "Patient_object_SP3": 
				{
					...
					// p1
					HMatch match_2 = new LocalSearchMatch("DoctorToPatient__CONSISTENCY_69_localSearch", 10);
			...
			case "Room_object_SP1": 
				{
					...
					// ro
					HMatch match_3 = new LocalSearchMatch("DoctorToPatient__CONSISTENCY_69_localSearch", 10);
					match_3.getNodes()[3] = objs[0];
					start(edge_explorer_12_1_orchestration, match_3);
				}
				break;
			case "Patient_1_object_SP0": 
				{
					...
					// p2
					HMatch match_4 = new LocalSearchMatch("DoctorToPatient__CONSISTENCY_69_localSearch", 10);
			...
			case "Staff_object_SP3": 
				{
					...
					// s
					HMatch match_5 = new LocalSearchMatch("DoctorToPatient__CONSISTENCY_69_localSearch", 10);
			...
			case "Treatment_object": 
				{
					...
					// t
					HMatch match_6 = new LocalSearchMatch("DoctorToPatient__CONSISTENCY_69_localSearch", 10);
			...
			case "StaffToStaff_object_SP1": 
				{
					...
					// dToS
					HMatch match_7 = new LocalSearchMatch("DoctorToPatient__CONSISTENCY_69_localSearch", 10);
			...
			case "PatientToPatient_object_SP0": 
				{
					...
					// pToP
					HMatch match_8 = new LocalSearchMatch("DoctorToPatient__CONSISTENCY_69_localSearch", 10);
			...
			case "DoctorToPatient__Marker_object": 
				{
					...
					HMatch match_9 = new LocalSearchMatch("DoctorToPatient__CONSISTENCY_69_localSearch", 10);
					match_9.getNodes()[9] = objs[0];
					start(edge_explorer_1_orchestration, match_9);
				}
				break;
			case "DoctorToPatient_t_treatment_incoming_TRG__FILTER_NAC_TRG_55_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "DoctorToPatient_t_treatment_incoming_TRG__FILTER_NAC_TRG_55_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("DoctorToPatient__CONSISTENCY_69_localSearch", 10);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
		...
		case "DoctorToPatient__Marker_CONTEXT__TRG__p2_Patient": 
			{
				...
				HMatch match = new LocalSearchMatch("DoctorToPatient__CONSISTENCY_69_localSearch", 10);
				Object[] objs = match.getNodes();
				objs[9] = msg.source;
				objs[4] = msg.target;
				currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_carelevelToMedication csp_13 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_carelevelToMedication();
		csp_13.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, p1.getLevel(), "Enum::Carelevel"));
		csp_13.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, t.getMedication(), "Enum::Medication"));
		csp_13.solve();
