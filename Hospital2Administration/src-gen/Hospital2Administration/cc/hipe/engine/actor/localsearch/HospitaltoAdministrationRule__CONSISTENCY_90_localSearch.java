...
public class HospitaltoAdministrationRule__CONSISTENCY_90_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> ((Hospital2Administration.HospitaltoAdministrationRule__Marker) o).getCREATE__CORR__htov();
						edge_explorer = new CachedEdgeExplorer(this, 4, 3, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> ((Hospital2Administration.HospitaltoAdministrationRule__Marker) o).getCREATE__SRC__r();
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						...
						edge_explorer_8 = new EdgeExplorer(this, 0, 1, edge_explorer_8_methods);
