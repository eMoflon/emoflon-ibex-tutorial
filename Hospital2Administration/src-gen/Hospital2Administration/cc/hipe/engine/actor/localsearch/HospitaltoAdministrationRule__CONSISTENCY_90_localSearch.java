...
public class HospitaltoAdministrationRule__CONSISTENCY_90_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> ((Hospital2Administration.HospitaltoAdministrationRule__Marker) o).getCREATE__SRC__h();
						edge_explorer_4 = new CachedEdgeExplorer(this, 4, 0, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> ((Hospital2Administration.HospitaltoAdministrationRule__Marker) o).getCREATE__TRG__v();
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> ((Hospital2Administration.HospitaltoAdministrationRule__Marker) o).getCREATE__CORR__htov();
						edge_explorer_7 = new CachedEdgeExplorer(this, 4, 3, edge_explorer_7_methods);
		name2explorer.put("edge_explorer_7", edge_explorer_7);
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> ((Hospital2Administration.HospitaltoAdministrationRule__Marker) o).getCREATE__SRC__r();
						edge_explorer_8 = new CachedEdgeExplorer(this, 4, 1, edge_explorer_8_methods);
			...
			case "Hospital_object_SP2": 
				{
					...
					// h
					HMatch match_0 = new LocalSearchMatch("HospitaltoAdministrationRule__CONSISTENCY_90_localSearch", 5);
			...
			case "Reception_object_SP0": 
				{
					...
					// r
					HMatch match_1 = new LocalSearchMatch("HospitaltoAdministrationRule__CONSISTENCY_90_localSearch", 5);
			...
			case "Administration_object_SP0": 
				{
					...
					// v
					HMatch match_2 = new LocalSearchMatch("HospitaltoAdministrationRule__CONSISTENCY_90_localSearch", 5);
			...
			case "HospitalToAdministration_object_SP2": 
				{
					...
					// htov
					HMatch match_3 = new LocalSearchMatch("HospitaltoAdministrationRule__CONSISTENCY_90_localSearch", 5);
			...
			case "HospitaltoAdministrationRule__Marker_object": 
				{
					...
					HMatch match_4 = new LocalSearchMatch("HospitaltoAdministrationRule__CONSISTENCY_90_localSearch", 5);
					match_4.getNodes()[4] = objs[0];
					start(edge_explorer_4_1_orchestration, match_4);
				}
				break;
			case "HospitaltoAdministrationRule_h_reception_outgoing_SRC__FILTER_NAC_SRC_80_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "HospitaltoAdministrationRule_h_reception_outgoing_SRC__FILTER_NAC_SRC_80_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("HospitaltoAdministrationRule__CONSISTENCY_90_localSearch", 5);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
		...
		case "HospitalToAdministration_source_Hospital": 
			{
				...
				HMatch match = new LocalSearchMatch("HospitaltoAdministrationRule__CONSISTENCY_90_localSearch", 5);
				Object[] objs = match.getNodes();
				objs[3] = msg.source;
				objs[0] = msg.target;
				currentDepth++;
