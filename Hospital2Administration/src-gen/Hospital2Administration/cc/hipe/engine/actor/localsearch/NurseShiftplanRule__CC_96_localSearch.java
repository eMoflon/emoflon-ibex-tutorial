...
public class NurseShiftplanRule__CC_96_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						...
						edge_explorer_5 = new CachedEdgeExplorer(this, 2, 0, edge_explorer_5_methods);
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						...
						edge_explorer_6 = new EdgeExplorer(this, 8, 7, edge_explorer_6_methods);
			...
			case "Staff_object_SP0": 
				{
					...
					start(edge_explorer_8_2_orchestration, match_5);
				}
				break;
