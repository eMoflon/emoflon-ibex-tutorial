...
public class NurseShiftplanRule__CC_96_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.multi_lookup = (o) -> ((AdministrationExample.Shiftplan) o).getCovers();
						edge_explorer_methods.multi_opposite_lookup = (o) -> ((AdministrationExample.Patient) o).getCoveredBy();
						edge_explorer = new EdgeExplorer(this, 8, 1, edge_explorer_methods);
			...
			case "Patient_object_SP0": 
				{
					...
					// p1
					HMatch match_0 = new LocalSearchMatch("NurseShiftplanRule__CC_96_localSearch", 9);
			...
			case "Patient_1_object_SP1": 
				{
					...
					// p2
					HMatch match_1 = new LocalSearchMatch("NurseShiftplanRule__CC_96_localSearch", 9);
			...
			case "PatientToPatient_object_SP1": 
				{
					...
					// pToP
					HMatch match_2 = new LocalSearchMatch("NurseShiftplanRule__CC_96_localSearch", 9);
			...
			case "Room_object_SP2": 
				{
					...
					// ro
					HMatch match_3 = new LocalSearchMatch("NurseShiftplanRule__CC_96_localSearch", 9);
			...
			case "Nurse_object_SP0": 
				{
					...
					// s1
					HMatch match_4 = new LocalSearchMatch("NurseShiftplanRule__CC_96_localSearch", 9);
			...
			case "Staff_object_SP0": 
				{
					...
					// s2
					HMatch match_5 = new LocalSearchMatch("NurseShiftplanRule__CC_96_localSearch", 9);
			...
			case "StaffToStaff_object_SP2": 
				{
					...
					// sToS
					HMatch match_6 = new LocalSearchMatch("NurseShiftplanRule__CC_96_localSearch", 9);
			...
			case "Shift_object_SP2": 
				{
					...
					// sh
					HMatch match_7 = new LocalSearchMatch("NurseShiftplanRule__CC_96_localSearch", 9);
			...
			case "Shiftplan_object_SP0": 
				{
					...
					// sp
					HMatch match_8 = new LocalSearchMatch("NurseShiftplanRule__CC_96_localSearch", 9);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "Shiftplan_covers_Patient": 
			{
				HMatch match = new LocalSearchMatch("NurseShiftplanRule__CC_96_localSearch", 9);
				Object[] objs = match.getNodes();
				objs[8] = msg.source;
				objs[1] = msg.target;
				currentDepth++;
