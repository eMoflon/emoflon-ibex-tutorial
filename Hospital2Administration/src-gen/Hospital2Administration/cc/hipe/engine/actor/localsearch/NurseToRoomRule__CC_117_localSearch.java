...
public class NurseToRoomRule__CC_117_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						...
						edge_explorer_5_methods.multi_opposite_lookup = (o) -> ((HospitalExample.Department) o).getStaff().stream().filter(obj -> obj instanceof HospitalExample.Nurse).collect(Collectors.toList());
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						...
						edge_explorer_6 = new EdgeExplorer(this, 0, 6, edge_explorer_6_methods);
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						...
						edge_explorer_7 = new EdgeExplorer(this, 1, 6, edge_explorer_7_methods);
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("NurseToRoomRule__CC_production"), this::returnTrue  , false ));
	}
			...
			case "Department_object_SP2": 
				{
					...
					// dep
					HMatch match_0 = new LocalSearchMatch("NurseToRoomRule__CC_117_localSearch", 8);
			...
			case "Nurse_object_SP0": 
				{
					...
					// n
					HMatch match_1 = new LocalSearchMatch("NurseToRoomRule__CC_117_localSearch", 8);
			...
			case "StaffToStaff_object_SP1": 
				{
					...
					// nToS
					HMatch match_2 = new LocalSearchMatch("NurseToRoomRule__CC_117_localSearch", 8);
			...
			case "Patient_object_SP2": 
				{
					...
					// p1
					HMatch match_3 = new LocalSearchMatch("NurseToRoomRule__CC_117_localSearch", 8);
			...
			case "Patient_1_object_SP0": 
				{
					...
					// p2
					HMatch match_4 = new LocalSearchMatch("NurseToRoomRule__CC_117_localSearch", 8);
			...
			case "PatientToPatient_object_SP0": 
				{
					...
					// pTop
					HMatch match_5 = new LocalSearchMatch("NurseToRoomRule__CC_117_localSearch", 8);
			...
			case "Room_object_SP1": 
				{
					...
					// r
					HMatch match_6 = new LocalSearchMatch("NurseToRoomRule__CC_117_localSearch", 8);
			...
			case "Staff_object_SP2": 
				{
					...
					// s
					HMatch match_7 = new LocalSearchMatch("NurseToRoomRule__CC_117_localSearch", 8);
		...
		case "StaffToStaff_target_Staff": 
			{
				...
				HMatch match = new LocalSearchMatch("NurseToRoomRule__CC_117_localSearch", 8);
				Object[] objs = match.getNodes();
				objs[2] = msg.source;
				objs[7] = msg.target;
				currentDepth++;
