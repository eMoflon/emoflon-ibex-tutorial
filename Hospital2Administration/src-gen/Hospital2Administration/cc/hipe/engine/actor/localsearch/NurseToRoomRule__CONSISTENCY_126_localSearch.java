...
public class NurseToRoomRule__CONSISTENCY_126_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> ((Hospital2Administration.NurseToRoomRule__Marker) o).getCONTEXT__TRG__s();
						edge_explorer_3 = new CachedEdgeExplorer(this, 8, 5, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> ((Hospital2Administration.NurseToRoomRule__Marker) o).getCONTEXT__CORR__pTop();
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> ((Hospital2Administration.NurseToRoomRule__Marker) o).getCONTEXT__CORR__nToS();
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> ((HospitalExample.Nurse) o).getResponsible();
						edge_explorer_8_methods.multi_opposite_lookup = (o) -> ((HospitalExample.Room) o).getNurses();
						edge_explorer_8 = new EdgeExplorer(this, 1, 3, edge_explorer_8_methods);
		name2explorer.put("edge_explorer_8", edge_explorer_8);
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> ((Hospital2Administration.NurseToRoomRule__Marker) o).getCONTEXT__SRC__dep();
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> ((Hospital2Administration.NurseToRoomRule__Marker) o).getCONTEXT__SRC__r();
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> ((Hospital2Administration.NurseToRoomRule__Marker) o).getCONTEXT__SRC__n();
						edge_explorer_11 = new CachedEdgeExplorer(this, 8, 1, edge_explorer_11_methods);
		name2explorer.put("edge_explorer_11", edge_explorer_11);
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> ((HospitalExample.Staff) o).getWorks();
						edge_explorer_12_methods.multi_opposite_lookup = (o) -> ((HospitalExample.Department) o).getStaff().stream().filter(obj -> obj instanceof HospitalExample.Nurse).collect(Collectors.toList());
		...
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> ((Hospital2Administration.NurseToRoomRule__Marker) o).getCONTEXT__TRG__p2();
						edge_explorer_13 = new CachedEdgeExplorer(this, 8, 4, edge_explorer_13_methods);
		name2explorer.put("edge_explorer_13", edge_explorer_13);
		EdgeLookupMethods edge_explorer_14_methods = new EdgeLookupMethods();
						edge_explorer_14_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.StaffToStaff) o).getSource(); return (result instanceof HospitalExample.Nurse ? result : null);};
		...
		EdgeLookupMethods edge_explorer_15_methods = new EdgeLookupMethods();
						edge_explorer_15_methods.multi_lookup = (o) -> ((HospitalExample.Room) o).getLies();
						edge_explorer_15_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof HospitalExample.Room) return edge_explorer_15_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
						edge_explorer_15 = new EdgeExplorer(this, 3, 2, edge_explorer_15_methods);
		...
		EdgeLookupMethods edge_explorer_17_methods = new EdgeLookupMethods();
						edge_explorer_17_methods.unique_lookup = (o) -> ((Hospital2Administration.NurseToRoomRule__Marker) o).getCONTEXT__SRC__p1();
			...
			case "Department_object_SP3": 
				{
					...
					// dep
					HMatch match_0 = new LocalSearchMatch("NurseToRoomRule__CONSISTENCY_126_localSearch", 9);
			...
			case "Nurse_object_SP1": 
				{
					...
					// n
					HMatch match_1 = new LocalSearchMatch("NurseToRoomRule__CONSISTENCY_126_localSearch", 9);
			...
			case "Patient_object_SP3": 
				{
					...
					// p1
					HMatch match_2 = new LocalSearchMatch("NurseToRoomRule__CONSISTENCY_126_localSearch", 9);
			...
			case "Room_object_SP2": 
				{
					...
					// r
					HMatch match_3 = new LocalSearchMatch("NurseToRoomRule__CONSISTENCY_126_localSearch", 9);
					match_3.getNodes()[3] = objs[0];
					start(edge_explorer_8_2_orchestration, match_3);
				}
				break;
			case "Patient_1_object_SP1": 
				{
					...
					// p2
					HMatch match_4 = new LocalSearchMatch("NurseToRoomRule__CONSISTENCY_126_localSearch", 9);
			...
			case "Staff_object_SP3": 
				{
					...
					// s
					HMatch match_5 = new LocalSearchMatch("NurseToRoomRule__CONSISTENCY_126_localSearch", 9);
			...
			case "StaffToStaff_object_SP2": 
				{
					...
					// nToS
					HMatch match_6 = new LocalSearchMatch("NurseToRoomRule__CONSISTENCY_126_localSearch", 9);
			...
			case "PatientToPatient_object_SP1": 
				{
					...
					// pTop
					HMatch match_7 = new LocalSearchMatch("NurseToRoomRule__CONSISTENCY_126_localSearch", 9);
			...
			case "NurseToRoomRule__Marker_object": 
				{
					...
					HMatch match_8 = new LocalSearchMatch("NurseToRoomRule__CONSISTENCY_126_localSearch", 9);
		...
		case "PatientToPatient_source_Patient": 
			{
				...
				HMatch match = new LocalSearchMatch("NurseToRoomRule__CONSISTENCY_126_localSearch", 9);
				Object[] objs = match.getNodes();
				objs[7] = msg.source;
				objs[2] = msg.target;
				currentDepth++;
