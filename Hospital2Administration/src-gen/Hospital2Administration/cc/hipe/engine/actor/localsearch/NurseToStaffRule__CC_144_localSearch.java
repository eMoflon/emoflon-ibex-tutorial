...
public class NurseToStaffRule__CC_144_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.multi_lookup = (o) -> ((AdministrationExample.Shiftplan) o).getShifts();
						edge_explorer_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof AdministrationExample.Shiftplan) return edge_explorer_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
						edge_explorer = new EdgeExplorer(this, 7, 6, edge_explorer_methods);
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.multi_lookup = (o) -> ((HospitalExample.Hospital) o).getStaff().stream().filter(obj -> obj instanceof HospitalExample.Nurse).collect(Collectors.toList());
						...
						edge_explorer_4 = new EdgeExplorer(this, 1, 4, edge_explorer_4_methods);
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						...
						edge_explorer_8_methods.multi_opposite_lookup = (o) -> ((HospitalExample.Department) o).getStaff().stream().filter(obj -> obj instanceof HospitalExample.Nurse).collect(Collectors.toList());
						edge_explorer_8 = new EdgeExplorer(this, 4, 0, edge_explorer_8_methods);
