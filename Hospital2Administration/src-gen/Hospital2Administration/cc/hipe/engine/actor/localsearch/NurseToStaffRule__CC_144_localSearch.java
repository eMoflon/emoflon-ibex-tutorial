...
public class NurseToStaffRule__CC_144_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						...
						edge_explorer = new EdgeExplorer(this, 5, 7, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.multi_lookup = (o) -> ((HospitalExample.Hospital) o).getStaff().stream().filter(obj -> obj instanceof HospitalExample.Nurse).collect(Collectors.toList());
						...
						edge_explorer_3 = new EdgeExplorer(this, 1, 4, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> ((HospitalExample.Staff) o).getWorks();
						edge_explorer_4_methods.multi_opposite_lookup = (o) -> ((HospitalExample.Department) o).getStaff().stream().filter(obj -> obj instanceof HospitalExample.Nurse).collect(Collectors.toList());
						edge_explorer_4 = new EdgeExplorer(this, 4, 0, edge_explorer_4_methods);
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.multi_lookup = (o) -> ((AdministrationExample.Administration) o).getStaff();
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> ((Hospital2Administration.HospitalToAdministration) o).getSource();
						edge_explorer_7 = new CachedEdgeExplorer(this, 2, 1, edge_explorer_7_methods);
		name2explorer.put("edge_explorer_7", edge_explorer_7);
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> ((Hospital2Administration.HospitalToAdministration) o).getTarget();
			...
			case "Department_object_SP0": 
				{
					...
					// d
					HMatch match_0 = new LocalSearchMatch("NurseToStaffRule__CC_144_localSearch", 8);
			...
			case "Hospital_object_SP3": 
				{
					...
					// h
					HMatch match_1 = new LocalSearchMatch("NurseToStaffRule__CC_144_localSearch", 8);
			...
			case "HospitalToAdministration_object_SP0": 
				{
					...
					// htov
					HMatch match_2 = new LocalSearchMatch("NurseToStaffRule__CC_144_localSearch", 8);
			...
			case "Administration_object_SP1": 
				{
					...
					// v
					HMatch match_3 = new LocalSearchMatch("NurseToStaffRule__CC_144_localSearch", 8);
			...
			case "Nurse_object_SP0": 
				{
					...
					// s1
					HMatch match_4 = new LocalSearchMatch("NurseToStaffRule__CC_144_localSearch", 8);
			...
			case "Staff_object_SP0": 
				{
					...
					// s2
					HMatch match_5 = new LocalSearchMatch("NurseToStaffRule__CC_144_localSearch", 8);
					match_5.getNodes()[5] = objs[0];
					start(edge_explorer_1_orchestration, match_5);
				}
				break;
			case "Shift_object_SP1": 
				{
					
					// sh
					HMatch match_6 = new LocalSearchMatch("NurseToStaffRule__CC_144_localSearch", 8);
			...
			case "Shiftplan_object_SP2": 
				{
					...
					// sp
					HMatch match_7 = new LocalSearchMatch("NurseToStaffRule__CC_144_localSearch", 8);
		...
		switch(match.creator) {
			...
			case "NurseToStaffRule_s2_shiftPlan_outgoing_TRG__FILTER_NAC_TRG_136_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("NurseToStaffRule__CC_144_localSearch", 8);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
			...
			case "NurseToStaffRule_sp_shifts_outgoing_TRG__FILTER_NAC_TRG_140_localSearch": 
				if(nac_checker_0.deregister(match)) {
					HMatch acMatch_1 = new LocalSearchMatch("NurseToStaffRule__CC_144_localSearch", 8);
					Object[] acMatch_nodes_1 = acMatch_1.getNodes();
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "Staff_shiftPlan_Shiftplan": 
			{
				HMatch match = new LocalSearchMatch("NurseToStaffRule__CC_144_localSearch", 8);
				Object[] objs = match.getNodes();
				objs[5] = msg.source;
				objs[7] = msg.target;
				currentDepth++;
