...
public class PatientInReception__CONSISTENCY_174_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> ((Hospital2Administration.PatientInReception__Marker) o).getCREATE__TRG__p2();
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						...
						edge_explorer_3 = new CachedEdgeExplorer(this, 6, 3, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> ((Hospital2Administration.PatientInReception__Marker) o).getCONTEXT__CORR__htov();
						edge_explorer_4 = new CachedEdgeExplorer(this, 7, 5, edge_explorer_4_methods);
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						...
						edge_explorer_6 = new EdgeExplorer(this, 0, 2, edge_explorer_6_methods);
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						...
						edge_explorer_7 = new EdgeExplorer(this, 4, 3, edge_explorer_7_methods);
		name2explorer.put("edge_explorer_7", edge_explorer_7);
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> ((Hospital2Administration.PatientInReception__Marker) o).getCREATE__CORR__pTop();
						edge_explorer_8 = new CachedEdgeExplorer(this, 7, 6, edge_explorer_8_methods);
		name2explorer.put("edge_explorer_8", edge_explorer_8);
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> ((Hospital2Administration.PatientToPatient) o).getSource();
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> ((Hospital2Administration.PatientInReception__Marker) o).getCREATE__SRC__p1();
						edge_explorer_10 = new CachedEdgeExplorer(this, 7, 1, edge_explorer_10_methods);
		name2explorer.put("edge_explorer_10", edge_explorer_10);
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> ((Hospital2Administration.PatientInReception__Marker) o).getCONTEXT__SRC__r();
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> ((Hospital2Administration.HospitalToAdministration) o).getSource();
						edge_explorer_12 = new CachedEdgeExplorer(this, 5, 0, edge_explorer_12_methods);
		name2explorer.put("edge_explorer_12", edge_explorer_12);
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> ((Hospital2Administration.PatientInReception__Marker) o).getCONTEXT__SRC__h();
		...
		EdgeLookupMethods edge_explorer_14_methods = new EdgeLookupMethods();
						edge_explorer_14_methods.multi_lookup = (o) -> ((HospitalExample.Reception) o).getWaits();
						edge_explorer_14_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof HospitalExample.Reception) return edge_explorer_14_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
						edge_explorer_14 = new EdgeExplorer(this, 2, 1, edge_explorer_14_methods);
		name2explorer.put("edge_explorer_14", edge_explorer_14);
		EdgeLookupMethods edge_explorer_15_methods = new EdgeLookupMethods();
						edge_explorer_15_methods.unique_lookup = (o) -> ((Hospital2Administration.PatientInReception__Marker) o).getCONTEXT__TRG__v();
						edge_explorer_15 = new CachedEdgeExplorer(this, 7, 4, edge_explorer_15_methods);
			...
			case "Hospital_object_SP2": 
				{
					...
					// h
					HMatch match_0 = new LocalSearchMatch("PatientInReception__CONSISTENCY_174_localSearch", 8);
			...
			case "Patient_object_SP2": 
				{
					...
					// p1
					HMatch match_1 = new LocalSearchMatch("PatientInReception__CONSISTENCY_174_localSearch", 8);
			...
			case "Reception_object_SP0": 
				{
					...
					// r
					HMatch match_2 = new LocalSearchMatch("PatientInReception__CONSISTENCY_174_localSearch", 8);
					match_2.getNodes()[2] = objs[0];
					start(edge_explorer_6_2_orchestration, match_2);
				}
				break;
			case "Patient_1_object_SP0": 
				{
					...
					// p2
					HMatch match_3 = new LocalSearchMatch("PatientInReception__CONSISTENCY_174_localSearch", 8);
			...
			case "Administration_object_SP1": 
				{
					...
					// v
					HMatch match_4 = new LocalSearchMatch("PatientInReception__CONSISTENCY_174_localSearch", 8);
			...
			case "HospitalToAdministration_object_SP0": 
				{
					...
					// htov
					HMatch match_5 = new LocalSearchMatch("PatientInReception__CONSISTENCY_174_localSearch", 8);
			...
			case "PatientToPatient_object_SP2": 
				{
					...
					// pTop
					HMatch match_6 = new LocalSearchMatch("PatientInReception__CONSISTENCY_174_localSearch", 8);
			...
			case "PatientInReception__Marker_object": 
				{
					...
					HMatch match_7 = new LocalSearchMatch("PatientInReception__CONSISTENCY_174_localSearch", 8);
					match_7.getNodes()[7] = objs[0];
					start(edge_explorer_1_orchestration, match_7);
				}
				break;
			case "PatientInReception_p1_lies_incoming_SRC__FILTER_NAC_SRC_164_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "PatientInReception_p1_lies_incoming_SRC__FILTER_NAC_SRC_164_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("PatientInReception__CONSISTENCY_174_localSearch", 8);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
		...
		case "PatientInReception__Marker_CREATE__TRG__p2_Patient": 
			{
				...
				HMatch match = new LocalSearchMatch("PatientInReception__CONSISTENCY_174_localSearch", 8);
				Object[] objs = match.getNodes();
				objs[7] = msg.source;
				objs[3] = msg.target;
				currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_incrementingPatientID csp_24 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_incrementingPatientID();
		csp_24.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, p1.getPatientID(), "int"));
		csp_24.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, p2.getPatientID(), "int"));
		csp_24.solve();
	...
	public boolean constraint_checker_0_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_nametoname csp_25 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_nametoname();
		csp_25.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, " ", "java.lang.String"));
		csp_25.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, p2.getFirstName(), "java.lang.String"));
		csp_25.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, p2.getLastName(), "java.lang.String"));
		csp_25.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, p1.getName(), "java.lang.String"));
		csp_25.solve();
