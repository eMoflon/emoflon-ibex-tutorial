...
public class PatientInRoom__CC_186_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						...
						edge_explorer_4 = new EdgeExplorer(this, 3, 5, edge_explorer_4_methods);
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						...
						edge_explorer_7 = new CachedEdgeExplorer(this, 2, 4, edge_explorer_7_methods);
			...
			case "Department_object_SP2": 
				{
					...
					// d
					HMatch match_0 = new LocalSearchMatch("PatientInRoom__CC_186_localSearch", 7);
			...
			case "Hospital_object_SP3": 
				{
					...
					// h
					HMatch match_1 = new LocalSearchMatch("PatientInRoom__CC_186_localSearch", 7);
			...
			case "HospitalToAdministration_object_SP1": 
				{
					...
					// htov
					HMatch match_2 = new LocalSearchMatch("PatientInRoom__CC_186_localSearch", 7);
			...
			case "Room_object_SP1": 
				{
					...
					// ro
					HMatch match_3 = new LocalSearchMatch("PatientInRoom__CC_186_localSearch", 7);
			...
			case "Administration_object_SP2": 
				{
					...
					// v
					HMatch match_4 = new LocalSearchMatch("PatientInRoom__CC_186_localSearch", 7);
			...
			case "Patient_object_SP3": 
				{
					...
					// p1
					HMatch match_5 = new LocalSearchMatch("PatientInRoom__CC_186_localSearch", 7);
			...
			case "Patient_1_object_SP1": 
				{
					...
					// p2
					HMatch match_6 = new LocalSearchMatch("PatientInRoom__CC_186_localSearch", 7);
		...
		switch(match.creator) {
			...
			case "PatientInRoom_p1_waits_incoming_SRC__FILTER_NAC_SRC_183_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("PatientInRoom__CC_186_localSearch", 7);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "Hospital_department_Department": 
			{
				HMatch match = new LocalSearchMatch("PatientInRoom__CC_186_localSearch", 7);
				Object[] objs = match.getNodes();
				objs[1] = msg.source;
				objs[0] = msg.target;
				currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_incrementingPatientID csp_26 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_incrementingPatientID();
		csp_26.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, p1.getPatientID(), "int"));
		csp_26.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, p2.getPatientID(), "int"));
		csp_26.solve();
	...
	public boolean constraint_checker_0_method(HMatch match) {
		...
		csp_27.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, p2.getFirstName(), "java.lang.String"));
		csp_27.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, p2.getLastName(), "java.lang.String"));
		csp_27.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, p1.getName(), "java.lang.String"));
		csp_27.solve();
