...
public class PatientInRoom__CONSISTENCY_194_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> ((Hospital2Administration.PatientInRoom__Marker) o).getCONTEXT__TRG__v();
						edge_explorer_4 = new CachedEdgeExplorer(this, 8, 5, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> ((Hospital2Administration.PatientInRoom__Marker) o).getCONTEXT__SRC__h();
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> ((Hospital2Administration.PatientInRoom__Marker) o).getCREATE__TRG__p2();
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.multi_lookup = (o) -> ((HospitalExample.Room) o).getLies();
						edge_explorer_11_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof HospitalExample.Room) return edge_explorer_11_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
						edge_explorer_11 = new EdgeExplorer(this, 3, 2, edge_explorer_11_methods);
		name2explorer.put("edge_explorer_11", edge_explorer_11);
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> ((Hospital2Administration.PatientInRoom__Marker) o).getCREATE__SRC__p1();
		...
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						...
						edge_explorer_13 = new EdgeExplorer(this, 5, 4, edge_explorer_13_methods);
		name2explorer.put("edge_explorer_13", edge_explorer_13);
		EdgeLookupMethods edge_explorer_14_methods = new EdgeLookupMethods();
						edge_explorer_14_methods.unique_lookup = (o) -> ((Hospital2Administration.PatientInRoom__Marker) o).getCONTEXT__CORR__htov();
		...
		EdgeLookupMethods edge_explorer_16_methods = new EdgeLookupMethods();
						...
						edge_explorer_16 = new CachedEdgeExplorer(this, 6, 5, edge_explorer_16_methods);
		name2explorer.put("edge_explorer_16", edge_explorer_16);
		EdgeLookupMethods edge_explorer_17_methods = new EdgeLookupMethods();
						edge_explorer_17_methods.unique_lookup = (o) -> ((Hospital2Administration.HospitalToAdministration) o).getSource();
						edge_explorer_17 = new CachedEdgeExplorer(this, 6, 1, edge_explorer_17_methods);
			...
			case "HospitalToAdministration_object_SP2": 
				{
					...
					start(edge_explorer_14_1_orchestration, match_6);
				}
				break;
