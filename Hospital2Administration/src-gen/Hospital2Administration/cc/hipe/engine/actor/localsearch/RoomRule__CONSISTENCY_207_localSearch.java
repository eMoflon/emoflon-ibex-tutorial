...
public class RoomRule__CONSISTENCY_207_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> ((Hospital2Administration.RoomRule__Marker) o).getCONTEXT__SRC__d();
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> ((Hospital2Administration.RoomRule__Marker) o).getCREATE__SRC__ro();
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("RoomRule__CONSISTENCY_production"), this::returnTrue , 0  , false ));
	}
			...
			case "Department_object_SP1": 
				{
					...
					// d
					HMatch match_0 = new LocalSearchMatch("RoomRule__CONSISTENCY_207_localSearch", 3);
			...
			case "Room_object_SP1": 
				{
					...
					// ro
					HMatch match_1 = new LocalSearchMatch("RoomRule__CONSISTENCY_207_localSearch", 3);
					match_1.getNodes()[1] = objs[0];
					start(edge_explorer_3_1_orchestration, match_1);
				}
				break;
			case "RoomRule__Marker_object": 
				{
					edge_explorer.registerSourceObject(objs[0]);
					edge_explorer_4.registerSourceObject(objs[0]);
					
					// RoomRule_eMoflon_ProtocolNode
					HMatch match_2 = new LocalSearchMatch("RoomRule__CONSISTENCY_207_localSearch", 3);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		switch(msg.refName) {
		case "RoomRule__Marker_CONTEXT__SRC__d_Department": 
			{
				edge_explorer.registerEdge(msg.source, msg.target);
				HMatch match = new LocalSearchMatch("RoomRule__CONSISTENCY_207_localSearch", 3);
				Object[] objs = match.getNodes();
				objs[2] = msg.source;
				objs[0] = msg.target;
				currentDepth++;
		...
		case "Department_rooms_Room": 
			...
			break;
		case "RoomRule__Marker_CREATE__SRC__ro_Room": 
			{
	...
	protected void registerMatch(HMatch match) {
		...
		// register RoomRule_eMoflon_ProtocolNode
	...
	protected void deregisterMatch(HMatch match) {
		...
		// deregister RoomRule_eMoflon_ProtocolNode
		Collection<HMatch> matches_2 = obj2matches.get(objs[2]);
		if(matches_2 != null) {
