...
public class DoctorShiftplanRule__CO_14_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						...
						edge_explorer_6 = new EdgeExplorer(this, 7, 1, edge_explorer_6_methods);
		name2explorer.put("edge_explorer_6", edge_explorer_6);
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.multi_lookup = (o) -> ((AdministrationExample.Shiftplan) o).getShifts();
						edge_explorer_7_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof AdministrationExample.Shiftplan) return edge_explorer_7_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
						edge_explorer_7 = new EdgeExplorer(this, 7, 6, edge_explorer_7_methods);
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						...
						edge_explorer_8 = new EdgeExplorer(this, 4, 7, edge_explorer_8_methods);
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("DoctorShiftplanRule__CO_production"), this::returnTrue  , false ));
	}
			...
			case "Patient_object_SP0": 
				{
					...
					// p1
					HMatch match_0 = new LocalSearchMatch("DoctorShiftplanRule__CO_14_localSearch", 8);
			...
			case "Patient_1_object_SP0": 
				{
					...
					// p2
					HMatch match_1 = new LocalSearchMatch("DoctorShiftplanRule__CO_14_localSearch", 8);
			...
			case "PatientToPatient_object_SP0": 
				{
					...
					// pToP
					HMatch match_2 = new LocalSearchMatch("DoctorShiftplanRule__CO_14_localSearch", 8);
			...
			case "Doctor_object": 
				{
					...
					// s1
					HMatch match_3 = new LocalSearchMatch("DoctorShiftplanRule__CO_14_localSearch", 8);
			...
			case "Staff_object_SP1": 
				{
					...
					// s2
					HMatch match_4 = new LocalSearchMatch("DoctorShiftplanRule__CO_14_localSearch", 8);
			...
			case "StaffToStaff_object_SP1": 
				{
					...
					// sToS
					HMatch match_5 = new LocalSearchMatch("DoctorShiftplanRule__CO_14_localSearch", 8);
			...
			case "Shift_object": 
				{
					...
					// sh
					HMatch match_6 = new LocalSearchMatch("DoctorShiftplanRule__CO_14_localSearch", 8);
			...
			case "Shiftplan_object": 
				{
					...
					// sp
					HMatch match_7 = new LocalSearchMatch("DoctorShiftplanRule__CO_14_localSearch", 8);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "Patient_doctor_Doctor": 
			{
				HMatch match = new LocalSearchMatch("DoctorShiftplanRule__CO_14_localSearch", 8);
				Object[] objs = match.getNodes();
				objs[0] = msg.source;
				objs[3] = msg.target;
				currentDepth++;
