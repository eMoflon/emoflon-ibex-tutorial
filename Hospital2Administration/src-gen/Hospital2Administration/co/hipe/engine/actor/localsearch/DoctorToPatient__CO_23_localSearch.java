...
public class DoctorToPatient__CO_23_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> ((HospitalExample.Patient) o).getDoctor();
						edge_explorer_7_methods.multi_opposite_lookup = (o) -> ((HospitalExample.Doctor) o).getCaresfor();
						edge_explorer_7 = new EdgeExplorer(this, 3, 0, edge_explorer_7_methods);
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						...
						edge_explorer_8 = new CachedEdgeExplorer(this, 1, 7, edge_explorer_8_methods);
		name2explorer.put("edge_explorer_8", edge_explorer_8);
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.multi_lookup = (o) -> ((AdministrationExample.Staff) o).getTreatment();
						edge_explorer_9 = new CachedEdgeExplorer(this, 7, 8, edge_explorer_9_methods);
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						...
						edge_explorer_10 = new EdgeExplorer(this, 4, 8, edge_explorer_10_methods);
			...
			case "Staff_object_SP0": 
				{
					...
					start(edge_explorer_8_1_orchestration, match_7);
				}
				break;
