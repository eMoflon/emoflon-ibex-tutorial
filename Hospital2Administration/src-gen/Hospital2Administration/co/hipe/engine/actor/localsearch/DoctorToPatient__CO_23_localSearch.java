...
public class DoctorToPatient__CO_23_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> ((Hospital2Administration.PatientToPatient) o).getSource();
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						...
						edge_explorer_5 = new EdgeExplorer(this, 4, 8, edge_explorer_5_methods);
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						...
						edge_explorer_8 = new CachedEdgeExplorer(this, 1, 0, edge_explorer_8_methods);
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						...
						edge_explorer_9 = new EdgeExplorer(this, 0, 2, edge_explorer_9_methods);
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						...
						edge_explorer_11 = new EdgeExplorer(this, 3, 0, edge_explorer_11_methods);
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("DoctorToPatient__CO_production"), this::returnTrue , 0  , false ));
	}
			...
			case "Doctor_object": 
				{
					...
					// d
					HMatch match_0 = new LocalSearchMatch("DoctorToPatient__CO_23_localSearch", 9);
			...
			case "StaffToStaff_object_SP0": 
				{
					...
					// dToS
					HMatch match_1 = new LocalSearchMatch("DoctorToPatient__CO_23_localSearch", 9);
			...
			case "Department_object_SP0": 
				{
					...
					// dep
					HMatch match_2 = new LocalSearchMatch("DoctorToPatient__CO_23_localSearch", 9);
					match_2.getNodes()[2] = objs[0];
					start(edge_explorer_9_1_orchestration, match_2);
				}
				break;
			case "Patient_object_SP1": 
				{
					...
					// p1
					HMatch match_3 = new LocalSearchMatch("DoctorToPatient__CO_23_localSearch", 9);
			...
			case "Patient_1_object_SP1": 
				{
					...
					// p2
					HMatch match_4 = new LocalSearchMatch("DoctorToPatient__CO_23_localSearch", 9);
			...
			case "PatientToPatient_object_SP1": 
				{
					...
					// pToP
					HMatch match_5 = new LocalSearchMatch("DoctorToPatient__CO_23_localSearch", 9);
			...
			case "Room_object_SP0": 
				{
					...
					// ro
					HMatch match_6 = new LocalSearchMatch("DoctorToPatient__CO_23_localSearch", 9);
			...
			case "Staff_object_SP0": 
				{
					...
					// s
					HMatch match_7 = new LocalSearchMatch("DoctorToPatient__CO_23_localSearch", 9);
			...
			case "Treatment_object": 
				{
					...
					// t
					HMatch match_8 = new LocalSearchMatch("DoctorToPatient__CO_23_localSearch", 9);
		...
		case "StaffToStaff_target_Staff": 
			{
				...
				HMatch match = new LocalSearchMatch("DoctorToPatient__CO_23_localSearch", 9);
				Object[] objs = match.getNodes();
				objs[1] = msg.source;
				objs[7] = msg.target;
				currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_carelevelToMedication csp_6 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_carelevelToMedication();
		csp_6.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, p1.getLevel(), "Enum::Carelevel"));
		csp_6.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, t.getMedication(), "Enum::Medication"));
		csp_6.solve();
