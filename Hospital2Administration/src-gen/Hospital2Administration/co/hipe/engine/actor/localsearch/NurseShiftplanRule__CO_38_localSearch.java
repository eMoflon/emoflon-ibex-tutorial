...
public class NurseShiftplanRule__CO_38_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						...
						edge_explorer = new EdgeExplorer(this, 8, 7, edge_explorer_methods);
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						...
						edge_explorer_3 = new EdgeExplorer(this, 8, 1, edge_explorer_3_methods);
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						...
						edge_explorer_5 = new EdgeExplorer(this, 3, 0, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> ((HospitalExample.Nurse) o).getResponsible();
						edge_explorer_6_methods.multi_opposite_lookup = (o) -> ((HospitalExample.Room) o).getNurses();
						edge_explorer_6 = new EdgeExplorer(this, 4, 3, edge_explorer_6_methods);
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						...
						edge_explorer_7 = new EdgeExplorer(this, 5, 8, edge_explorer_7_methods);
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						...
						edge_explorer_10 = new CachedEdgeExplorer(this, 2, 0, edge_explorer_10_methods);
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("NurseShiftplanRule__CO_production"), this::returnTrue  , false ));
	}
			...
			case "Patient_object_SP0": 
				{
					...
					// p1
					HMatch match_0 = new LocalSearchMatch("NurseShiftplanRule__CO_38_localSearch", 9);
			...
			case "Patient_1_object_SP0": 
				{
					...
					// p2
					HMatch match_1 = new LocalSearchMatch("NurseShiftplanRule__CO_38_localSearch", 9);
			...
			case "PatientToPatient_object_SP0": 
				{
					...
					// pToP
					HMatch match_2 = new LocalSearchMatch("NurseShiftplanRule__CO_38_localSearch", 9);
			...
			case "Room_object_SP1": 
				{
					...
					// ro
					HMatch match_3 = new LocalSearchMatch("NurseShiftplanRule__CO_38_localSearch", 9);
			...
			case "Nurse_object": 
				{
					...
					// s1
					HMatch match_4 = new LocalSearchMatch("NurseShiftplanRule__CO_38_localSearch", 9);
			...
			case "Staff_object_SP1": 
				{
					...
					// s2
					HMatch match_5 = new LocalSearchMatch("NurseShiftplanRule__CO_38_localSearch", 9);
			...
			case "StaffToStaff_object_SP1": 
				{
					...
					// sToS
					HMatch match_6 = new LocalSearchMatch("NurseShiftplanRule__CO_38_localSearch", 9);
			...
			case "Shift_object": 
				{
					...
					// sh
					HMatch match_7 = new LocalSearchMatch("NurseShiftplanRule__CO_38_localSearch", 9);
			...
			case "Shiftplan_object": 
				{
					...
					// sp
					HMatch match_8 = new LocalSearchMatch("NurseShiftplanRule__CO_38_localSearch", 9);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "Shiftplan_shifts_Shift": 
			{
				HMatch match = new LocalSearchMatch("NurseShiftplanRule__CO_38_localSearch", 9);
				Object[] objs = match.getNodes();
				objs[8] = msg.source;
				objs[7] = msg.target;
				currentDepth++;
