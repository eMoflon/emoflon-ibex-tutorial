...
public class NurseShiftplanRule__CO_38_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						...
						edge_explorer = new EdgeExplorer(this, 5, 8, edge_explorer_methods);
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						...
						edge_explorer_9 = new EdgeExplorer(this, 3, 0, edge_explorer_9_methods);
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						...
						edge_explorer_10 = new EdgeExplorer(this, 8, 7, edge_explorer_10_methods);
			...
			case "Shift_object": 
				{
					...
					start(edge_explorer_10_1_orchestration, match_7);
				}
				break;
