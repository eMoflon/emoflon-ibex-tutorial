...
public class NurseToRoomRule__CO_48_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						...
						edge_explorer_6 = new EdgeExplorer(this, 1, 6, edge_explorer_6_methods);
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						...
						edge_explorer_7 = new EdgeExplorer(this, 0, 6, edge_explorer_7_methods);
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("NurseToRoomRule__CO_production"), this::returnTrue  , false ));
	}
			...
			case "Department_object_SP1": 
				{
					...
					// dep
					HMatch match_0 = new LocalSearchMatch("NurseToRoomRule__CO_48_localSearch", 8);
			...
			case "Nurse_object": 
				{
					...
					// n
					HMatch match_1 = new LocalSearchMatch("NurseToRoomRule__CO_48_localSearch", 8);
			...
			case "StaffToStaff_object_SP0": 
				{
					...
					// nToS
					HMatch match_2 = new LocalSearchMatch("NurseToRoomRule__CO_48_localSearch", 8);
			...
			case "Patient_object_SP1": 
				{
					...
					// p1
					HMatch match_3 = new LocalSearchMatch("NurseToRoomRule__CO_48_localSearch", 8);
			...
			case "Patient_1_object_SP1": 
				{
					...
					// p2
					HMatch match_4 = new LocalSearchMatch("NurseToRoomRule__CO_48_localSearch", 8);
					match_4.getNodes()[4] = objs[0];
					start(edge_explorer_9_1_orchestration, match_4);
				}
				break;
			case "PatientToPatient_object_SP1": 
				{
					...
					// pTop
					HMatch match_5 = new LocalSearchMatch("NurseToRoomRule__CO_48_localSearch", 8);
			...
			case "Room_object_SP0": 
				{
					...
					// r
					HMatch match_6 = new LocalSearchMatch("NurseToRoomRule__CO_48_localSearch", 8);
			...
			case "Staff_object_SP0": 
				{
					...
					// s
					HMatch match_7 = new LocalSearchMatch("NurseToRoomRule__CO_48_localSearch", 8);
		...
		case "PatientToPatient_source_Patient": 
			{
				...
				HMatch match = new LocalSearchMatch("NurseToRoomRule__CO_48_localSearch", 8);
				Object[] objs = match.getNodes();
				objs[5] = msg.source;
				objs[3] = msg.target;
				currentDepth++;
