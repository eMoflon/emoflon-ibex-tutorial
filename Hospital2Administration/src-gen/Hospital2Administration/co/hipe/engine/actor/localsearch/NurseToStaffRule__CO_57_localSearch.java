...
public class NurseToStaffRule__CO_57_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.StaffToStaff) o).getSource(); return (result instanceof HospitalExample.Nurse ? result : null);};
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.multi_lookup = (o) -> ((HospitalExample.Hospital) o).getStaff().stream().filter(obj -> obj instanceof HospitalExample.Nurse).collect(Collectors.toList());
						edge_explorer_9_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof HospitalExample.Hospital) return edge_explorer_9_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
						edge_explorer_9 = new EdgeExplorer(this, 1, 4, edge_explorer_9_methods);
		name2explorer.put("edge_explorer_9", edge_explorer_9);
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.multi_lookup = (o) -> ((AdministrationExample.Shiftplan) o).getShifts();
						edge_explorer_10_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof AdministrationExample.Shiftplan) return edge_explorer_10_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
						edge_explorer_10 = new EdgeExplorer(this, 7, 6, edge_explorer_10_methods);
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("NurseToStaffRule__CO_production"), this::returnTrue , 0  , false ));
	}
			...
			case "Department_object_SP0": 
				{
					...
					// d
					HMatch match_0 = new LocalSearchMatch("NurseToStaffRule__CO_57_localSearch", 9);
					match_0.getNodes()[0] = objs[0];
					start(edge_explorer_6_2_orchestration, match_0);
				}
				break;
			case "Hospital_object_SP1": 
				{
					...
					// h
					HMatch match_1 = new LocalSearchMatch("NurseToStaffRule__CO_57_localSearch", 9);
			...
			case "HospitalToAdministration_object_SP0": 
				{
					...
					// htov
					HMatch match_2 = new LocalSearchMatch("NurseToStaffRule__CO_57_localSearch", 9);
			...
			case "Administration_object_SP0": 
				{
					...
					// v
					HMatch match_3 = new LocalSearchMatch("NurseToStaffRule__CO_57_localSearch", 9);
			...
			case "Nurse_object": 
				{
					...
					// s1
					HMatch match_4 = new LocalSearchMatch("NurseToStaffRule__CO_57_localSearch", 9);
			...
			case "Staff_object_SP1": 
				{
					...
					// s2
					HMatch match_5 = new LocalSearchMatch("NurseToStaffRule__CO_57_localSearch", 9);
			...
			case "Shift_object": 
				{
					...
					// sh
					HMatch match_6 = new LocalSearchMatch("NurseToStaffRule__CO_57_localSearch", 9);
			...
			case "Shiftplan_object": 
				{
					...
					// sp
					HMatch match_7 = new LocalSearchMatch("NurseToStaffRule__CO_57_localSearch", 9);
			...
			case "StaffToStaff_object_SP1": 
				{
					...
					// stot
					HMatch match_8 = new LocalSearchMatch("NurseToStaffRule__CO_57_localSearch", 9);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "Staff_shiftPlan_Shiftplan": 
			{
				HMatch match = new LocalSearchMatch("NurseToStaffRule__CO_57_localSearch", 9);
				Object[] objs = match.getNodes();
				objs[5] = msg.source;
				objs[7] = msg.target;
				currentDepth++;
	...
	public boolean constraint_checker_2_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_nursesalary csp_10 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_nursesalary();
		csp_10.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, s2.getSalary(), "double"));
		csp_10.solve();
