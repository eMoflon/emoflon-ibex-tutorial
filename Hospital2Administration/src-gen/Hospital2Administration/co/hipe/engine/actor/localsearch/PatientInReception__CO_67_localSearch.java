...
public class PatientInReception__CO_67_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						...
						edge_explorer_5 = new CachedEdgeExplorer(this, 1, 3, edge_explorer_5_methods);
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> ((HospitalExample.Hospital) o).getReception();
						edge_explorer_7_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof HospitalExample.Hospital) return o.equals(edge_explorer_7_methods.unique_lookup.apply(result)) ? result : null; else return null;};
						edge_explorer_7 = new EdgeExplorer(this, 0, 2, edge_explorer_7_methods);
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("PatientInReception__CO_production"), this::returnTrue , 0  , false ));
	}
			...
			case "Hospital_object_SP0": 
				{
					...
					// h
					HMatch match_0 = new LocalSearchMatch("PatientInReception__CO_67_localSearch", 7);
			...
			case "HospitalToAdministration_object_SP1": 
				{
					...
					// htov
					HMatch match_1 = new LocalSearchMatch("PatientInReception__CO_67_localSearch", 7);
			...
			case "Reception_object": 
				{
					...
					// r
					HMatch match_2 = new LocalSearchMatch("PatientInReception__CO_67_localSearch", 7);
			...
			case "Administration_object_SP1": 
				{
					...
					// v
					HMatch match_3 = new LocalSearchMatch("PatientInReception__CO_67_localSearch", 7);
			...
			case "Patient_object_SP0": 
				{
					...
					// p1
					HMatch match_4 = new LocalSearchMatch("PatientInReception__CO_67_localSearch", 7);
			...
			case "Patient_1_object_SP0": 
				{
					...
					// p2
					HMatch match_5 = new LocalSearchMatch("PatientInReception__CO_67_localSearch", 7);
			...
			case "PatientToPatient_object_SP0": 
				{
					...
					// pTop
					HMatch match_6 = new LocalSearchMatch("PatientInReception__CO_67_localSearch", 7);
		...
		case "HospitalToAdministration_source_Hospital": 
			{
				...
				HMatch match = new LocalSearchMatch("PatientInReception__CO_67_localSearch", 7);
				Object[] objs = match.getNodes();
				objs[1] = msg.source;
				objs[0] = msg.target;
				currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_incrementingPatientID csp_11 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_incrementingPatientID();
		csp_11.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, p1.getPatientID(), "int"));
		csp_11.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, p2.getPatientID(), "int"));
		csp_11.solve();
	...
	public boolean constraint_checker_0_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_nametoname csp_12 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_nametoname();
		csp_12.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, " ", "java.lang.String"));
		csp_12.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, p2.getFirstName(), "java.lang.String"));
		csp_12.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, p2.getLastName(), "java.lang.String"));
		csp_12.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, p1.getName(), "java.lang.String"));
		csp_12.solve();
