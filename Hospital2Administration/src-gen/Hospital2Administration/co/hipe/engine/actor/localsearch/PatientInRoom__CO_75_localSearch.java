...
public class PatientInRoom__CO_75_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						...
						edge_explorer_3 = new EdgeExplorer(this, 4, 6, edge_explorer_3_methods);
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						...
						edge_explorer_5 = new CachedEdgeExplorer(this, 7, 5, edge_explorer_5_methods);
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						...
						edge_explorer_8 = new EdgeExplorer(this, 0, 3, edge_explorer_8_methods);
		name2explorer.put("edge_explorer_8", edge_explorer_8);
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.multi_lookup = (o) -> ((HospitalExample.Room) o).getLies();
						edge_explorer_9_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof HospitalExample.Room) return edge_explorer_9_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("PatientInRoom__CO_production"), this::returnTrue , 0  , false ));
	}
			...
			case "Department_object_SP1": 
				{
					...
					// d
					HMatch match_0 = new LocalSearchMatch("PatientInRoom__CO_75_localSearch", 8);
			...
			case "Hospital_object_SP1": 
				{
					...
					// h
					HMatch match_1 = new LocalSearchMatch("PatientInRoom__CO_75_localSearch", 8);
			...
			case "HospitalToAdministration_object_SP0": 
				{
					...
					// htov
					HMatch match_2 = new LocalSearchMatch("PatientInRoom__CO_75_localSearch", 8);
			...
			case "Room_object_SP1": 
				{
					...
					// ro
					HMatch match_3 = new LocalSearchMatch("PatientInRoom__CO_75_localSearch", 8);
			...
			case "Administration_object_SP0": 
				{
					...
					// v
					HMatch match_4 = new LocalSearchMatch("PatientInRoom__CO_75_localSearch", 8);
			...
			case "Patient_object_SP1": 
				{
					...
					// p1
					HMatch match_5 = new LocalSearchMatch("PatientInRoom__CO_75_localSearch", 8);
			...
			case "Patient_1_object_SP1": 
				{
					...
					// p2
					HMatch match_6 = new LocalSearchMatch("PatientInRoom__CO_75_localSearch", 8);
			...
			case "PatientToPatient_object_SP1": 
				{
					...
					// pTop
					HMatch match_7 = new LocalSearchMatch("PatientInRoom__CO_75_localSearch", 8);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "Hospital_department_Department": 
			{
				HMatch match = new LocalSearchMatch("PatientInRoom__CO_75_localSearch", 8);
				Object[] objs = match.getNodes();
				objs[1] = msg.source;
				objs[0] = msg.target;
				currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_incrementingPatientID csp_13 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_incrementingPatientID();
		csp_13.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, p1.getPatientID(), "int"));
		csp_13.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, p2.getPatientID(), "int"));
		csp_13.solve();
	...
	public boolean constraint_checker_0_method(HMatch match) {
		...
		csp_14.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, p2.getFirstName(), "java.lang.String"));
		csp_14.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, p2.getLastName(), "java.lang.String"));
		csp_14.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, p1.getName(), "java.lang.String"));
		csp_14.solve();
