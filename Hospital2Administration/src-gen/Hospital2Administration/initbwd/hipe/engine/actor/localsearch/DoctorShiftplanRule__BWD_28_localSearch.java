...
public class DoctorShiftplanRule__BWD_28_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> ((HospitalExample.Patient) o).getDoctor();
						edge_explorer_5_methods.multi_opposite_lookup = (o) -> ((HospitalExample.Doctor) o).getCaresfor();
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						...
						edge_explorer_9 = new EdgeExplorer(this, 4, 7, edge_explorer_9_methods);
			...
			case "Patient_object": 
				{
					...
					// p1
					HMatch match_0 = new LocalSearchMatch("DoctorShiftplanRule__BWD_28_localSearch", 8);
			...
			case "Patient_1_object_SP0": 
				{
					...
					// p2
					HMatch match_1 = new LocalSearchMatch("DoctorShiftplanRule__BWD_28_localSearch", 8);
			...
			case "PatientToPatient_object": 
				{
					...
					// pToP
					HMatch match_2 = new LocalSearchMatch("DoctorShiftplanRule__BWD_28_localSearch", 8);
			...
			case "Doctor_object": 
				{
					...
					// s1
					HMatch match_3 = new LocalSearchMatch("DoctorShiftplanRule__BWD_28_localSearch", 8);
			...
			case "Staff_object_SP0": 
				{
					...
					// s2
					HMatch match_4 = new LocalSearchMatch("DoctorShiftplanRule__BWD_28_localSearch", 8);
			...
			case "StaffToStaff_object": 
				{
					...
					// sToS
					HMatch match_5 = new LocalSearchMatch("DoctorShiftplanRule__BWD_28_localSearch", 8);
			...
			case "Shift_object_SP0": 
				{
					...
					// sh
					HMatch match_6 = new LocalSearchMatch("DoctorShiftplanRule__BWD_28_localSearch", 8);
			...
			case "Shiftplan_object_SP1": 
				{
					...
					// sp
					HMatch match_7 = new LocalSearchMatch("DoctorShiftplanRule__BWD_28_localSearch", 8);
		...
		case "PatientToPatient_target_Patient": 
			{
				...
				HMatch match = new LocalSearchMatch("DoctorShiftplanRule__BWD_28_localSearch", 8);
				Object[] objs = match.getNodes();
				objs[2] = msg.source;
				objs[1] = msg.target;
				currentDepth++;
