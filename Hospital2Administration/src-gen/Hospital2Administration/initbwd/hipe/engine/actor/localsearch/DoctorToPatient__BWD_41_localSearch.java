...
public class DoctorToPatient__BWD_41_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.multi_lookup = (o) -> ((AdministrationExample.Staff) o).getTreatment();
						edge_explorer_4 = new CachedEdgeExplorer(this, 7, 8, edge_explorer_4_methods);
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						...
						edge_explorer_6 = new CachedEdgeExplorer(this, 1, 0, edge_explorer_6_methods);
		name2explorer.put("edge_explorer_6", edge_explorer_6);
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> ((AdministrationExample.Patient) o).getTreatment();
						edge_explorer_7_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof AdministrationExample.Patient) return o.equals(edge_explorer_7_methods.unique_lookup.apply(result)) ? result : null; else return null;};
						edge_explorer_7 = new EdgeExplorer(this, 4, 8, edge_explorer_7_methods);
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> ((Hospital2Administration.PatientToPatient) o).getTarget();
						edge_explorer_9 = new CachedEdgeExplorer(this, 5, 4, edge_explorer_9_methods);
			...
			case "Doctor_object": 
				{
					...
					// d
					HMatch match_0 = new LocalSearchMatch("DoctorToPatient__BWD_41_localSearch", 9);
			...
			case "StaffToStaff_object": 
				{
					...
					// dToS
					HMatch match_1 = new LocalSearchMatch("DoctorToPatient__BWD_41_localSearch", 9);
			...
			case "Department_object": 
				{
					...
					// dep
					HMatch match_2 = new LocalSearchMatch("DoctorToPatient__BWD_41_localSearch", 9);
			...
			case "Patient_object": 
				{
					...
					// p1
					HMatch match_3 = new LocalSearchMatch("DoctorToPatient__BWD_41_localSearch", 9);
			...
			case "Patient_1_object_SP1": 
				{
					...
					// p2
					HMatch match_4 = new LocalSearchMatch("DoctorToPatient__BWD_41_localSearch", 9);
			...
			case "PatientToPatient_object": 
				{
					...
					// pToP
					HMatch match_5 = new LocalSearchMatch("DoctorToPatient__BWD_41_localSearch", 9);
			...
			case "Room_object": 
				{
					...
					// ro
					HMatch match_6 = new LocalSearchMatch("DoctorToPatient__BWD_41_localSearch", 9);
			...
			case "Staff_object_SP1": 
				{
					...
					// s
					HMatch match_7 = new LocalSearchMatch("DoctorToPatient__BWD_41_localSearch", 9);
			...
			case "Treatment_object": 
				{
					...
					// t
					HMatch match_8 = new LocalSearchMatch("DoctorToPatient__BWD_41_localSearch", 9);
					match_8.getNodes()[8] = objs[0];
					start(edge_explorer_4_1_orchestration, match_8);
				}
				break;
			case "DoctorToPatient_t_treatment_incoming_TRG__FILTER_NAC_TRG_37_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "DoctorToPatient_t_treatment_incoming_TRG__FILTER_NAC_TRG_37_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("DoctorToPatient__BWD_41_localSearch", 9);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
		...
		case "StaffToStaff_target_Staff": 
			{
				...
				HMatch match = new LocalSearchMatch("DoctorToPatient__BWD_41_localSearch", 9);
				Object[] objs = match.getNodes();
				objs[1] = msg.source;
				objs[7] = msg.target;
				currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_carelevelToMedication csp_2 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_carelevelToMedication();
		csp_2.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, p1.getLevel(), "Enum::Carelevel"));
		csp_2.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, t.getMedication(), "Enum::Medication"));
		csp_2.solve();
