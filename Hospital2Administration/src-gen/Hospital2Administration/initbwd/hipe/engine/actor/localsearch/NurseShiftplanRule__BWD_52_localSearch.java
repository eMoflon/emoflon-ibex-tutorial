...
public class NurseShiftplanRule__BWD_52_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> ((AdministrationExample.Staff) o).getShiftPlan();
						edge_explorer_5_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof AdministrationExample.Staff) return o.equals(edge_explorer_5_methods.unique_lookup.apply(result)) ? result : null; else return null;};
						edge_explorer_5 = new EdgeExplorer(this, 5, 8, edge_explorer_5_methods);
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						...
						edge_explorer_8 = new EdgeExplorer(this, 8, 7, edge_explorer_8_methods);
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						...
						edge_explorer_9 = new EdgeExplorer(this, 4, 3, edge_explorer_9_methods);
			...
			case "Patient_object": 
				{
					...
					// p1
					HMatch match_0 = new LocalSearchMatch("NurseShiftplanRule__BWD_52_localSearch", 9);
			...
			case "Patient_1_object_SP0": 
				{
					...
					// p2
					HMatch match_1 = new LocalSearchMatch("NurseShiftplanRule__BWD_52_localSearch", 9);
			...
			case "PatientToPatient_object": 
				{
					...
					// pToP
					HMatch match_2 = new LocalSearchMatch("NurseShiftplanRule__BWD_52_localSearch", 9);
			...
			case "Room_object": 
				{
					...
					// ro
					HMatch match_3 = new LocalSearchMatch("NurseShiftplanRule__BWD_52_localSearch", 9);
			...
			case "Nurse_object": 
				{
					...
					// s1
					HMatch match_4 = new LocalSearchMatch("NurseShiftplanRule__BWD_52_localSearch", 9);
					match_4.getNodes()[4] = objs[0];
					start(edge_explorer_7_2_orchestration, match_4);
				}
				break;
			case "Staff_object_SP0": 
				{
					...
					// s2
					HMatch match_5 = new LocalSearchMatch("NurseShiftplanRule__BWD_52_localSearch", 9);
			...
			case "StaffToStaff_object": 
				{
					...
					// sToS
					HMatch match_6 = new LocalSearchMatch("NurseShiftplanRule__BWD_52_localSearch", 9);
			...
			case "Shift_object_SP1": 
				{
					...
					// sh
					HMatch match_7 = new LocalSearchMatch("NurseShiftplanRule__BWD_52_localSearch", 9);
			...
			case "Shiftplan_object_SP2": 
				{
					...
					// sp
					HMatch match_8 = new LocalSearchMatch("NurseShiftplanRule__BWD_52_localSearch", 9);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "Room_lies_Patient": 
			{
				HMatch match = new LocalSearchMatch("NurseShiftplanRule__BWD_52_localSearch", 9);
				Object[] objs = match.getNodes();
				objs[3] = msg.source;
				objs[0] = msg.target;
				currentDepth++;
