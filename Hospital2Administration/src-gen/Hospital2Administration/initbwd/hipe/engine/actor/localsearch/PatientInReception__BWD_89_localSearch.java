...
public class PatientInReception__BWD_89_localSearch extends GenericLocalSearchActor{
			...
			case "Hospital_object": 
				{
					...
					// h
					HMatch match_0 = new LocalSearchMatch("PatientInReception__BWD_89_localSearch", 5);
			...
			case "HospitalToAdministration_object": 
				{
					...
					// htov
					HMatch match_1 = new LocalSearchMatch("PatientInReception__BWD_89_localSearch", 5);
			...
			case "Reception_object": 
				{
					...
					// r
					HMatch match_2 = new LocalSearchMatch("PatientInReception__BWD_89_localSearch", 5);
			...
			case "Administration_object_SP0": 
				{
					...
					// v
					HMatch match_3 = new LocalSearchMatch("PatientInReception__BWD_89_localSearch", 5);
			...
			case "Patient_1_object_SP1": 
				{
					...
					// p2
					HMatch match_4 = new LocalSearchMatch("PatientInReception__BWD_89_localSearch", 5);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "Administration_patient_Patient": 
			{
				HMatch match = new LocalSearchMatch("PatientInReception__BWD_89_localSearch", 5);
				Object[] objs = match.getNodes();
				objs[3] = msg.source;
				objs[4] = msg.target;
				currentDepth++;
