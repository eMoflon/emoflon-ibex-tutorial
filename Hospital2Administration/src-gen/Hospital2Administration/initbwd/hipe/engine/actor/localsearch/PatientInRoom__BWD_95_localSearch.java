...
public class PatientInRoom__BWD_95_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						...
						edge_explorer_6 = new EdgeExplorer(this, 4, 5, edge_explorer_6_methods);
			...
			case "Department_object": 
				{
					...
					// d
					HMatch match_0 = new LocalSearchMatch("PatientInRoom__BWD_95_localSearch", 6);
			...
			case "Hospital_object": 
				{
					...
					// h
					HMatch match_1 = new LocalSearchMatch("PatientInRoom__BWD_95_localSearch", 6);
			...
			case "HospitalToAdministration_object": 
				{
					...
					// htov
					HMatch match_2 = new LocalSearchMatch("PatientInRoom__BWD_95_localSearch", 6);
			...
			case "Room_object": 
				{
					...
					// ro
					HMatch match_3 = new LocalSearchMatch("PatientInRoom__BWD_95_localSearch", 6);
			...
			case "Administration_object_SP1": 
				{
					...
					// v
					HMatch match_4 = new LocalSearchMatch("PatientInRoom__BWD_95_localSearch", 6);
			...
			case "Patient_1_object_SP0": 
				{
					...
					// p2
					HMatch match_5 = new LocalSearchMatch("PatientInRoom__BWD_95_localSearch", 6);
		...
		case "HospitalToAdministration_target_Administration": 
			{
				...
				HMatch match = new LocalSearchMatch("PatientInRoom__BWD_95_localSearch", 6);
				Object[] objs = match.getNodes();
				objs[2] = msg.source;
				objs[4] = msg.target;
				currentDepth++;
