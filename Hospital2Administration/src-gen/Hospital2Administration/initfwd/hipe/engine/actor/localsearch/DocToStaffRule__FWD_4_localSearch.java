...
public class DocToStaffRule__FWD_4_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.multi_lookup = (o) -> ((HospitalExample.Hospital) o).getStaff().stream().filter(obj -> obj instanceof HospitalExample.Doctor).collect(Collectors.toList());
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("DocToStaffRule__FWD_production"), this::returnTrue  , false ));
	}
			...
			case "Department_object_SP1": 
				{
					...
					// d
					HMatch match_0 = new LocalSearchMatch("DocToStaffRule__FWD_4_localSearch", 5);
			...
			case "Hospital_object_SP1": 
				{
					...
					// h
					HMatch match_1 = new LocalSearchMatch("DocToStaffRule__FWD_4_localSearch", 5);
			...
			case "HospitalToAdministration_object": 
				{
					...
					// htov
					HMatch match_2 = new LocalSearchMatch("DocToStaffRule__FWD_4_localSearch", 5);
			...
			case "Administration_object": 
				{
					...
					// v
					HMatch match_3 = new LocalSearchMatch("DocToStaffRule__FWD_4_localSearch", 5);
			...
			case "Doctor_object": 
				{
					...
					// s1
					HMatch match_4 = new LocalSearchMatch("DocToStaffRule__FWD_4_localSearch", 5);
		...
		case "HospitalToAdministration_target_Administration": 
			{
				...
				HMatch match = new LocalSearchMatch("DocToStaffRule__FWD_4_localSearch", 5);
				Object[] objs = match.getNodes();
				objs[2] = msg.source;
				objs[3] = msg.target;
				currentDepth++;
