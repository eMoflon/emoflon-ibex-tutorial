...
public class DoctorToPatient__FWD_10_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("DoctorToPatient__FWD_production"), this::returnTrue  , false ));
	}
			...
			case "Doctor_object": 
				{
					...
					// d
					HMatch match_0 = new LocalSearchMatch("DoctorToPatient__FWD_10_localSearch", 8);
			...
			case "StaffToStaff_object": 
				{
					...
					// dToS
					HMatch match_1 = new LocalSearchMatch("DoctorToPatient__FWD_10_localSearch", 8);
			...
			case "Department_object_SP0": 
				{
					...
					// dep
					HMatch match_2 = new LocalSearchMatch("DoctorToPatient__FWD_10_localSearch", 8);
			...
			case "Patient_object_SP0": 
				{
					...
					// p1
					HMatch match_3 = new LocalSearchMatch("DoctorToPatient__FWD_10_localSearch", 8);
			...
			case "Patient_1_object": 
				{
					...
					// p2
					HMatch match_4 = new LocalSearchMatch("DoctorToPatient__FWD_10_localSearch", 8);
			...
			case "PatientToPatient_object": 
				{
					...
					// pToP
					HMatch match_5 = new LocalSearchMatch("DoctorToPatient__FWD_10_localSearch", 8);
			...
			case "Room_object_SP0": 
				{
					...
					// ro
					HMatch match_6 = new LocalSearchMatch("DoctorToPatient__FWD_10_localSearch", 8);
			...
			case "Staff_object": 
				{
					...
					// s
					HMatch match_7 = new LocalSearchMatch("DoctorToPatient__FWD_10_localSearch", 8);
		...
		case "StaffToStaff_target_Staff": 
			{
				...
				HMatch match = new LocalSearchMatch("DoctorToPatient__FWD_10_localSearch", 8);
				Object[] objs = match.getNodes();
				objs[1] = msg.source;
				objs[7] = msg.target;
				currentDepth++;
