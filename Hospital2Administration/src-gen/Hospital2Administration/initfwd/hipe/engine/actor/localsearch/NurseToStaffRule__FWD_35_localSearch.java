...
public class NurseToStaffRule__FWD_35_localSearch extends GenericLocalSearchActor{
			...
			case "Department_object_SP0": 
				{
					...
					// d
					HMatch match_0 = new LocalSearchMatch("NurseToStaffRule__FWD_35_localSearch", 5);
			...
			case "Hospital_object_SP0": 
				{
					...
					// h
					HMatch match_1 = new LocalSearchMatch("NurseToStaffRule__FWD_35_localSearch", 5);
			...
			case "HospitalToAdministration_object": 
				{
					...
					// htov
					HMatch match_2 = new LocalSearchMatch("NurseToStaffRule__FWD_35_localSearch", 5);
			...
			case "Administration_object": 
				{
					...
					// v
					HMatch match_3 = new LocalSearchMatch("NurseToStaffRule__FWD_35_localSearch", 5);
			...
			case "Nurse_object": 
				{
					...
					// s1
					HMatch match_4 = new LocalSearchMatch("NurseToStaffRule__FWD_35_localSearch", 5);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "Staff_works_Department": 
			...
			{
				HMatch match = new LocalSearchMatch("NurseToStaffRule__FWD_35_localSearch", 5);
				Object[] objs = match.getNodes();
				objs[4] = msg.source;
				objs[0] = msg.target;
				currentDepth++;
