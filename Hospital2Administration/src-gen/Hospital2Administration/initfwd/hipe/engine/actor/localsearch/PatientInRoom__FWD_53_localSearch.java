...
public class PatientInRoom__FWD_53_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.multi_lookup = (o) -> ((HospitalExample.Hospital) o).getDepartment();
			...
			case "Department_object_SP1": 
				{
					...
					// d
					HMatch match_0 = new LocalSearchMatch("PatientInRoom__FWD_53_localSearch", 6);
			...
			case "Hospital_object_SP0": 
				{
					...
					// h
					HMatch match_1 = new LocalSearchMatch("PatientInRoom__FWD_53_localSearch", 6);
			...
			case "HospitalToAdministration_object": 
				{
					...
					// htov
					HMatch match_2 = new LocalSearchMatch("PatientInRoom__FWD_53_localSearch", 6);
			...
			case "Room_object_SP1": 
				{
					...
					// ro
					HMatch match_3 = new LocalSearchMatch("PatientInRoom__FWD_53_localSearch", 6);
			...
			case "Administration_object": 
				{
					...
					// v
					HMatch match_4 = new LocalSearchMatch("PatientInRoom__FWD_53_localSearch", 6);
			...
			case "Patient_object_SP0": 
				{
					...
					// p1
					HMatch match_5 = new LocalSearchMatch("PatientInRoom__FWD_53_localSearch", 6);
					match_5.getNodes()[5] = objs[0];
					start(edge_explorer_6_1_orchestration, match_5);
				}
				break;
			case "PatientInRoom_p1_waits_incoming_SRC__FILTER_NAC_SRC_50_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "PatientInRoom_p1_waits_incoming_SRC__FILTER_NAC_SRC_50_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("PatientInRoom__FWD_53_localSearch", 6);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "Department_rooms_Room": 
			{
				HMatch match = new LocalSearchMatch("PatientInRoom__FWD_53_localSearch", 6);
				Object[] objs = match.getNodes();
				objs[0] = msg.source;
				objs[3] = msg.target;
				currentDepth++;
