...
public class DepartmentRule__CC_1_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("DepartmentRule__CC_production"), this::returnTrue , 0  , false ));
	}
			...
			case "Hospital_object_SP0": 
				{
					...
					// h
					HMatch match_0 = new LocalSearchMatch("DepartmentRule__CC_1_localSearch", 2);
			...
			case "Department_object_SP0": 
				{
					...
					// d
					HMatch match_1 = new LocalSearchMatch("DepartmentRule__CC_1_localSearch", 2);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "Hospital_department_Department": 
			{
				HMatch match = new LocalSearchMatch("DepartmentRule__CC_1_localSearch", 2);
				Object[] objs = match.getNodes();
				objs[0] = msg.source;
				objs[1] = msg.target;
				currentDepth++;
