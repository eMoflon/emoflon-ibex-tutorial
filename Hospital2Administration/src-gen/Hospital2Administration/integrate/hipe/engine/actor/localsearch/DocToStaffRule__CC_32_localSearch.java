...
public class DocToStaffRule__CC_32_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.multi_lookup = (o) -> ((HospitalExample.Hospital) o).getStaff().stream().filter(obj -> obj instanceof HospitalExample.Doctor).collect(Collectors.toList());
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						...
						edge_explorer_4_methods.multi_opposite_lookup = (o) -> ((HospitalExample.Department) o).getStaff().stream().filter(obj -> obj instanceof HospitalExample.Doctor).collect(Collectors.toList());
			...
			case "Department_object_SP3": 
				{
					...
					// d
					HMatch match_0 = new LocalSearchMatch("DocToStaffRule__CC_32_localSearch", 8);
			...
			case "Hospital_object_SP3": 
				{
					...
					// h
					HMatch match_1 = new LocalSearchMatch("DocToStaffRule__CC_32_localSearch", 8);
			...
			case "HospitalToAdministration_object_SP2": 
				{
					...
					// htov
					HMatch match_2 = new LocalSearchMatch("DocToStaffRule__CC_32_localSearch", 8);
			...
			case "Administration_object_SP2": 
				{
					...
					// v
					HMatch match_3 = new LocalSearchMatch("DocToStaffRule__CC_32_localSearch", 8);
			...
			case "Doctor_object_SP0": 
				{
					...
					// s1
					HMatch match_4 = new LocalSearchMatch("DocToStaffRule__CC_32_localSearch", 8);
			...
			case "Staff_object_SP2": 
				{
					...
					// s2
					HMatch match_5 = new LocalSearchMatch("DocToStaffRule__CC_32_localSearch", 8);
			...
			case "Shift_object_SP2": 
				{
					...
					// sh
					HMatch match_6 = new LocalSearchMatch("DocToStaffRule__CC_32_localSearch", 8);
					match_6.getNodes()[6] = objs[0];
					start(edge_explorer_6_2_orchestration, match_6);
				}
				break;
			case "Shiftplan_object_SP0": 
				{
					...
					// sp
					HMatch match_7 = new LocalSearchMatch("DocToStaffRule__CC_32_localSearch", 8);
		...
		switch(match.creator) {
			...
			case "DocToStaffRule_s2_shiftPlan_outgoing_TRG__FILTER_NAC_TRG_10_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("DocToStaffRule__CC_32_localSearch", 8);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
			...
			case "DocToStaffRule_sp_shifts_outgoing_TRG__FILTER_NAC_TRG_14_localSearch": 
				if(nac_checker_0.deregister(match)) {
					HMatch acMatch_1 = new LocalSearchMatch("DocToStaffRule__CC_32_localSearch", 8);
					Object[] acMatch_nodes_1 = acMatch_1.getNodes();
		...
		case "HospitalToAdministration_target_Administration": 
			{
				...
				HMatch match = new LocalSearchMatch("DocToStaffRule__CC_32_localSearch", 8);
				Object[] objs = match.getNodes();
				objs[2] = msg.source;
				objs[3] = msg.target;
				currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_doctorsalary csp_11 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_doctorsalary();
	...
	public boolean constraint_checker_1_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_incrementingStaffID csp_13 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_incrementingStaffID();
		csp_13.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, s1.getStaffID(), "int"));
		csp_13.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, s2.getStaffID(), "int"));
		csp_13.solve();
	...
	public boolean constraint_checker_2_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_nametoname csp_14 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_nametoname();
		csp_14.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, " ", "java.lang.String"));
		csp_14.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, s2.getFirstName(), "java.lang.String"));
		csp_14.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, s2.getLastName(), "java.lang.String"));
		csp_14.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, s1.getName(), "java.lang.String"));
		csp_14.solve();
