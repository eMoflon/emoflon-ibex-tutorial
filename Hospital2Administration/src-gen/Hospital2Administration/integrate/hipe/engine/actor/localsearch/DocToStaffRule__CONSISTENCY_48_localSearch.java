...
public class DocToStaffRule__CONSISTENCY_48_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> ((Hospital2Administration.DocToStaffRule__Marker) o).getCREATE__CORR__stot();
						edge_explorer = new CachedEdgeExplorer(this, 9, 8, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> ((Hospital2Administration.DocToStaffRule__Marker) o).getCONTEXT__SRC__d();
						edge_explorer_3 = new CachedEdgeExplorer(this, 9, 0, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> ((Hospital2Administration.DocToStaffRule__Marker) o).getCREATE__TRG__sh();
						edge_explorer_4 = new CachedEdgeExplorer(this, 9, 4, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> ((Hospital2Administration.DocToStaffRule__Marker) o).getCREATE__SRC__s1();
						edge_explorer_5 = new CachedEdgeExplorer(this, 9, 2, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.StaffToStaff) o).getSource(); return (result instanceof HospitalExample.Doctor ? result : null);};
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> ((Hospital2Administration.DocToStaffRule__Marker) o).getCONTEXT__TRG__v();
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> ((Hospital2Administration.StaffToStaff) o).getTarget();
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> ((Hospital2Administration.DocToStaffRule__Marker) o).getCREATE__TRG__s2();
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> ((Hospital2Administration.DocToStaffRule__Marker) o).getCREATE__TRG__sp();
			...
			case "StaffToStaff_object_SP0": 
				{
					...
					// stot
					HMatch match_8 = new LocalSearchMatch("DocToStaffRule__CONSISTENCY_48_localSearch", 10);
			...
			case "DocToStaffRule__Marker_object": 
				{
					...
					HMatch match_9 = new LocalSearchMatch("DocToStaffRule__CONSISTENCY_48_localSearch", 10);
					match_9.getNodes()[9] = objs[0];
					start(edge_explorer_1_orchestration, match_9);
				}
				break;
			case "DocToStaffRule__FWD_45_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("DocToStaffRule__CONSISTENCY_48_localSearch", 10);
				...
				break;
			case "DocToStaffRule__BWD_23_junction": 
				{
					if(pac_explorer_0.register(match)) {
						HMatch acMatch_1 = new LocalSearchMatch("DocToStaffRule__CONSISTENCY_48_localSearch", 10);
		...
		case "DocToStaffRule__Marker_CREATE__CORR__stot_StaffToStaff": 
			{
				...
				HMatch match = new LocalSearchMatch("DocToStaffRule__CONSISTENCY_48_localSearch", 10);
				Object[] objs = match.getNodes();
				objs[9] = msg.source;
				objs[8] = msg.target;
				currentDepth++;
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister DocToStaffRule__FWD
		OverlapMatch oMatch_0 = new OverlapMatch(5);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[0];
		oMatch_Nodes_0[1] = objs[1];
		...
		// deregister DocToStaffRule__BWD
		OverlapMatch oMatch_1 = new OverlapMatch(7);
		Object[] oMatch_Nodes_1 = oMatch_1.getNodes();
		oMatch_Nodes_1[0] = objs[0];
		oMatch_Nodes_1[1] = objs[1];
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof HospitalExample.Doctor) {
			HMatch match_2 = new LocalSearchMatch("DocToStaffRule__CONSISTENCY_48_localSearch", 10);
		...
		if(obj instanceof AdministrationExample.Staff) {
			HMatch match_3 = new LocalSearchMatch("DocToStaffRule__CONSISTENCY_48_localSearch", 10);
		...
		if(obj instanceof HospitalExample.Department) {
			HMatch match_0 = new LocalSearchMatch("DocToStaffRule__CONSISTENCY_48_localSearch", 10);
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_doctorsalary csp_15 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_doctorsalary();
		csp_15.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, s2.getSalary(), "double"));
		csp_15.solve();
	...
	public boolean constraint_checker_0_method(HMatch match) {
		...
		csp_16.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, d.getDID(), "int"));
		csp_16.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, s2.getDInt(), "int"));
		csp_16.solve();
	...
	public boolean constraint_checker_1_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_incrementingStaffID csp_17 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_incrementingStaffID();
		csp_17.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, s1.getStaffID(), "int"));
		csp_17.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, s2.getStaffID(), "int"));
		csp_17.solve();
	...
	public boolean constraint_checker_2_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_nametoname csp_18 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_nametoname();
		...
		csp_18.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, s2.getFirstName(), "java.lang.String"));
		csp_18.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, s2.getLastName(), "java.lang.String"));
		csp_18.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, s1.getName(), "java.lang.String"));
		csp_18.solve();
