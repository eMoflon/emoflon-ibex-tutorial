...
public class DocToStaffRule__FWD_45_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		pac_explorer = new PACExplorer(this, Arrays.asList(new Integer[] {0,1,4}), node.getAllOverlaps().get(0));
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("DocToStaffRule__CONSISTENCY_48_localSearch"), this::returnTrue  , false ));
		ports.add(new PortJunction(node.getPorts().getPort().get(1), getSelf(), name2actor.get("DocToStaffRule__FWD_production"), this::returnTrue  , false ));
	}
			...
			case "HospitalToAdministration_object_SP3": 
				{
					...
					// htov
					HMatch match_2 = new LocalSearchMatch("DocToStaffRule__FWD_45_localSearch", 5);
			...
			case "Administration_object_SP3": 
				{
					...
					// v
					HMatch match_3 = new LocalSearchMatch("DocToStaffRule__FWD_45_localSearch", 5);
					match_3.getNodes()[3] = objs[0];
					start(edge_explorer_2_orchestration, match_3);
				}
				break;
			case "DocToStaffRule__SRC_41_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("DocToStaffRule__FWD_45_localSearch", 5);
		...
		case "HospitalToAdministration_target_Administration": 
			{
				...
				HMatch match = new LocalSearchMatch("DocToStaffRule__FWD_45_localSearch", 5);
				Object[] objs = match.getNodes();
				objs[2] = msg.source;
				objs[3] = msg.target;
				currentDepth++;
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister DocToStaffRule__SRC
		OverlapMatch oMatch_0 = new OverlapMatch(3);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[0];
		oMatch_Nodes_0[1] = objs[1];
