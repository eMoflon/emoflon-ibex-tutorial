...
public class DocToStaffRule_sp_shifts_outgoing_TRG__FILTER_NAC_TRG_14_localSearch extends GenericLocalSearchActor{
			...
			case "Shiftplan_object_SP2": 
				{
					...
					// sp
					HMatch match_0 = new LocalSearchMatch("DocToStaffRule_sp_shifts_outgoing_TRG__FILTER_NAC_TRG_14_localSearch", 3);
			...
			case "Shift_object_SP1": 
				{
					...
					// sh
					HMatch match_1 = new LocalSearchMatch("DocToStaffRule_sp_shifts_outgoing_TRG__FILTER_NAC_TRG_14_localSearch", 3);
					match_1.getNodes()[1] = objs[0];
					start(edge_explorer_3_1_orchestration, match_1);
					
					// FILTER_NAC_NODE
					HMatch match_2 = new LocalSearchMatch("DocToStaffRule_sp_shifts_outgoing_TRG__FILTER_NAC_TRG_14_localSearch", 3);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "Shiftplan_shifts_Shift": 
			{
				HMatch match = new LocalSearchMatch("DocToStaffRule_sp_shifts_outgoing_TRG__FILTER_NAC_TRG_14_localSearch", 3);
				Object[] objs = match.getNodes();
				objs[0] = msg.source;
				objs[2] = msg.target;
				currentDepth++;
