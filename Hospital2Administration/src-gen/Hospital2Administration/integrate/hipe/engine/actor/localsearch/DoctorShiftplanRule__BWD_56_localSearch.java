...
public class DoctorShiftplanRule__BWD_56_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(1), getSelf(), name2actor.get("DoctorShiftplanRule__CONSISTENCY_70_localSearch"), this::returnTrue  , false ));
	}
			...
			case "Patient_object_SP0": 
				{
					...
					// p1
					HMatch match_0 = new LocalSearchMatch("DoctorShiftplanRule__BWD_56_localSearch", 8);
			...
			case "PatientToPatient_object_SP0": 
				{
					...
					// pToP
					HMatch match_2 = new LocalSearchMatch("DoctorShiftplanRule__BWD_56_localSearch", 8);
			...
			case "Doctor_object_SP0": 
				{
					...
					// s1
					HMatch match_3 = new LocalSearchMatch("DoctorShiftplanRule__BWD_56_localSearch", 8);
			...
			case "StaffToStaff_object_SP1": 
				{
					...
					// sToS
					HMatch match_5 = new LocalSearchMatch("DoctorShiftplanRule__BWD_56_localSearch", 8);
					match_5.getNodes()[5] = objs[0];
					start(edge_explorer_3_1_orchestration, match_5);
				}
				break;
			case "DoctorShiftplanRule__TRG_51_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("DoctorShiftplanRule__BWD_56_localSearch", 8);
		...
		case "PatientToPatient_target_Patient": 
			{
				...
				HMatch match = new LocalSearchMatch("DoctorShiftplanRule__BWD_56_localSearch", 8);
				Object[] objs = match.getNodes();
				objs[2] = msg.source;
				objs[1] = msg.target;
				currentDepth++;
