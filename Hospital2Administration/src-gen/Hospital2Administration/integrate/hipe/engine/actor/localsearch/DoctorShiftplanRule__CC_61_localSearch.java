...
public class DoctorShiftplanRule__CC_61_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						...
						edge_explorer_5 = new EdgeExplorer(this, 7, 1, edge_explorer_5_methods);
			...
			case "Patient_object_SP1": 
				{
					...
					// p1
					HMatch match_0 = new LocalSearchMatch("DoctorShiftplanRule__CC_61_localSearch", 8);
			...
			case "Patient_1_object_SP1": 
				{
					...
					// p2
					HMatch match_1 = new LocalSearchMatch("DoctorShiftplanRule__CC_61_localSearch", 8);
			...
			case "PatientToPatient_object_SP1": 
				{
					...
					// pToP
					HMatch match_2 = new LocalSearchMatch("DoctorShiftplanRule__CC_61_localSearch", 8);
			...
			case "Doctor_object_SP1": 
				{
					...
					// s1
					HMatch match_3 = new LocalSearchMatch("DoctorShiftplanRule__CC_61_localSearch", 8);
			...
			case "Staff_object_SP0": 
				{
					...
					// s2
					HMatch match_4 = new LocalSearchMatch("DoctorShiftplanRule__CC_61_localSearch", 8);
			...
			case "StaffToStaff_object_SP2": 
				{
					...
					// sToS
					HMatch match_5 = new LocalSearchMatch("DoctorShiftplanRule__CC_61_localSearch", 8);
			...
			case "Shift_object_SP1": 
				{
					...
					// sh
					HMatch match_6 = new LocalSearchMatch("DoctorShiftplanRule__CC_61_localSearch", 8);
			...
			case "Shiftplan_object_SP2": 
				{
					...
					// sp
					HMatch match_7 = new LocalSearchMatch("DoctorShiftplanRule__CC_61_localSearch", 8);
		...
		case "PatientToPatient_target_Patient": 
			{
				...
				HMatch match = new LocalSearchMatch("DoctorShiftplanRule__CC_61_localSearch", 8);
				Object[] objs = match.getNodes();
				objs[2] = msg.source;
				objs[1] = msg.target;
				currentDepth++;
