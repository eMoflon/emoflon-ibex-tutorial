...
public class DoctorShiftplanRule__CONSISTENCY_70_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> ((Hospital2Administration.DoctorShiftplanRule__Marker) o).getCONTEXT__TRG__sp();
						edge_explorer_4 = new CachedEdgeExplorer(this, 8, 5, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> ((Hospital2Administration.DoctorShiftplanRule__Marker) o).getCONTEXT__TRG__sh();
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> ((Hospital2Administration.DoctorShiftplanRule__Marker) o).getCONTEXT__TRG__p2();
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> ((Hospital2Administration.DoctorShiftplanRule__Marker) o).getCONTEXT__SRC__s1();
						edge_explorer_9 = new CachedEdgeExplorer(this, 8, 1, edge_explorer_9_methods);
		name2explorer.put("edge_explorer_9", edge_explorer_9);
		pac_explorer = new PACExplorer(this, Arrays.asList(new Integer[] {0,1,2,3,4,5,6,7}), node.getAllOverlaps().get(0));
			...
			case "DoctorShiftplanRule__Marker_object": 
				{
					...
					HMatch match_8 = new LocalSearchMatch("DoctorShiftplanRule__CONSISTENCY_70_localSearch", 9);
					match_8.getNodes()[8] = objs[0];
					start(edge_explorer_1_orchestration, match_8);
				}
				break;
			case "DoctorShiftplanRule__BWD_56_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("DoctorShiftplanRule__CONSISTENCY_70_localSearch", 9);
		...
		case "DoctorShiftplanRule__Marker_CONTEXT__CORR__pToP_PatientToPatient": 
			{
				...
				HMatch match = new LocalSearchMatch("DoctorShiftplanRule__CONSISTENCY_70_localSearch", 9);
				Object[] objs = match.getNodes();
				objs[8] = msg.source;
				objs[6] = msg.target;
				currentDepth++;
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register DoctorShiftplanRule__BWD
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister DoctorShiftplanRule__BWD
		OverlapMatch oMatch_0 = new OverlapMatch(8);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[0];
		oMatch_Nodes_0[1] = objs[1];
