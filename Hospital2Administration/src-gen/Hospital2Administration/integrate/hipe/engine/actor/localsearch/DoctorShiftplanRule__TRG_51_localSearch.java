...
public class DoctorShiftplanRule__TRG_51_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("DoctorShiftplanRule__BWD_56_localSearch"), this::returnTrue  , false ));
		ports.add(new PortJunction(node.getPorts().getPort().get(1), getSelf(), name2actor.get("DoctorShiftplanRule__TRG_production"), this::returnTrue  , false ));
	}
			...
			case "Patient_1_object_SP0": 
				{
					...
					// p2
					HMatch match_0 = new LocalSearchMatch("DoctorShiftplanRule__TRG_51_localSearch", 4);
			...
			case "Staff_object_SP3": 
				{
					...
					// s2
					HMatch match_1 = new LocalSearchMatch("DoctorShiftplanRule__TRG_51_localSearch", 4);
			...
			case "Shift_object_SP0": 
				{
					...
					// sh
					HMatch match_2 = new LocalSearchMatch("DoctorShiftplanRule__TRG_51_localSearch", 4);
			...
			case "Shiftplan_object_SP1": 
				{
					...
					// sp
					HMatch match_3 = new LocalSearchMatch("DoctorShiftplanRule__TRG_51_localSearch", 4);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "Shiftplan_covers_Patient": 
			{
				HMatch match = new LocalSearchMatch("DoctorShiftplanRule__TRG_51_localSearch", 4);
				Object[] objs = match.getNodes();
				objs[3] = msg.source;
				objs[0] = msg.target;
				currentDepth++;
