...
public class DoctorToPatient__BWD_80_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		pac_explorer = new PACExplorer(this, Arrays.asList(new Integer[] {4,7,8}), node.getAllOverlaps().get(0));
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(1), getSelf(), name2actor.get("DoctorToPatient__CONSISTENCY_107_localSearch"), this::returnTrue  , false ));
	}
			...
			case "Doctor_object_SP0": 
				{
					...
					// d
					HMatch match_0 = new LocalSearchMatch("DoctorToPatient__BWD_80_localSearch", 9);
			...
			case "StaffToStaff_object_SP0": 
				{
					...
					// dToS
					HMatch match_1 = new LocalSearchMatch("DoctorToPatient__BWD_80_localSearch", 9);
			...
			case "Department_object_SP0": 
				{
					...
					// dep
					HMatch match_2 = new LocalSearchMatch("DoctorToPatient__BWD_80_localSearch", 9);
			...
			case "Patient_object_SP2": 
				{
					...
					// p1
					HMatch match_3 = new LocalSearchMatch("DoctorToPatient__BWD_80_localSearch", 9);
			...
			case "PatientToPatient_object_SP2": 
				{
					...
					// pToP
					HMatch match_5 = new LocalSearchMatch("DoctorToPatient__BWD_80_localSearch", 9);
			...
			case "Room_object_SP0": 
				{
					...
					// ro
					HMatch match_6 = new LocalSearchMatch("DoctorToPatient__BWD_80_localSearch", 9);
					match_6.getNodes()[6] = objs[0];
					start(edge_explorer_3_1_orchestration, match_6);
				}
				break;
			case "DoctorToPatient__TRG_76_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("DoctorToPatient__BWD_80_localSearch", 9);
		...
		case "StaffToStaff_target_Staff": 
			{
				...
				HMatch match = new LocalSearchMatch("DoctorToPatient__BWD_80_localSearch", 9);
				Object[] objs = match.getNodes();
				objs[1] = msg.source;
				objs[7] = msg.target;
				currentDepth++;
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister DoctorToPatient__TRG
		OverlapMatch oMatch_0 = new OverlapMatch(3);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[4];
		oMatch_Nodes_0[1] = objs[7];
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof AdministrationExample.Treatment) {
			HMatch match_8 = new LocalSearchMatch("DoctorToPatient__BWD_80_localSearch", 9);
			...
			start(pac_explorer_orchestration, match_8);
		}
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_carelevelToMedication csp_19 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_carelevelToMedication();
		csp_19.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, p1.getLevel(), "Enum::Carelevel"));
		csp_19.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, t.getMedication(), "Enum::Medication"));
		csp_19.solve();
