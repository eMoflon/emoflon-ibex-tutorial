...
public class DoctorToPatient__CC_87_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.multi_lookup = (o) -> ((AdministrationExample.Staff) o).getTreatment();
						edge_explorer_5 = new CachedEdgeExplorer(this, 7, 8, edge_explorer_5_methods);
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						...
						edge_explorer_6 = new EdgeExplorer(this, 2, 6, edge_explorer_6_methods);
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						...
						edge_explorer_11 = new CachedEdgeExplorer(this, 1, 7, edge_explorer_11_methods);
	...
	protected void initializeOrchestration() {
		...
		edge_explorer_5_2_orchestration = initializeOrchestration(node.getOrchestrations().get(11).getPlan());
		edge_explorer_6_0_orchestration = initializeOrchestration(node.getOrchestrations().get(12).getPlan());
			...
			case "Doctor_object_SP1": 
				{
					...
					// d
					HMatch match_0 = new LocalSearchMatch("DoctorToPatient__CC_87_localSearch", 9);
			...
			case "StaffToStaff_object_SP1": 
				{
					...
					// dToS
					HMatch match_1 = new LocalSearchMatch("DoctorToPatient__CC_87_localSearch", 9);
			...
			case "Department_object_SP1": 
				{
					...
					// dep
					HMatch match_2 = new LocalSearchMatch("DoctorToPatient__CC_87_localSearch", 9);
			...
			case "Patient_object_SP3": 
				{
					...
					// p1
					HMatch match_3 = new LocalSearchMatch("DoctorToPatient__CC_87_localSearch", 9);
			...
			case "Patient_1_object_SP3": 
				{
					...
					// p2
					HMatch match_4 = new LocalSearchMatch("DoctorToPatient__CC_87_localSearch", 9);
			...
			case "PatientToPatient_object_SP0": 
				{
					...
					// pToP
					HMatch match_5 = new LocalSearchMatch("DoctorToPatient__CC_87_localSearch", 9);
			...
			case "Room_object_SP1": 
				{
					...
					// ro
					HMatch match_6 = new LocalSearchMatch("DoctorToPatient__CC_87_localSearch", 9);
			...
			case "Staff_object_SP3": 
				{
					...
					// s
					HMatch match_7 = new LocalSearchMatch("DoctorToPatient__CC_87_localSearch", 9);
			...
			case "Treatment_object": 
				{
					...
					// t
					HMatch match_8 = new LocalSearchMatch("DoctorToPatient__CC_87_localSearch", 9);
					match_8.getNodes()[8] = objs[0];
					start(edge_explorer_5_2_orchestration, match_8);
				}
				break;
		...
		switch(match.creator) {
			...
			case "DoctorToPatient_t_treatment_incoming_TRG__FILTER_NAC_TRG_72_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("DoctorToPatient__CC_87_localSearch", 9);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "Staff_works_Department": 
			...
			{
				HMatch match = new LocalSearchMatch("DoctorToPatient__CC_87_localSearch", 9);
				Object[] objs = match.getNodes();
				objs[0] = msg.source;
				objs[2] = msg.target;
				currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_carelevelToMedication csp_20 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_carelevelToMedication();
		csp_20.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, p1.getLevel(), "Enum::Carelevel"));
		csp_20.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, t.getMedication(), "Enum::Medication"));
		csp_20.solve();
