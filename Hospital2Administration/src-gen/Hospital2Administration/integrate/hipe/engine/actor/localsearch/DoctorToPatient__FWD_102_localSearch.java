...
public class DoctorToPatient__FWD_102_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		pac_explorer = new PACExplorer(this, Arrays.asList(new Integer[] {0,2,3,6}), node.getAllOverlaps().get(0));
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("DoctorToPatient__CONSISTENCY_107_localSearch"), this::returnTrue  , false ));
		ports.add(new PortJunction(node.getPorts().getPort().get(1), getSelf(), name2actor.get("DoctorToPatient__FWD_production"), this::returnTrue  , false ));
	}
			...
			case "StaffToStaff_object_SP2": 
				{
					...
					// dToS
					HMatch match_1 = new LocalSearchMatch("DoctorToPatient__FWD_102_localSearch", 8);
			...
			case "Patient_1_object_SP0": 
				{
					...
					// p2
					HMatch match_4 = new LocalSearchMatch("DoctorToPatient__FWD_102_localSearch", 8);
			...
			case "PatientToPatient_object_SP1": 
				{
					...
					// pToP
					HMatch match_5 = new LocalSearchMatch("DoctorToPatient__FWD_102_localSearch", 8);
			...
			case "Staff_object_SP0": 
				{
					...
					// s
					HMatch match_7 = new LocalSearchMatch("DoctorToPatient__FWD_102_localSearch", 8);
					match_7.getNodes()[7] = objs[0];
					start(edge_explorer_5_1_orchestration, match_7);
				}
				break;
			case "DoctorToPatient__SRC_97_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("DoctorToPatient__FWD_102_localSearch", 8);
		...
		case "PatientToPatient_target_Patient": 
			{
				...
				HMatch match = new LocalSearchMatch("DoctorToPatient__FWD_102_localSearch", 8);
				Object[] objs = match.getNodes();
				objs[5] = msg.source;
				objs[4] = msg.target;
				currentDepth++;
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister DoctorToPatient__SRC
		OverlapMatch oMatch_0 = new OverlapMatch(4);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[0];
		oMatch_Nodes_0[1] = objs[2];
