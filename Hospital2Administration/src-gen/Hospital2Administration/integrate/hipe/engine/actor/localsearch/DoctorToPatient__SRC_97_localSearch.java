...
public class DoctorToPatient__SRC_97_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						...
						edge_explorer_3 = new EdgeExplorer(this, 2, 0, edge_explorer_3_methods);
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("DoctorToPatient__FWD_102_localSearch"), this::returnTrue  , false ));
		ports.add(new PortJunction(node.getPorts().getPort().get(1), getSelf(), name2actor.get("DoctorToPatient__SRC_production"), this::returnTrue  , false ));
	}
			...
			case "Doctor_object_SP0": 
				{
					...
					// d
					HMatch match_0 = new LocalSearchMatch("DoctorToPatient__SRC_97_localSearch", 4);
			...
			case "Department_object_SP2": 
				{
					...
					// dep
					HMatch match_1 = new LocalSearchMatch("DoctorToPatient__SRC_97_localSearch", 4);
			...
			case "Patient_object_SP0": 
				{
					...
					// p1
					HMatch match_2 = new LocalSearchMatch("DoctorToPatient__SRC_97_localSearch", 4);
			...
			case "Room_object_SP2": 
				{
					...
					// ro
					HMatch match_3 = new LocalSearchMatch("DoctorToPatient__SRC_97_localSearch", 4);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "Department_rooms_Room": 
			{
				HMatch match = new LocalSearchMatch("DoctorToPatient__SRC_97_localSearch", 4);
				Object[] objs = match.getNodes();
				objs[1] = msg.source;
				objs[3] = msg.target;
				currentDepth++;
