...
public class HospitaltoAdministrationRule__SRC_120_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("HospitaltoAdministrationRule__FWD_123_localSearch"), this::returnTrue  , false ));
		ports.add(new PortJunction(node.getPorts().getPort().get(1), getSelf(), name2actor.get("HospitaltoAdministrationRule__SRC_production"), this::returnTrue  , false ));
	}
			...
			case "Hospital_object_SP3": 
				{
					...
					// h
					HMatch match_0 = new LocalSearchMatch("HospitaltoAdministrationRule__SRC_120_localSearch", 2);
			...
			case "Reception_object_SP0": 
				{
					...
					// r
					HMatch match_1 = new LocalSearchMatch("HospitaltoAdministrationRule__SRC_120_localSearch", 2);
					match_1.getNodes()[1] = objs[0];
					start(edge_explorer_2_orchestration, match_1);
				}
				break;
			case "HospitaltoAdministrationRule_h_reception_outgoing_SRC__FILTER_NAC_SRC_110_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "HospitaltoAdministrationRule_h_reception_outgoing_SRC__FILTER_NAC_SRC_110_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("HospitaltoAdministrationRule__SRC_120_localSearch", 2);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "Hospital_reception_Reception": 
			{
				HMatch match = new LocalSearchMatch("HospitaltoAdministrationRule__SRC_120_localSearch", 2);
				Object[] objs = match.getNodes();
				objs[0] = msg.source;
				objs[1] = msg.target;
				currentDepth++;
