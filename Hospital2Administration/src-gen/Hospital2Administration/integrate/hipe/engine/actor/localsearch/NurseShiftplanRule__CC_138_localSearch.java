...
public class NurseShiftplanRule__CC_138_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						...
						edge_explorer = new CachedEdgeExplorer(this, 6, 4, edge_explorer_methods);
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						...
						edge_explorer_3 = new EdgeExplorer(this, 5, 8, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> ((Hospital2Administration.StaffToStaff) o).getTarget();
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						...
						edge_explorer_5 = new EdgeExplorer(this, 8, 7, edge_explorer_5_methods);
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						...
						edge_explorer_6 = new EdgeExplorer(this, 8, 1, edge_explorer_6_methods);
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						...
						edge_explorer_8 = new CachedEdgeExplorer(this, 2, 0, edge_explorer_8_methods);
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("NurseShiftplanRule__CC_production"), this::returnTrue  , false ));
	}
			...
			case "Patient_object_SP2": 
				{
					...
					// p1
					HMatch match_0 = new LocalSearchMatch("NurseShiftplanRule__CC_138_localSearch", 9);
			...
			case "Patient_1_object_SP2": 
				{
					...
					// p2
					HMatch match_1 = new LocalSearchMatch("NurseShiftplanRule__CC_138_localSearch", 9);
			...
			case "PatientToPatient_object_SP0": 
				{
					...
					// pToP
					HMatch match_2 = new LocalSearchMatch("NurseShiftplanRule__CC_138_localSearch", 9);
			...
			case "Room_object_SP0": 
				{
					...
					// ro
					HMatch match_3 = new LocalSearchMatch("NurseShiftplanRule__CC_138_localSearch", 9);
			...
			case "Nurse_object_SP1": 
				{
					...
					// s1
					HMatch match_4 = new LocalSearchMatch("NurseShiftplanRule__CC_138_localSearch", 9);
			...
			case "Staff_object_SP2": 
				{
					...
					// s2
					HMatch match_5 = new LocalSearchMatch("NurseShiftplanRule__CC_138_localSearch", 9);
			...
			case "StaffToStaff_object_SP1": 
				{
					...
					// sToS
					HMatch match_6 = new LocalSearchMatch("NurseShiftplanRule__CC_138_localSearch", 9);
			...
			case "Shift_object_SP0": 
				{
					...
					// sh
					HMatch match_7 = new LocalSearchMatch("NurseShiftplanRule__CC_138_localSearch", 9);
			...
			case "Shiftplan_object_SP1": 
				{
					...
					// sp
					HMatch match_8 = new LocalSearchMatch("NurseShiftplanRule__CC_138_localSearch", 9);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "StaffToStaff_source_Staff": 
			if(msg.target instanceof HospitalExample.Nurse) {
			{
				...
				HMatch match = new LocalSearchMatch("NurseShiftplanRule__CC_138_localSearch", 9);
				Object[] objs = match.getNodes();
				objs[6] = msg.source;
				objs[4] = msg.target;
				currentDepth++;
