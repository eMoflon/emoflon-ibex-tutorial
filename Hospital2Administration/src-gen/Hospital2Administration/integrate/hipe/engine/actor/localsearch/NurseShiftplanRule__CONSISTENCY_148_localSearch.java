...
public class NurseShiftplanRule__CONSISTENCY_148_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> ((Hospital2Administration.NurseShiftplanRule__Marker) o).getCONTEXT__CORR__sToS();
						edge_explorer = new CachedEdgeExplorer(this, 9, 8, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> ((Hospital2Administration.NurseShiftplanRule__Marker) o).getCONTEXT__TRG__sh();
						edge_explorer_3 = new CachedEdgeExplorer(this, 9, 5, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> ((Hospital2Administration.NurseShiftplanRule__Marker) o).getCONTEXT__TRG__sp();
						edge_explorer_4 = new CachedEdgeExplorer(this, 9, 6, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> ((Hospital2Administration.NurseShiftplanRule__Marker) o).getCONTEXT__SRC__ro();
						edge_explorer_5 = new CachedEdgeExplorer(this, 9, 1, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> ((Hospital2Administration.NurseShiftplanRule__Marker) o).getCONTEXT__SRC__p1();
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> ((Hospital2Administration.NurseShiftplanRule__Marker) o).getCONTEXT__SRC__s1();
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> ((Hospital2Administration.NurseShiftplanRule__Marker) o).getCONTEXT__TRG__p2();
						edge_explorer_8 = new CachedEdgeExplorer(this, 9, 3, edge_explorer_8_methods);
		name2explorer.put("edge_explorer_8", edge_explorer_8);
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> ((Hospital2Administration.NurseShiftplanRule__Marker) o).getCONTEXT__TRG__s2();
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> ((Hospital2Administration.NurseShiftplanRule__Marker) o).getCONTEXT__CORR__pToP();
