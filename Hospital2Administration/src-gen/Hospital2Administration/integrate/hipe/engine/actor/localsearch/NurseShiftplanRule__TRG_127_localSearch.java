...
public class NurseShiftplanRule__TRG_127_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("NurseShiftplanRule__BWD_132_localSearch"), this::returnTrue  , false ));
			...
			case "Patient_1_object_SP1": 
				{
					...
					// p2
					HMatch match_0 = new LocalSearchMatch("NurseShiftplanRule__TRG_127_localSearch", 4);
			...
			case "Staff_object_SP1": 
				{
					...
					// s2
					HMatch match_1 = new LocalSearchMatch("NurseShiftplanRule__TRG_127_localSearch", 4);
			...
			case "Shift_object_SP2": 
				{
					...
					// sh
					HMatch match_2 = new LocalSearchMatch("NurseShiftplanRule__TRG_127_localSearch", 4);
			...
			case "Shiftplan_object_SP0": 
				{
					...
					// sp
					HMatch match_3 = new LocalSearchMatch("NurseShiftplanRule__TRG_127_localSearch", 4);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "Staff_shiftPlan_Shiftplan": 
			{
				HMatch match = new LocalSearchMatch("NurseShiftplanRule__TRG_127_localSearch", 4);
				Object[] objs = match.getNodes();
				objs[1] = msg.source;
				objs[3] = msg.target;
				currentDepth++;
