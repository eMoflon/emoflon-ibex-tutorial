...
public class NurseToRoomRule__CC_150_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						...
						edge_explorer_5 = new EdgeExplorer(this, 0, 6, edge_explorer_5_methods);
			...
			case "Department_object_SP3": 
				{
					...
					// dep
					HMatch match_0 = new LocalSearchMatch("NurseToRoomRule__CC_150_localSearch", 8);
			...
			case "Nurse_object_SP0": 
				{
					...
					// n
					HMatch match_1 = new LocalSearchMatch("NurseToRoomRule__CC_150_localSearch", 8);
			...
			case "StaffToStaff_object_SP2": 
				{
					...
					// nToS
					HMatch match_2 = new LocalSearchMatch("NurseToRoomRule__CC_150_localSearch", 8);
			...
			case "Patient_object_SP3": 
				{
					...
					// p1
					HMatch match_3 = new LocalSearchMatch("NurseToRoomRule__CC_150_localSearch", 8);
			...
			case "Patient_1_object_SP3": 
				{
					...
					// p2
					HMatch match_4 = new LocalSearchMatch("NurseToRoomRule__CC_150_localSearch", 8);
			...
			case "PatientToPatient_object_SP1": 
				{
					...
					// pTop
					HMatch match_5 = new LocalSearchMatch("NurseToRoomRule__CC_150_localSearch", 8);
			...
			case "Room_object_SP1": 
				{
					...
					// r
					HMatch match_6 = new LocalSearchMatch("NurseToRoomRule__CC_150_localSearch", 8);
			...
			case "Staff_object_SP3": 
				{
					...
					// s
					HMatch match_7 = new LocalSearchMatch("NurseToRoomRule__CC_150_localSearch", 8);
		...
		case "PatientToPatient_target_Patient": 
			{
				...
				HMatch match = new LocalSearchMatch("NurseToRoomRule__CC_150_localSearch", 8);
				Object[] objs = match.getNodes();
				objs[5] = msg.source;
				objs[4] = msg.target;
				currentDepth++;
