...
public class NurseToRoomRule__CONSISTENCY_169_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> ((Hospital2Administration.NurseToRoomRule__Marker) o).getCONTEXT__TRG__s();
						edge_explorer_4 = new CachedEdgeExplorer(this, 8, 5, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> ((Hospital2Administration.NurseToRoomRule__Marker) o).getCONTEXT__SRC__dep();
						edge_explorer_5 = new CachedEdgeExplorer(this, 8, 0, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> ((Hospital2Administration.NurseToRoomRule__Marker) o).getCONTEXT__CORR__pTop();
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> ((Hospital2Administration.NurseToRoomRule__Marker) o).getCONTEXT__SRC__r();
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> ((Hospital2Administration.NurseToRoomRule__Marker) o).getCONTEXT__CORR__nToS();
						edge_explorer_9 = new CachedEdgeExplorer(this, 8, 6, edge_explorer_9_methods);
			...
			case "NurseToRoomRule__Marker_object": 
				{
					...
					HMatch match_8 = new LocalSearchMatch("NurseToRoomRule__CONSISTENCY_169_localSearch", 9);
					match_8.getNodes()[8] = objs[0];
					start(edge_explorer_1_orchestration, match_8);
				}
				break;
			case "NurseToRoomRule__FWD_164_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("NurseToRoomRule__CONSISTENCY_169_localSearch", 9);
		...
		case "NurseToRoomRule__Marker_CONTEXT__SRC__p1_Patient": 
			{
				...
				HMatch match = new LocalSearchMatch("NurseToRoomRule__CONSISTENCY_169_localSearch", 9);
				Object[] objs = match.getNodes();
				objs[8] = msg.source;
				objs[2] = msg.target;
				currentDepth++;
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister NurseToRoomRule__FWD
		OverlapMatch oMatch_0 = new OverlapMatch(8);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[0];
		oMatch_Nodes_0[1] = objs[1];
