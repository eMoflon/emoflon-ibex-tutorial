...
public class NurseToRoomRule__SRC_159_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("NurseToRoomRule__FWD_164_localSearch"), this::returnTrue  , false ));
		ports.add(new PortJunction(node.getPorts().getPort().get(1), getSelf(), name2actor.get("NurseToRoomRule__SRC_production"), this::returnTrue  , false ));
	}
			...
			case "Department_object_SP4": 
				{
					...
					// dep
					HMatch match_0 = new LocalSearchMatch("NurseToRoomRule__SRC_159_localSearch", 4);
			...
			case "Nurse_object_SP1": 
				{
					...
					// n
					HMatch match_1 = new LocalSearchMatch("NurseToRoomRule__SRC_159_localSearch", 4);
			...
			case "Patient_object_SP0": 
				{
					...
					// p1
					HMatch match_2 = new LocalSearchMatch("NurseToRoomRule__SRC_159_localSearch", 4);
			...
			case "Room_object_SP2": 
				{
					...
					// r
					HMatch match_3 = new LocalSearchMatch("NurseToRoomRule__SRC_159_localSearch", 4);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "Department_rooms_Room": 
			{
				HMatch match = new LocalSearchMatch("NurseToRoomRule__SRC_159_localSearch", 4);
				Object[] objs = match.getNodes();
				objs[0] = msg.source;
				objs[3] = msg.target;
				currentDepth++;
