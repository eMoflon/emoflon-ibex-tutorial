...
public class NurseToStaffRule__CC_193_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.multi_lookup = (o) -> ((HospitalExample.Hospital) o).getStaff().stream().filter(obj -> obj instanceof HospitalExample.Nurse).collect(Collectors.toList());
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.multi_lookup = (o) -> ((AdministrationExample.Administration) o).getStaff();
						edge_explorer_3_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof AdministrationExample.Administration) return edge_explorer_3_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
						edge_explorer_3 = new EdgeExplorer(this, 3, 5, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> ((Hospital2Administration.HospitalToAdministration) o).getTarget();
						edge_explorer_4 = new CachedEdgeExplorer(this, 2, 3, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.multi_lookup = (o) -> ((AdministrationExample.Shiftplan) o).getShifts();
						edge_explorer_5_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof AdministrationExample.Shiftplan) return edge_explorer_5_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
						edge_explorer_5 = new EdgeExplorer(this, 7, 6, edge_explorer_5_methods);
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						...
						edge_explorer_6 = new EdgeExplorer(this, 5, 7, edge_explorer_6_methods);
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						...
						edge_explorer_7_methods.multi_opposite_lookup = (o) -> ((HospitalExample.Department) o).getStaff().stream().filter(obj -> obj instanceof HospitalExample.Nurse).collect(Collectors.toList());
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						...
						edge_explorer_8 = new CachedEdgeExplorer(this, 2, 1, edge_explorer_8_methods);
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("NurseToStaffRule__CC_production"), this::returnTrue , 0  , false ));
	}
			...
			case "Department_object_SP1": 
				{
					...
					// d
					HMatch match_0 = new LocalSearchMatch("NurseToStaffRule__CC_193_localSearch", 8);
			...
			case "Hospital_object_SP0": 
				{
					...
					// h
					HMatch match_1 = new LocalSearchMatch("NurseToStaffRule__CC_193_localSearch", 8);
			...
			case "HospitalToAdministration_object_SP1": 
				{
					...
					// htov
					HMatch match_2 = new LocalSearchMatch("NurseToStaffRule__CC_193_localSearch", 8);
			...
			case "Administration_object_SP0": 
				{
					...
					// v
					HMatch match_3 = new LocalSearchMatch("NurseToStaffRule__CC_193_localSearch", 8);
			...
			case "Nurse_object_SP0": 
				{
					...
					// s1
					HMatch match_4 = new LocalSearchMatch("NurseToStaffRule__CC_193_localSearch", 8);
			...
			case "Staff_object_SP3": 
				{
					...
					// s2
					HMatch match_5 = new LocalSearchMatch("NurseToStaffRule__CC_193_localSearch", 8);
			...
			case "Shift_object_SP0": 
				{
					...
					// sh
					HMatch match_6 = new LocalSearchMatch("NurseToStaffRule__CC_193_localSearch", 8);
			...
			case "Shiftplan_object_SP2": 
				{
					...
					// sp
					HMatch match_7 = new LocalSearchMatch("NurseToStaffRule__CC_193_localSearch", 8);
					match_7.getNodes()[7] = objs[0];
					start(edge_explorer_5_1_orchestration, match_7);
				}
				break;
			case "NurseToStaffRule_s2_shiftPlan_outgoing_TRG__FILTER_NAC_TRG_171_localSearch": 
				{
				...
				break;
			case "NurseToStaffRule_sp_shifts_outgoing_TRG__FILTER_NAC_TRG_175_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "NurseToStaffRule_s2_shiftPlan_outgoing_TRG__FILTER_NAC_TRG_171_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("NurseToStaffRule__CC_193_localSearch", 8);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
			...
			case "NurseToStaffRule_sp_shifts_outgoing_TRG__FILTER_NAC_TRG_175_localSearch": 
				if(nac_checker_0.deregister(match)) {
					HMatch acMatch_1 = new LocalSearchMatch("NurseToStaffRule__CC_193_localSearch", 8);
					Object[] acMatch_nodes_1 = acMatch_1.getNodes();
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "Hospital_staff_Staff": 
			...
			{
				HMatch match = new LocalSearchMatch("NurseToStaffRule__CC_193_localSearch", 8);
				Object[] objs = match.getNodes();
				objs[1] = msg.source;
				objs[4] = msg.target;
				currentDepth++;
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof HospitalExample.Nurse) {
			...
			if(formerMatches_4 != null) {
				...
				formerMatches_4 = formerMatches_4.stream().filter(m -> !constraint_checker_0.check(m) || !constraint_checker_1.check(m)).collect(Collectors.toList());
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_25.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, d.getDID(), "int"));
		csp_25.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, s2.getDInt(), "int"));
		csp_25.solve();
		
		boolean predicate = csp_25.isSatisfied();
		return predicate;
	}
	
	public boolean constraint_checker_0_method(HMatch match) {
		HospitalExample.Nurse s1 = (HospitalExample.Nurse) match.getNodes()[4];
		AdministrationExample.Staff s2 = (AdministrationExample.Staff) match.getNodes()[5];
		
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_incrementingStaffID csp_26 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_incrementingStaffID();
		csp_26.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, s1.getStaffID(), "int"));
		csp_26.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, s2.getStaffID(), "int"));
		csp_26.solve();
		
		boolean predicate = csp_26.isSatisfied();
		return predicate;
	}
	...
	public boolean constraint_checker_1_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_nametoname csp_27 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_nametoname();
		csp_27.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, " ", "java.lang.String"));
		csp_27.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, s2.getFirstName(), "java.lang.String"));
		csp_27.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, s2.getLastName(), "java.lang.String"));
		csp_27.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, s1.getName(), "java.lang.String"));
		csp_27.solve();
	...
	public boolean constraint_checker_2_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_nursesalary csp_28 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_nursesalary();
		csp_28.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, s2.getSalary(), "double"));
		csp_28.solve();
