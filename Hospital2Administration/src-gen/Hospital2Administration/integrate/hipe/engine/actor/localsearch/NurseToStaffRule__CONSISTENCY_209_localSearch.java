...
public class NurseToStaffRule__CONSISTENCY_209_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> ((Hospital2Administration.NurseToStaffRule__Marker) o).getCREATE__CORR__stot();
						edge_explorer = new CachedEdgeExplorer(this, 9, 8, edge_explorer_methods);
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> ((Hospital2Administration.NurseToStaffRule__Marker) o).getCREATE__TRG__sp();
						edge_explorer_6 = new CachedEdgeExplorer(this, 9, 5, edge_explorer_6_methods);
		name2explorer.put("edge_explorer_6", edge_explorer_6);
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> ((Hospital2Administration.NurseToStaffRule__Marker) o).getCONTEXT__SRC__d();
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> ((Hospital2Administration.NurseToStaffRule__Marker) o).getCONTEXT__CORR__htov();
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> ((Hospital2Administration.NurseToStaffRule__Marker) o).getCONTEXT__SRC__h();
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> ((Hospital2Administration.NurseToStaffRule__Marker) o).getCONTEXT__TRG__v();
						edge_explorer_10 = new CachedEdgeExplorer(this, 9, 6, edge_explorer_10_methods);
		name2explorer.put("edge_explorer_10", edge_explorer_10);
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> ((Hospital2Administration.NurseToStaffRule__Marker) o).getCREATE__SRC__s1();
						edge_explorer_11 = new CachedEdgeExplorer(this, 9, 2, edge_explorer_11_methods);
		...
		pac_explorer = new PACExplorer(this, Arrays.asList(new Integer[] {0,1,2,6,7}), node.getAllOverlaps().get(0));
			...
			case "StaffToStaff_object_SP1": 
				{
					...
					// stot
					HMatch match_8 = new LocalSearchMatch("NurseToStaffRule__CONSISTENCY_209_localSearch", 10);
			...
			case "NurseToStaffRule__Marker_object": 
				{
					...
					HMatch match_9 = new LocalSearchMatch("NurseToStaffRule__CONSISTENCY_209_localSearch", 10);
					match_9.getNodes()[9] = objs[0];
					start(edge_explorer_1_orchestration, match_9);
				}
				break;
			case "NurseToStaffRule__FWD_206_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("NurseToStaffRule__CONSISTENCY_209_localSearch", 10);
				...
				break;
			case "NurseToStaffRule__BWD_184_junction": 
				{
					if(pac_explorer_0.register(match)) {
						HMatch acMatch_1 = new LocalSearchMatch("NurseToStaffRule__CONSISTENCY_209_localSearch", 10);
		...
		switch(match.creator) {
			...
			case "NurseToStaffRule__FWD_206_localSearch": 
				if(pac_explorer.deregister(match)) {
					OverlapMatch acMatch_0 = new OverlapMatch(5);
		...
		case "NurseToStaffRule__Marker_CREATE__CORR__stot_StaffToStaff": 
			{
				...
				HMatch match = new LocalSearchMatch("NurseToStaffRule__CONSISTENCY_209_localSearch", 10);
				Object[] objs = match.getNodes();
				objs[9] = msg.source;
				objs[8] = msg.target;
				currentDepth++;
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register NurseToStaffRule__FWD
		OverlapMatch oMatch_0 = new OverlapMatch(5);
		...
		// register NurseToStaffRule__BWD
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister NurseToStaffRule__FWD
		OverlapMatch oMatch_0 = new OverlapMatch(5);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[0];
		oMatch_Nodes_0[1] = objs[1];
		...
		// deregister NurseToStaffRule__BWD
		OverlapMatch oMatch_1 = new OverlapMatch(7);
		Object[] oMatch_Nodes_1 = oMatch_1.getNodes();
		oMatch_Nodes_1[0] = objs[0];
		oMatch_Nodes_1[1] = objs[1];
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof HospitalExample.Nurse) {
			HMatch match_2 = new LocalSearchMatch("NurseToStaffRule__CONSISTENCY_209_localSearch", 10);
		...
		if(obj instanceof AdministrationExample.Staff) {
			HMatch match_3 = new LocalSearchMatch("NurseToStaffRule__CONSISTENCY_209_localSearch", 10);
		...
		if(obj instanceof HospitalExample.Department) {
			HMatch match_0 = new LocalSearchMatch("NurseToStaffRule__CONSISTENCY_209_localSearch", 10);
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_29.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, d.getDID(), "int"));
		csp_29.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, s2.getDInt(), "int"));
		csp_29.solve();
	...
	public boolean constraint_checker_0_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_incrementingStaffID csp_30 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_incrementingStaffID();
		csp_30.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, s1.getStaffID(), "int"));
		csp_30.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, s2.getStaffID(), "int"));
		csp_30.solve();
		
		boolean predicate = csp_30.isSatisfied();
		return predicate;
	}
	...
	public boolean constraint_checker_1_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_nametoname csp_31 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_nametoname();
		csp_31.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, " ", "java.lang.String"));
		csp_31.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, s2.getFirstName(), "java.lang.String"));
		csp_31.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, s2.getLastName(), "java.lang.String"));
		csp_31.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, s1.getName(), "java.lang.String"));
		csp_31.solve();
		
		boolean predicate = csp_31.isSatisfied();
		return predicate;
	}
	...
	public boolean constraint_checker_2_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_nursesalary csp_32 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_nursesalary();
		csp_32.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, s2.getSalary(), "double"));
		csp_32.solve();
		
		boolean predicate = csp_32.isSatisfied();
		return predicate;
	}
