...
public class PatientInReception__BWD_215_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		pac_explorer = new PACExplorer(this, Arrays.asList(new Integer[] {3,4}), node.getAllOverlaps().get(0));
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(1), getSelf(), name2actor.get("PatientInReception__CONSISTENCY_236_localSearch"), this::returnTrue  , false ));
	}
			...
			case "Hospital_object_SP2": 
				{
					...
					// h
					HMatch match_0 = new LocalSearchMatch("PatientInReception__BWD_215_localSearch", 5);
			...
			case "HospitalToAdministration_object_SP3": 
				{
					...
					// htov
					HMatch match_1 = new LocalSearchMatch("PatientInReception__BWD_215_localSearch", 5);
			...
			case "Reception_object_SP1": 
				{
					...
					// r
					HMatch match_2 = new LocalSearchMatch("PatientInReception__BWD_215_localSearch", 5);
					match_2.getNodes()[2] = objs[0];
					start(edge_explorer_3_2_orchestration, match_2);
				}
				break;
			case "PatientInReception__TRG_212_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("PatientInReception__BWD_215_localSearch", 5);
		...
		case "HospitalToAdministration_target_Administration": 
			{
				...
				HMatch match = new LocalSearchMatch("PatientInReception__BWD_215_localSearch", 5);
				Object[] objs = match.getNodes();
				objs[1] = msg.source;
				objs[3] = msg.target;
				currentDepth++;
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register PatientInReception__TRG
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister PatientInReception__TRG
		OverlapMatch oMatch_0 = new OverlapMatch(2);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[3];
		oMatch_Nodes_0[1] = objs[4];
