...
public class PatientInReception__CC_222_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.multi_lookup = (o) -> ((HospitalExample.Reception) o).getWaits();
						edge_explorer_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof HospitalExample.Reception) return edge_explorer_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
			...
			case "Hospital_object_SP3": 
				{
					...
					// h
					HMatch match_0 = new LocalSearchMatch("PatientInReception__CC_222_localSearch", 6);
			...
			case "HospitalToAdministration_object_SP0": 
				{
					...
					// htov
					HMatch match_1 = new LocalSearchMatch("PatientInReception__CC_222_localSearch", 6);
			...
			case "Reception_object_SP0": 
				{
					...
					// r
					HMatch match_2 = new LocalSearchMatch("PatientInReception__CC_222_localSearch", 6);
			...
			case "Administration_object_SP3": 
				{
					...
					// v
					HMatch match_3 = new LocalSearchMatch("PatientInReception__CC_222_localSearch", 6);
			...
			case "Patient_object_SP1": 
				{
					...
					// p1
					HMatch match_4 = new LocalSearchMatch("PatientInReception__CC_222_localSearch", 6);
			...
			case "Patient_1_object_SP2": 
				{
					...
					// p2
					HMatch match_5 = new LocalSearchMatch("PatientInReception__CC_222_localSearch", 6);
					match_5.getNodes()[5] = objs[0];
					start(edge_explorer_3_2_orchestration, match_5);
				}
				break;
			case "PatientInReception_p1_lies_incoming_SRC__FILTER_NAC_SRC_219_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "PatientInReception_p1_lies_incoming_SRC__FILTER_NAC_SRC_219_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("PatientInReception__CC_222_localSearch", 6);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "Reception_waits_Patient": 
			{
				HMatch match = new LocalSearchMatch("PatientInReception__CC_222_localSearch", 6);
				Object[] objs = match.getNodes();
				objs[2] = msg.source;
				objs[4] = msg.target;
				currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_incrementingPatientID csp_33 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_incrementingPatientID();
		csp_33.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, p1.getPatientID(), "int"));
		csp_33.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, p2.getPatientID(), "int"));
		csp_33.solve();
		
		boolean predicate = csp_33.isSatisfied();
		return predicate;
	}
	...
	public boolean constraint_checker_0_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_nametoname csp_34 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_nametoname();
		csp_34.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, " ", "java.lang.String"));
		csp_34.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, p2.getFirstName(), "java.lang.String"));
		csp_34.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, p2.getLastName(), "java.lang.String"));
		csp_34.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, p1.getName(), "java.lang.String"));
		csp_34.solve();
		
		boolean predicate = csp_34.isSatisfied();
		return predicate;
	}
