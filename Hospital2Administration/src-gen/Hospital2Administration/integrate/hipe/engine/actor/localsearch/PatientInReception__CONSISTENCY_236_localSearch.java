...
public class PatientInReception__CONSISTENCY_236_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> ((Hospital2Administration.PatientInReception__Marker) o).getCONTEXT__TRG__v();
						edge_explorer = new CachedEdgeExplorer(this, 7, 4, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> ((Hospital2Administration.PatientInReception__Marker) o).getCREATE__SRC__p1();
						edge_explorer_3 = new CachedEdgeExplorer(this, 7, 1, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> ((Hospital2Administration.PatientInReception__Marker) o).getCREATE__TRG__p2();
						edge_explorer_4 = new CachedEdgeExplorer(this, 7, 3, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> ((Hospital2Administration.PatientInReception__Marker) o).getCREATE__CORR__pTop();
						edge_explorer_5 = new CachedEdgeExplorer(this, 7, 6, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> ((Hospital2Administration.PatientInReception__Marker) o).getCONTEXT__SRC__r();
						edge_explorer_6 = new CachedEdgeExplorer(this, 7, 2, edge_explorer_6_methods);
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> ((Hospital2Administration.PatientInReception__Marker) o).getCONTEXT__SRC__h();
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> ((Hospital2Administration.PatientInReception__Marker) o).getCONTEXT__CORR__htov();
		...
		pac_explorer = new PACExplorer(this, Arrays.asList(new Integer[] {0,1,2,4,5}), node.getAllOverlaps().get(0));
			...
			case "PatientToPatient_object_SP0": 
				{
					...
					// pTop
					HMatch match_6 = new LocalSearchMatch("PatientInReception__CONSISTENCY_236_localSearch", 8);
			...
			case "PatientInReception__Marker_object": 
				{
					...
					HMatch match_7 = new LocalSearchMatch("PatientInReception__CONSISTENCY_236_localSearch", 8);
					match_7.getNodes()[7] = objs[0];
					start(edge_explorer_1_orchestration, match_7);
				}
				break;
			case "PatientInReception__FWD_233_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("PatientInReception__CONSISTENCY_236_localSearch", 8);
				...
				break;
			case "PatientInReception__BWD_215_localSearch": 
				{
					if(pac_explorer_0.register(match)) {
						HMatch acMatch_1 = new LocalSearchMatch("PatientInReception__CONSISTENCY_236_localSearch", 8);
						acMatch_1.getNodes()[0] = objs[0];
						acMatch_1.getNodes()[2] = objs[2];
						acMatch_1.getNodes()[3] = objs[4];
						acMatch_1.getNodes()[4] = objs[3];
						acMatch_1.getNodes()[5] = objs[1];
		...
		switch(match.creator) {
			...
			case "PatientInReception__FWD_233_localSearch": 
				if(pac_explorer.deregister(match)) {
					...
					acMatch_0.getNodes()[4] = match.getNodes()[1];
			...
			case "PatientInReception__BWD_215_localSearch": 
				if(pac_explorer_0.deregister(match)) {
					...
					acMatch_1.getNodes()[4] = match.getNodes()[1];
		...
		case "PatientInReception__Marker_CONTEXT__TRG__v_Administration": 
			{
				...
				HMatch match = new LocalSearchMatch("PatientInReception__CONSISTENCY_236_localSearch", 8);
				Object[] objs = match.getNodes();
				objs[7] = msg.source;
				objs[4] = msg.target;
				currentDepth++;
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register PatientInReception__FWD
		...
		// register PatientInReception__BWD
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister PatientInReception__FWD
		OverlapMatch oMatch_0 = new OverlapMatch(5);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[0];
		oMatch_Nodes_0[1] = objs[1];
		...
		// deregister PatientInReception__BWD
		OverlapMatch oMatch_1 = new OverlapMatch(5);
		Object[] oMatch_Nodes_1 = oMatch_1.getNodes();
		oMatch_Nodes_1[0] = objs[0];
		oMatch_Nodes_1[1] = objs[2];
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof HospitalExample.Patient) {
			HMatch match_1 = new LocalSearchMatch("PatientInReception__CONSISTENCY_236_localSearch", 8);
		...
		if(obj instanceof AdministrationExample.Patient) {
			HMatch match_3 = new LocalSearchMatch("PatientInReception__CONSISTENCY_236_localSearch", 8);
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_incrementingPatientID csp_35 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_incrementingPatientID();
		csp_35.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, p1.getPatientID(), "int"));
		csp_35.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, p2.getPatientID(), "int"));
		csp_35.solve();
		
		boolean predicate = csp_35.isSatisfied();
		return predicate;
	}
	...
	public boolean constraint_checker_0_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_nametoname csp_36 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_nametoname();
		csp_36.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, " ", "java.lang.String"));
		csp_36.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, p2.getFirstName(), "java.lang.String"));
		csp_36.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, p2.getLastName(), "java.lang.String"));
		csp_36.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, p1.getName(), "java.lang.String"));
		csp_36.solve();
