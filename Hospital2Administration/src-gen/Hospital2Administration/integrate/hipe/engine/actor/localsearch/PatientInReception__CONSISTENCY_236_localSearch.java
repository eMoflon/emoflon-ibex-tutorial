...
public class PatientInReception__CONSISTENCY_236_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> ((Hospital2Administration.PatientInReception__Marker) o).getCONTEXT__SRC__h();
						edge_explorer = new CachedEdgeExplorer(this, 7, 0, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> ((Hospital2Administration.PatientInReception__Marker) o).getCONTEXT__TRG__v();
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						...
						edge_explorer_5 = new CachedEdgeExplorer(this, 6, 3, edge_explorer_5_methods);
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> ((Hospital2Administration.PatientInReception__Marker) o).getCONTEXT__CORR__htov();
						edge_explorer_7 = new CachedEdgeExplorer(this, 7, 5, edge_explorer_7_methods);
