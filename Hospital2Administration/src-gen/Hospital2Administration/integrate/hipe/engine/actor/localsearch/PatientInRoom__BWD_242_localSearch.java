...
public class PatientInRoom__BWD_242_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						...
						edge_explorer_4 = new CachedEdgeExplorer(this, 2, 4, edge_explorer_4_methods);
		...
		pac_explorer = new PACExplorer(this, Arrays.asList(new Integer[] {4,5}), node.getAllOverlaps().get(0));
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(1), getSelf(), name2actor.get("PatientInRoom__CONSISTENCY_266_localSearch"), this::returnTrue  , false ));
	}
			...
			case "Department_object_SP3": 
				{
					...
					// d
					HMatch match_0 = new LocalSearchMatch("PatientInRoom__BWD_242_localSearch", 6);
			...
			case "Hospital_object_SP1": 
				{
					...
					// h
					HMatch match_1 = new LocalSearchMatch("PatientInRoom__BWD_242_localSearch", 6);
			...
			case "HospitalToAdministration_object_SP2": 
				{
					...
					// htov
					HMatch match_2 = new LocalSearchMatch("PatientInRoom__BWD_242_localSearch", 6);
			...
			case "Room_object_SP0": 
				{
					...
					// ro
					HMatch match_3 = new LocalSearchMatch("PatientInRoom__BWD_242_localSearch", 6);
					match_3.getNodes()[3] = objs[0];
					start(edge_explorer_5_1_orchestration, match_3);
				}
				break;
			case "PatientInRoom__TRG_239_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("PatientInRoom__BWD_242_localSearch", 6);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "Hospital_department_Department": 
			{
				HMatch match = new LocalSearchMatch("PatientInRoom__BWD_242_localSearch", 6);
				Object[] objs = match.getNodes();
				objs[1] = msg.source;
				objs[0] = msg.target;
				currentDepth++;
