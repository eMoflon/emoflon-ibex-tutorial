...
public class PatientInRoom__CONSISTENCY_266_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> ((Hospital2Administration.PatientToPatient) o).getTarget();
						edge_explorer = new CachedEdgeExplorer(this, 7, 4, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> ((Hospital2Administration.PatientInRoom__Marker) o).getCREATE__CORR__pTop();
						edge_explorer_3 = new CachedEdgeExplorer(this, 8, 7, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> ((Hospital2Administration.PatientInRoom__Marker) o).getCONTEXT__SRC__h();
						edge_explorer_4 = new CachedEdgeExplorer(this, 8, 1, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> ((Hospital2Administration.PatientInRoom__Marker) o).getCONTEXT__SRC__ro();
						edge_explorer_5 = new CachedEdgeExplorer(this, 8, 3, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> ((Hospital2Administration.PatientInRoom__Marker) o).getCONTEXT__SRC__d();
						edge_explorer_6 = new CachedEdgeExplorer(this, 8, 0, edge_explorer_6_methods);
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> ((Hospital2Administration.PatientToPatient) o).getSource();
						edge_explorer_8 = new CachedEdgeExplorer(this, 7, 2, edge_explorer_8_methods);
		name2explorer.put("edge_explorer_8", edge_explorer_8);
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> ((Hospital2Administration.PatientInRoom__Marker) o).getCREATE__SRC__p1();
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> ((Hospital2Administration.PatientInRoom__Marker) o).getCONTEXT__CORR__htov();
						edge_explorer_11 = new CachedEdgeExplorer(this, 8, 6, edge_explorer_11_methods);
		name2explorer.put("edge_explorer_11", edge_explorer_11);
		pac_explorer = new PACExplorer(this, Arrays.asList(new Integer[] {0,1,2,3,5,6}), node.getAllOverlaps().get(0));
			...
			case "PatientToPatient_object_SP1": 
				{
					...
					// pTop
					HMatch match_7 = new LocalSearchMatch("PatientInRoom__CONSISTENCY_266_localSearch", 9);
			...
			case "PatientInRoom__Marker_object": 
				{
					...
					HMatch match_8 = new LocalSearchMatch("PatientInRoom__CONSISTENCY_266_localSearch", 9);
					match_8.getNodes()[8] = objs[0];
					start(edge_explorer_3_1_orchestration, match_8);
				}
				break;
			case "PatientInRoom__FWD_263_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("PatientInRoom__CONSISTENCY_266_localSearch", 9);
				...
				break;
			case "PatientInRoom__BWD_242_localSearch": 
				{
					if(pac_explorer_0.register(match)) {
						HMatch acMatch_1 = new LocalSearchMatch("PatientInRoom__CONSISTENCY_266_localSearch", 9);
		...
		switch(match.creator) {
			...
			case "PatientInRoom__FWD_263_localSearch": 
				if(pac_explorer.deregister(match)) {
					OverlapMatch acMatch_0 = new OverlapMatch(6);
					...
					acMatch_0.getNodes()[5] = match.getNodes()[2];
		...
		case "PatientToPatient_target_Patient": 
			{
				...
				HMatch match = new LocalSearchMatch("PatientInRoom__CONSISTENCY_266_localSearch", 9);
				Object[] objs = match.getNodes();
				objs[7] = msg.source;
				objs[4] = msg.target;
				currentDepth++;
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register PatientInRoom__FWD
		OverlapMatch oMatch_0 = new OverlapMatch(6);
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof HospitalExample.Patient) {
			HMatch match_2 = new LocalSearchMatch("PatientInRoom__CONSISTENCY_266_localSearch", 9);
		...
		if(obj instanceof AdministrationExample.Patient) {
			HMatch match_4 = new LocalSearchMatch("PatientInRoom__CONSISTENCY_266_localSearch", 9);
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_incrementingPatientID csp_39 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_incrementingPatientID();
		csp_39.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, p1.getPatientID(), "int"));
		csp_39.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, p2.getPatientID(), "int"));
		csp_39.solve();
		
		boolean predicate = csp_39.isSatisfied();
		return predicate;
	}
	...
	public boolean constraint_checker_0_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_nametoname csp_40 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_nametoname();
		csp_40.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, " ", "java.lang.String"));
		csp_40.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, p2.getFirstName(), "java.lang.String"));
		csp_40.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, p2.getLastName(), "java.lang.String"));
		csp_40.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, p1.getName(), "java.lang.String"));
		csp_40.solve();
