...
public class RoomRule__CONSISTENCY_276_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> ((Hospital2Administration.RoomRule__Marker) o).getCREATE__SRC__ro();
						edge_explorer = new CachedEdgeExplorer(this, 2, 1, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> ((Hospital2Administration.RoomRule__Marker) o).getCONTEXT__SRC__d();
			...
			case "RoomRule__Marker_object": 
				{
					...
					HMatch match_2 = new LocalSearchMatch("RoomRule__CONSISTENCY_276_localSearch", 3);
					match_2.getNodes()[2] = objs[0];
					start(edge_explorer_1_orchestration, match_2);
				}
				break;
			case "RoomRule__FWD_275_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("RoomRule__CONSISTENCY_276_localSearch", 3);
		...
		case "RoomRule__Marker_CREATE__SRC__ro_Room": 
			{
				...
				HMatch match = new LocalSearchMatch("RoomRule__CONSISTENCY_276_localSearch", 3);
				Object[] objs = match.getNodes();
				objs[2] = msg.source;
				objs[1] = msg.target;
				currentDepth++;
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof HospitalExample.Room) {
			HMatch match_1 = new LocalSearchMatch("RoomRule__CONSISTENCY_276_localSearch", 3);
