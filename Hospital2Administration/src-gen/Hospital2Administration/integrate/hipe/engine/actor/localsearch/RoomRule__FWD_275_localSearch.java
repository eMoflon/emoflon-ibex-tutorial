...
public class RoomRule__FWD_275_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("RoomRule__CONSISTENCY_276_localSearch"), this::returnTrue  , false ));
		ports.add(new PortJunction(node.getPorts().getPort().get(1), getSelf(), name2actor.get("RoomRule__FWD_production"), this::returnTrue , 0  , false ));
	}
	...
	protected void added(MatchAdded<HMatch> msg) {
		...
		switch(match.creator) {
			case "RoomRule__SRC_272_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("RoomRule__FWD_275_localSearch", 2);
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof HospitalExample.Room) {
			HMatch match_1 = new LocalSearchMatch("RoomRule__FWD_275_localSearch", 2);
