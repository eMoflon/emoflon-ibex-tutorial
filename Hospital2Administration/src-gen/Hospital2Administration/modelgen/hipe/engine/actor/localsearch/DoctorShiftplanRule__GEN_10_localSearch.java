...
public class DoctorShiftplanRule__GEN_10_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						...
						edge_explorer = new EdgeExplorer(this, 4, 7, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> ((HospitalExample.Patient) o).getDoctor();
						edge_explorer_3_methods.multi_opposite_lookup = (o) -> ((HospitalExample.Doctor) o).getCaresfor();
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("DoctorShiftplanRule__GEN_production"), this::returnTrue  , false ));
	}
			...
			case "Patient_object": 
				{
					...
					// p1
					HMatch match_0 = new LocalSearchMatch("DoctorShiftplanRule__GEN_10_localSearch", 8);
			...
			case "Patient_1_object": 
				{
					...
					// p2
					HMatch match_1 = new LocalSearchMatch("DoctorShiftplanRule__GEN_10_localSearch", 8);
			...
			case "PatientToPatient_object": 
				{
					...
					// pToP
					HMatch match_2 = new LocalSearchMatch("DoctorShiftplanRule__GEN_10_localSearch", 8);
			...
			case "Doctor_object": 
				{
					...
					// s1
					HMatch match_3 = new LocalSearchMatch("DoctorShiftplanRule__GEN_10_localSearch", 8);
			...
			case "Staff_object": 
				{
					...
					// s2
					HMatch match_4 = new LocalSearchMatch("DoctorShiftplanRule__GEN_10_localSearch", 8);
			...
			case "StaffToStaff_object": 
				{
					...
					// sToS
					HMatch match_5 = new LocalSearchMatch("DoctorShiftplanRule__GEN_10_localSearch", 8);
			...
			case "Shift_object": 
				{
					...
					// sh
					HMatch match_6 = new LocalSearchMatch("DoctorShiftplanRule__GEN_10_localSearch", 8);
			...
			case "Shiftplan_object": 
				{
					...
					// sp
					HMatch match_7 = new LocalSearchMatch("DoctorShiftplanRule__GEN_10_localSearch", 8);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "Staff_shiftPlan_Shiftplan": 
			{
				HMatch match = new LocalSearchMatch("DoctorShiftplanRule__GEN_10_localSearch", 8);
				Object[] objs = match.getNodes();
				objs[4] = msg.source;
				objs[7] = msg.target;
				currentDepth++;
