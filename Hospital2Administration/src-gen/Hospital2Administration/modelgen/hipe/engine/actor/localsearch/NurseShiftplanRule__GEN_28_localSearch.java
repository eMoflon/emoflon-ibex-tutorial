package Hospital2Administration.modelgen.hipe.engine.actor.localsearch;
...
public class NurseShiftplanRule__GEN_28_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						...
						edge_explorer_4 = new EdgeExplorer(this, 8, 7, edge_explorer_4_methods);
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("NurseShiftplanRule__GEN_production"), this::returnTrue  , false ));
	}
			...
			case "Patient_object": 
				{
					...
					// p1
					HMatch match_0 = new LocalSearchMatch("NurseShiftplanRule__GEN_28_localSearch", 9);
			...
			case "Patient_1_object": 
				{
					...
					// p2
					HMatch match_1 = new LocalSearchMatch("NurseShiftplanRule__GEN_28_localSearch", 9);
			...
			case "PatientToPatient_object": 
				{
					...
					// pToP
					HMatch match_2 = new LocalSearchMatch("NurseShiftplanRule__GEN_28_localSearch", 9);
			...
			case "Room_object": 
				{
					...
					// ro
					HMatch match_3 = new LocalSearchMatch("NurseShiftplanRule__GEN_28_localSearch", 9);
			...
			case "Nurse_object": 
				{
					...
					// s1
					HMatch match_4 = new LocalSearchMatch("NurseShiftplanRule__GEN_28_localSearch", 9);
			...
			case "Staff_object": 
				{
					...
					// s2
					HMatch match_5 = new LocalSearchMatch("NurseShiftplanRule__GEN_28_localSearch", 9);
			...
			case "StaffToStaff_object": 
				{
					...
					// sToS
					HMatch match_6 = new LocalSearchMatch("NurseShiftplanRule__GEN_28_localSearch", 9);
			...
			case "Shift_object": 
				{
					...
					// sh
					HMatch match_7 = new LocalSearchMatch("NurseShiftplanRule__GEN_28_localSearch", 9);
			...
			case "Shiftplan_object": 
				{
					...
					// sp
					HMatch match_8 = new LocalSearchMatch("NurseShiftplanRule__GEN_28_localSearch", 9);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "Staff_shiftPlan_Shiftplan": 
			{
				HMatch match = new LocalSearchMatch("NurseShiftplanRule__GEN_28_localSearch", 9);
				Object[] objs = match.getNodes();
				objs[5] = msg.source;
				objs[8] = msg.target;
				currentDepth++;
