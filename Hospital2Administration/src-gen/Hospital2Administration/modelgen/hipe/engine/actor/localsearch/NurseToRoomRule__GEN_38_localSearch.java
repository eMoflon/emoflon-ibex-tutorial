...
public class NurseToRoomRule__GEN_38_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("NurseToRoomRule__GEN_production"), this::returnTrue  , false ));
	}
			...
			case "Department_object_SP0": 
				{
					...
					// dep
					HMatch match_0 = new LocalSearchMatch("NurseToRoomRule__GEN_38_localSearch", 8);
			...
			case "Nurse_object": 
				{
					...
					// n
					HMatch match_1 = new LocalSearchMatch("NurseToRoomRule__GEN_38_localSearch", 8);
			...
			case "StaffToStaff_object": 
				{
					...
					// nToS
					HMatch match_2 = new LocalSearchMatch("NurseToRoomRule__GEN_38_localSearch", 8);
			...
			case "Patient_object": 
				{
					...
					// p1
					HMatch match_3 = new LocalSearchMatch("NurseToRoomRule__GEN_38_localSearch", 8);
			...
			case "Patient_1_object": 
				{
					...
					// p2
					HMatch match_4 = new LocalSearchMatch("NurseToRoomRule__GEN_38_localSearch", 8);
					match_4.getNodes()[4] = objs[0];
					start(edge_explorer_6_2_orchestration, match_4);
				}
				break;
			case "PatientToPatient_object": 
				{
					...
					// pTop
					HMatch match_5 = new LocalSearchMatch("NurseToRoomRule__GEN_38_localSearch", 8);
			...
			case "Room_object": 
				{
					...
					// r
					HMatch match_6 = new LocalSearchMatch("NurseToRoomRule__GEN_38_localSearch", 8);
			...
			case "Staff_object": 
				{
					...
					// s
					HMatch match_7 = new LocalSearchMatch("NurseToRoomRule__GEN_38_localSearch", 8);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "Staff_works_Department": 
			...
			{
				HMatch match = new LocalSearchMatch("NurseToRoomRule__GEN_38_localSearch", 8);
				Object[] objs = match.getNodes();
				objs[1] = msg.source;
				objs[0] = msg.target;
				currentDepth++;
