...
public class PatientInReception__GEN_55_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("PatientInReception__GEN_production"), this::returnTrue  , false ));
	}
			...
			case "Hospital_object": 
				{
					...
					// h
					HMatch match_0 = new LocalSearchMatch("PatientInReception__GEN_55_localSearch", 4);
			...
			case "HospitalToAdministration_object": 
				{
					...
					// htov
					HMatch match_1 = new LocalSearchMatch("PatientInReception__GEN_55_localSearch", 4);
			...
			case "Reception_object": 
				{
					...
					// r
					HMatch match_2 = new LocalSearchMatch("PatientInReception__GEN_55_localSearch", 4);
			...
			case "Administration_object": 
				{
					...
					// v
					HMatch match_3 = new LocalSearchMatch("PatientInReception__GEN_55_localSearch", 4);
		...
		case "HospitalToAdministration_source_Hospital": 
			{
				...
				HMatch match = new LocalSearchMatch("PatientInReception__GEN_55_localSearch", 4);
				Object[] objs = match.getNodes();
				objs[1] = msg.source;
				objs[0] = msg.target;
				currentDepth++;
