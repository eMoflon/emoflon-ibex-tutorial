...
public class PatientInRoom__GEN_60_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("PatientInRoom__GEN_production"), this::returnTrue  , false ));
	}
			...
			case "Department_object_SP0": 
				{
					...
					// d
					HMatch match_0 = new LocalSearchMatch("PatientInRoom__GEN_60_localSearch", 5);
			...
			case "Hospital_object": 
				{
					...
					// h
					HMatch match_1 = new LocalSearchMatch("PatientInRoom__GEN_60_localSearch", 5);
			...
			case "HospitalToAdministration_object": 
				{
					...
					// htov
					HMatch match_2 = new LocalSearchMatch("PatientInRoom__GEN_60_localSearch", 5);
			...
			case "Room_object": 
				{
					...
					// ro
					HMatch match_3 = new LocalSearchMatch("PatientInRoom__GEN_60_localSearch", 5);
			...
			case "Administration_object": 
				{
					...
					// v
					HMatch match_4 = new LocalSearchMatch("PatientInRoom__GEN_60_localSearch", 5);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "Department_rooms_Room": 
			{
				HMatch match = new LocalSearchMatch("PatientInRoom__GEN_60_localSearch", 5);
				Object[] objs = match.getNodes();
				objs[0] = msg.source;
				objs[3] = msg.target;
				currentDepth++;
