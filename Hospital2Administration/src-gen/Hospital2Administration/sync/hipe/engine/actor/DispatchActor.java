package Hospital2Administration.sync.hipe.engine.actor;
...
public class DispatchActor extends AbstractActor {
	...
	private void initializeAdd() {
		...
		type2addConsumer.put(AdministrationExample.AdministrationExamplePackage.eINSTANCE.getStaff(), obj -> {
			...
			incUtil.newMessage();
			name2actor.get("Staff_object_SP4").tell(new ObjectAdded<AdministrationExample.Staff>(incUtil, _staff), getSelf());
		});
	...
	private void initializeSet() {
		...
		feature2setConsumer.put(AdministrationExample.AdministrationExamplePackage.eINSTANCE.getPerson_LastName(), notification -> {
			...
			if(notification.getNotifier() instanceof AdministrationExample.Staff) {
				incUtil.newMessage();
				name2actor.get("Staff_object_SP4").tell(new AttributeChanged<AdministrationExample.Person>(incUtil, (AdministrationExample.Person) notification.getNotifier(), notification.getOldValue()), getSelf());
			}
		});
		...
		feature2setConsumer.put(AdministrationExample.AdministrationExamplePackage.eINSTANCE.getStaff_DInt(), notification -> {
			...
			if(notification.getNotifier() instanceof AdministrationExample.Staff) {
				incUtil.newMessage();
				name2actor.get("Staff_object_SP4").tell(new AttributeChanged<AdministrationExample.Staff>(incUtil, (AdministrationExample.Staff) notification.getNotifier(), notification.getOldValue()), getSelf());
			}
		});
	...
	private void initializeAddEdge() {
		...
		feature2addEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getPatientInRoom__Marker_CONTEXT__TRG__v(), notification -> {
			incUtil.newMessage();
			name2actor.get("PatientInRoom__CONSISTENCY_237_localSearch").tell(new ReferenceAdded<Hospital2Administration.PatientInRoom__Marker, AdministrationExample.Administration>(incUtil,(Hospital2Administration.PatientInRoom__Marker) notification.getNotifier(), (AdministrationExample.Administration) notification.getNewValue(), "PatientInRoom__Marker_CONTEXT__TRG__v_Administration"), getSelf());
		});
		feature2addEdgeConsumer.put(HospitalExample.HospitalExamplePackage.eINSTANCE.getPatient_Doctor(), notification -> {
			incUtil.newMessage();
			name2actor.get("DoctorShiftplanRule__BWD_52_localSearch").tell(new ReferenceAdded<HospitalExample.Patient, HospitalExample.Doctor>(incUtil,(HospitalExample.Patient) notification.getNotifier(), (HospitalExample.Doctor) notification.getNewValue(), "Patient_doctor_Doctor"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorShiftplanRule__CONSISTENCY_61_localSearch").tell(new ReferenceAdded<HospitalExample.Patient, HospitalExample.Doctor>(incUtil,(HospitalExample.Patient) notification.getNotifier(), (HospitalExample.Doctor) notification.getNewValue(), "Patient_doctor_Doctor"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__CONSISTENCY_85_localSearch").tell(new ReferenceAdded<HospitalExample.Patient, HospitalExample.Doctor>(incUtil,(HospitalExample.Patient) notification.getNotifier(), (HospitalExample.Doctor) notification.getNewValue(), "Patient_doctor_Doctor"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__FWD_96_localSearch").tell(new ReferenceAdded<HospitalExample.Patient, HospitalExample.Doctor>(incUtil,(HospitalExample.Patient) notification.getNotifier(), (HospitalExample.Doctor) notification.getNewValue(), "Patient_doctor_Doctor"), getSelf());
		});
		feature2addEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getDoctorShiftplanRule__Marker_CONTEXT__TRG__sh(), notification -> {
			incUtil.newMessage();
			name2actor.get("DoctorShiftplanRule__CONSISTENCY_61_localSearch").tell(new ReferenceAdded<Hospital2Administration.DoctorShiftplanRule__Marker, AdministrationExample.Shift>(incUtil,(Hospital2Administration.DoctorShiftplanRule__Marker) notification.getNotifier(), (AdministrationExample.Shift) notification.getNewValue(), "DoctorShiftplanRule__Marker_CONTEXT__TRG__sh_Shift"), getSelf());
		});
		feature2addEdgeConsumer.put(HospitalExample.HospitalExamplePackage.eINSTANCE.getRoom_Lies(), notification -> {
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__BWD_75_localSearch").tell(new ReferenceAdded<HospitalExample.Room, HospitalExample.Patient>(incUtil,(HospitalExample.Room) notification.getNotifier(), (HospitalExample.Patient) notification.getNewValue(), "Room_lies_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__CONSISTENCY_85_localSearch").tell(new ReferenceAdded<HospitalExample.Room, HospitalExample.Patient>(incUtil,(HospitalExample.Room) notification.getNotifier(), (HospitalExample.Patient) notification.getNewValue(), "Room_lies_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__FWD_96_localSearch").tell(new ReferenceAdded<HospitalExample.Room, HospitalExample.Patient>(incUtil,(HospitalExample.Room) notification.getNotifier(), (HospitalExample.Patient) notification.getNewValue(), "Room_lies_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseShiftplanRule__BWD_119_localSearch").tell(new ReferenceAdded<HospitalExample.Room, HospitalExample.Patient>(incUtil,(HospitalExample.Room) notification.getNotifier(), (HospitalExample.Patient) notification.getNewValue(), "Room_lies_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseShiftplanRule__CONSISTENCY_129_localSearch").tell(new ReferenceAdded<HospitalExample.Room, HospitalExample.Patient>(incUtil,(HospitalExample.Room) notification.getNotifier(), (HospitalExample.Patient) notification.getNewValue(), "Room_lies_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToRoomRule__CONSISTENCY_140_localSearch").tell(new ReferenceAdded<HospitalExample.Room, HospitalExample.Patient>(incUtil,(HospitalExample.Room) notification.getNotifier(), (HospitalExample.Patient) notification.getNewValue(), "Room_lies_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToRoomRule__FWD_150_localSearch").tell(new ReferenceAdded<HospitalExample.Room, HospitalExample.Patient>(incUtil,(HospitalExample.Room) notification.getNotifier(), (HospitalExample.Patient) notification.getNewValue(), "Room_lies_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInReception_p1_lies_incoming_SRC__FILTER_NAC_SRC_209_localSearch").tell(new ReferenceAdded<HospitalExample.Room, HospitalExample.Patient>(incUtil,(HospitalExample.Room) notification.getNotifier(), (HospitalExample.Patient) notification.getNewValue(), "Room_lies_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInRoom__CONSISTENCY_237_localSearch").tell(new ReferenceAdded<HospitalExample.Room, HospitalExample.Patient>(incUtil,(HospitalExample.Room) notification.getNotifier(), (HospitalExample.Patient) notification.getNewValue(), "Room_lies_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInRoom__FWD_247_localSearch").tell(new ReferenceAdded<HospitalExample.Room, HospitalExample.Patient>(incUtil,(HospitalExample.Room) notification.getNotifier(), (HospitalExample.Patient) notification.getNewValue(), "Room_lies_Patient"), getSelf());
		});
		feature2addEdgeConsumer.put(AdministrationExample.AdministrationExamplePackage.eINSTANCE.getStaff_ShiftPlan(), notification -> {
			incUtil.newMessage();
			name2actor.get("Staff_shiftPlan_0_reference").tell(new ReferenceAdded<AdministrationExample.Staff, AdministrationExample.Shiftplan>(incUtil,(AdministrationExample.Staff) notification.getNotifier(), (AdministrationExample.Shiftplan) notification.getNewValue(), "Staff_shiftPlan_Shiftplan"), getSelf());
			incUtil.newMessage();
			name2actor.get("Staff_shiftPlan_1_reference").tell(new ReferenceAdded<AdministrationExample.Staff, AdministrationExample.Shiftplan>(incUtil,(AdministrationExample.Staff) notification.getNotifier(), (AdministrationExample.Shiftplan) notification.getNewValue(), "Staff_shiftPlan_Shiftplan"), getSelf());
			incUtil.newMessage();
			name2actor.get("DocToStaffRule_s2_shiftPlan_outgoing_TRG__FILTER_NAC_TRG_8_localSearch").tell(new ReferenceAdded<AdministrationExample.Staff, AdministrationExample.Shiftplan>(incUtil,(AdministrationExample.Staff) notification.getNotifier(), (AdministrationExample.Shiftplan) notification.getNewValue(), "Staff_shiftPlan_Shiftplan"), getSelf());
			incUtil.newMessage();
			name2actor.get("DocToStaffRule_s2_shiftPlan_outgoing_TRG__FILTER_NAC_TRG_8_localSearch").tell(new ReferenceAdded<AdministrationExample.Staff, AdministrationExample.Shiftplan>(incUtil,(AdministrationExample.Staff) notification.getNotifier(), (AdministrationExample.Shiftplan) notification.getNewValue(), "Staff_shiftPlan_Shiftplan"), getSelf());
			incUtil.newMessage();
			name2actor.get("DocToStaffRule__CONSISTENCY_35_localSearch").tell(new ReferenceAdded<AdministrationExample.Staff, AdministrationExample.Shiftplan>(incUtil,(AdministrationExample.Staff) notification.getNotifier(), (AdministrationExample.Shiftplan) notification.getNewValue(), "Staff_shiftPlan_Shiftplan"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorShiftplanRule__BWD_52_localSearch").tell(new ReferenceAdded<AdministrationExample.Staff, AdministrationExample.Shiftplan>(incUtil,(AdministrationExample.Staff) notification.getNotifier(), (AdministrationExample.Shiftplan) notification.getNewValue(), "Staff_shiftPlan_Shiftplan"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorShiftplanRule__CONSISTENCY_61_localSearch").tell(new ReferenceAdded<AdministrationExample.Staff, AdministrationExample.Shiftplan>(incUtil,(AdministrationExample.Staff) notification.getNotifier(), (AdministrationExample.Shiftplan) notification.getNewValue(), "Staff_shiftPlan_Shiftplan"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseShiftplanRule__BWD_119_localSearch").tell(new ReferenceAdded<AdministrationExample.Staff, AdministrationExample.Shiftplan>(incUtil,(AdministrationExample.Staff) notification.getNotifier(), (AdministrationExample.Shiftplan) notification.getNewValue(), "Staff_shiftPlan_Shiftplan"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseShiftplanRule__CONSISTENCY_129_localSearch").tell(new ReferenceAdded<AdministrationExample.Staff, AdministrationExample.Shiftplan>(incUtil,(AdministrationExample.Staff) notification.getNotifier(), (AdministrationExample.Shiftplan) notification.getNewValue(), "Staff_shiftPlan_Shiftplan"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToStaffRule_s2_shiftPlan_outgoing_TRG__FILTER_NAC_TRG_159_localSearch").tell(new ReferenceAdded<AdministrationExample.Staff, AdministrationExample.Shiftplan>(incUtil,(AdministrationExample.Staff) notification.getNotifier(), (AdministrationExample.Shiftplan) notification.getNewValue(), "Staff_shiftPlan_Shiftplan"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToStaffRule_s2_shiftPlan_outgoing_TRG__FILTER_NAC_TRG_159_localSearch").tell(new ReferenceAdded<AdministrationExample.Staff, AdministrationExample.Shiftplan>(incUtil,(AdministrationExample.Staff) notification.getNotifier(), (AdministrationExample.Shiftplan) notification.getNewValue(), "Staff_shiftPlan_Shiftplan"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToStaffRule__CONSISTENCY_186_localSearch").tell(new ReferenceAdded<AdministrationExample.Staff, AdministrationExample.Shiftplan>(incUtil,(AdministrationExample.Staff) notification.getNotifier(), (AdministrationExample.Shiftplan) notification.getNewValue(), "Staff_shiftPlan_Shiftplan"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getDocToStaffRule__Marker_CREATE__TRG__sp(), notification -> {
			incUtil.newMessage();
			name2actor.get("DocToStaffRule__CONSISTENCY_35_localSearch").tell(new ReferenceAdded<Hospital2Administration.DocToStaffRule__Marker, AdministrationExample.Shiftplan>(incUtil,(Hospital2Administration.DocToStaffRule__Marker) notification.getNotifier(), (AdministrationExample.Shiftplan) notification.getNewValue(), "DocToStaffRule__Marker_CREATE__TRG__sp_Shiftplan"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getDoctorToPatient__Marker_CONTEXT__TRG__p2(), notification -> {
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__CONSISTENCY_85_localSearch").tell(new ReferenceAdded<Hospital2Administration.DoctorToPatient__Marker, AdministrationExample.Patient>(incUtil,(Hospital2Administration.DoctorToPatient__Marker) notification.getNotifier(), (AdministrationExample.Patient) notification.getNewValue(), "DoctorToPatient__Marker_CONTEXT__TRG__p2_Patient"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getPatientInRoom__Marker_CONTEXT__SRC__h(), notification -> {
			incUtil.newMessage();
			name2actor.get("PatientInRoom__CONSISTENCY_237_localSearch").tell(new ReferenceAdded<Hospital2Administration.PatientInRoom__Marker, HospitalExample.Hospital>(incUtil,(Hospital2Administration.PatientInRoom__Marker) notification.getNotifier(), (HospitalExample.Hospital) notification.getNewValue(), "PatientInRoom__Marker_CONTEXT__SRC__h_Hospital"), getSelf());
		});
		feature2addEdgeConsumer.put(AdministrationExample.AdministrationExamplePackage.eINSTANCE.getAdministration_Staff(), notification -> {
			incUtil.newMessage();
			name2actor.get("Administration_staff_0_reference").tell(new ReferenceAdded<AdministrationExample.Administration, AdministrationExample.Staff>(incUtil,(AdministrationExample.Administration) notification.getNotifier(), (AdministrationExample.Staff) notification.getNewValue(), "Administration_staff_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("Administration_staff_1_reference").tell(new ReferenceAdded<AdministrationExample.Administration, AdministrationExample.Staff>(incUtil,(AdministrationExample.Administration) notification.getNotifier(), (AdministrationExample.Staff) notification.getNewValue(), "Administration_staff_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("DocToStaffRule__CONSISTENCY_35_localSearch").tell(new ReferenceAdded<AdministrationExample.Administration, AdministrationExample.Staff>(incUtil,(AdministrationExample.Administration) notification.getNotifier(), (AdministrationExample.Staff) notification.getNewValue(), "Administration_staff_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToStaffRule__CONSISTENCY_186_localSearch").tell(new ReferenceAdded<AdministrationExample.Administration, AdministrationExample.Staff>(incUtil,(AdministrationExample.Administration) notification.getNotifier(), (AdministrationExample.Staff) notification.getNewValue(), "Administration_staff_Staff"), getSelf());
		});
		feature2addEdgeConsumer.put(AdministrationExample.AdministrationExamplePackage.eINSTANCE.getPatient_Treatment(), notification -> {
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__BWD_75_localSearch").tell(new ReferenceAdded<AdministrationExample.Patient, AdministrationExample.Treatment>(incUtil,(AdministrationExample.Patient) notification.getNotifier(), (AdministrationExample.Treatment) notification.getNewValue(), "Patient_treatment_Treatment"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__CONSISTENCY_85_localSearch").tell(new ReferenceAdded<AdministrationExample.Patient, AdministrationExample.Treatment>(incUtil,(AdministrationExample.Patient) notification.getNotifier(), (AdministrationExample.Treatment) notification.getNewValue(), "Patient_treatment_Treatment"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(HospitalExample.HospitalExamplePackage.eINSTANCE.getHospital_Staff(), notification -> {
			incUtil.newMessage();
			name2actor.get("DocToStaffRule__CONSISTENCY_35_localSearch").tell(new ReferenceAdded<HospitalExample.Hospital, HospitalExample.Staff>(incUtil,(HospitalExample.Hospital) notification.getNotifier(), (HospitalExample.Staff) notification.getNewValue(), "Hospital_staff_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("DocToStaffRule__FWD_46_localSearch").tell(new ReferenceAdded<HospitalExample.Hospital, HospitalExample.Staff>(incUtil,(HospitalExample.Hospital) notification.getNotifier(), (HospitalExample.Staff) notification.getNewValue(), "Hospital_staff_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToStaffRule__CONSISTENCY_186_localSearch").tell(new ReferenceAdded<HospitalExample.Hospital, HospitalExample.Staff>(incUtil,(HospitalExample.Hospital) notification.getNotifier(), (HospitalExample.Staff) notification.getNewValue(), "Hospital_staff_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToStaffRule__FWD_197_localSearch").tell(new ReferenceAdded<HospitalExample.Hospital, HospitalExample.Staff>(incUtil,(HospitalExample.Hospital) notification.getNotifier(), (HospitalExample.Staff) notification.getNewValue(), "Hospital_staff_Staff"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getPatientToPatient_Target(), notification -> {
			incUtil.newMessage();
			name2actor.get("DoctorShiftplanRule__BWD_52_localSearch").tell(new ReferenceAdded<Hospital2Administration.PatientToPatient, AdministrationExample.Patient>(incUtil,(Hospital2Administration.PatientToPatient) notification.getNotifier(), (AdministrationExample.Patient) notification.getNewValue(), "PatientToPatient_target_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorShiftplanRule__CONSISTENCY_61_localSearch").tell(new ReferenceAdded<Hospital2Administration.PatientToPatient, AdministrationExample.Patient>(incUtil,(Hospital2Administration.PatientToPatient) notification.getNotifier(), (AdministrationExample.Patient) notification.getNewValue(), "PatientToPatient_target_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__BWD_75_localSearch").tell(new ReferenceAdded<Hospital2Administration.PatientToPatient, AdministrationExample.Patient>(incUtil,(Hospital2Administration.PatientToPatient) notification.getNotifier(), (AdministrationExample.Patient) notification.getNewValue(), "PatientToPatient_target_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__CONSISTENCY_85_localSearch").tell(new ReferenceAdded<Hospital2Administration.PatientToPatient, AdministrationExample.Patient>(incUtil,(Hospital2Administration.PatientToPatient) notification.getNotifier(), (AdministrationExample.Patient) notification.getNewValue(), "PatientToPatient_target_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__FWD_96_localSearch").tell(new ReferenceAdded<Hospital2Administration.PatientToPatient, AdministrationExample.Patient>(incUtil,(Hospital2Administration.PatientToPatient) notification.getNotifier(), (AdministrationExample.Patient) notification.getNewValue(), "PatientToPatient_target_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseShiftplanRule__BWD_119_localSearch").tell(new ReferenceAdded<Hospital2Administration.PatientToPatient, AdministrationExample.Patient>(incUtil,(Hospital2Administration.PatientToPatient) notification.getNotifier(), (AdministrationExample.Patient) notification.getNewValue(), "PatientToPatient_target_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseShiftplanRule__CONSISTENCY_129_localSearch").tell(new ReferenceAdded<Hospital2Administration.PatientToPatient, AdministrationExample.Patient>(incUtil,(Hospital2Administration.PatientToPatient) notification.getNotifier(), (AdministrationExample.Patient) notification.getNewValue(), "PatientToPatient_target_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToRoomRule__CONSISTENCY_140_localSearch").tell(new ReferenceAdded<Hospital2Administration.PatientToPatient, AdministrationExample.Patient>(incUtil,(Hospital2Administration.PatientToPatient) notification.getNotifier(), (AdministrationExample.Patient) notification.getNewValue(), "PatientToPatient_target_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToRoomRule__FWD_150_localSearch").tell(new ReferenceAdded<Hospital2Administration.PatientToPatient, AdministrationExample.Patient>(incUtil,(Hospital2Administration.PatientToPatient) notification.getNotifier(), (AdministrationExample.Patient) notification.getNewValue(), "PatientToPatient_target_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInReception__CONSISTENCY_212_localSearch").tell(new ReferenceAdded<Hospital2Administration.PatientToPatient, AdministrationExample.Patient>(incUtil,(Hospital2Administration.PatientToPatient) notification.getNotifier(), (AdministrationExample.Patient) notification.getNewValue(), "PatientToPatient_target_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInRoom__CONSISTENCY_237_localSearch").tell(new ReferenceAdded<Hospital2Administration.PatientToPatient, AdministrationExample.Patient>(incUtil,(Hospital2Administration.PatientToPatient) notification.getNotifier(), (AdministrationExample.Patient) notification.getNewValue(), "PatientToPatient_target_Patient"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(HospitalExample.HospitalExamplePackage.eINSTANCE.getHospital_Department(), notification -> {
			incUtil.newMessage();
			name2actor.get("DepartmentRule__CONSISTENCY_1_localSearch").tell(new ReferenceAdded<HospitalExample.Hospital, HospitalExample.Department>(incUtil,(HospitalExample.Hospital) notification.getNotifier(), (HospitalExample.Department) notification.getNewValue(), "Hospital_department_Department"), getSelf());
			incUtil.newMessage();
			name2actor.get("DepartmentRule__FWD_5_localSearch").tell(new ReferenceAdded<HospitalExample.Hospital, HospitalExample.Department>(incUtil,(HospitalExample.Hospital) notification.getNotifier(), (HospitalExample.Department) notification.getNewValue(), "Hospital_department_Department"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInRoom__BWD_227_localSearch").tell(new ReferenceAdded<HospitalExample.Hospital, HospitalExample.Department>(incUtil,(HospitalExample.Hospital) notification.getNotifier(), (HospitalExample.Department) notification.getNewValue(), "Hospital_department_Department"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInRoom__CONSISTENCY_237_localSearch").tell(new ReferenceAdded<HospitalExample.Hospital, HospitalExample.Department>(incUtil,(HospitalExample.Hospital) notification.getNotifier(), (HospitalExample.Department) notification.getNewValue(), "Hospital_department_Department"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInRoom__FWD_247_localSearch").tell(new ReferenceAdded<HospitalExample.Hospital, HospitalExample.Department>(incUtil,(HospitalExample.Hospital) notification.getNotifier(), (HospitalExample.Department) notification.getNewValue(), "Hospital_department_Department"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getHospitaltoAdministrationRule__Marker_CREATE__SRC__r(), notification -> {
			incUtil.newMessage();
			name2actor.get("HospitaltoAdministrationRule__CONSISTENCY_110_localSearch").tell(new ReferenceAdded<Hospital2Administration.HospitaltoAdministrationRule__Marker, HospitalExample.Reception>(incUtil,(Hospital2Administration.HospitaltoAdministrationRule__Marker) notification.getNotifier(), (HospitalExample.Reception) notification.getNewValue(), "HospitaltoAdministrationRule__Marker_CREATE__SRC__r_Reception"), getSelf());
		});
		feature2addEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getDoctorToPatient__Marker_CREATE__TRG__t(), notification -> {
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__CONSISTENCY_85_localSearch").tell(new ReferenceAdded<Hospital2Administration.DoctorToPatient__Marker, AdministrationExample.Treatment>(incUtil,(Hospital2Administration.DoctorToPatient__Marker) notification.getNotifier(), (AdministrationExample.Treatment) notification.getNewValue(), "DoctorToPatient__Marker_CREATE__TRG__t_Treatment"), getSelf());
		});
		feature2addEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getPatientInRoom__Marker_CREATE__TRG__p2(), notification -> {
			incUtil.newMessage();
			name2actor.get("PatientInRoom__CONSISTENCY_237_localSearch").tell(new ReferenceAdded<Hospital2Administration.PatientInRoom__Marker, AdministrationExample.Patient>(incUtil,(Hospital2Administration.PatientInRoom__Marker) notification.getNotifier(), (AdministrationExample.Patient) notification.getNewValue(), "PatientInRoom__Marker_CREATE__TRG__p2_Patient"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(AdministrationExample.AdministrationExamplePackage.eINSTANCE.getShiftplan_Shifts(), notification -> {
			incUtil.newMessage();
			name2actor.get("Shiftplan_shifts_0_reference").tell(new ReferenceAdded<AdministrationExample.Shiftplan, AdministrationExample.Shift>(incUtil,(AdministrationExample.Shiftplan) notification.getNotifier(), (AdministrationExample.Shift) notification.getNewValue(), "Shiftplan_shifts_Shift"), getSelf());
			incUtil.newMessage();
			name2actor.get("DocToStaffRule_sp_shifts_outgoing_TRG__FILTER_NAC_TRG_12_localSearch").tell(new ReferenceAdded<AdministrationExample.Shiftplan, AdministrationExample.Shift>(incUtil,(AdministrationExample.Shiftplan) notification.getNotifier(), (AdministrationExample.Shift) notification.getNewValue(), "Shiftplan_shifts_Shift"), getSelf());
			incUtil.newMessage();
			name2actor.get("DocToStaffRule_sp_shifts_outgoing_TRG__FILTER_NAC_TRG_12_localSearch").tell(new ReferenceAdded<AdministrationExample.Shiftplan, AdministrationExample.Shift>(incUtil,(AdministrationExample.Shiftplan) notification.getNotifier(), (AdministrationExample.Shift) notification.getNewValue(), "Shiftplan_shifts_Shift"), getSelf());
			incUtil.newMessage();
			name2actor.get("DocToStaffRule__CONSISTENCY_35_localSearch").tell(new ReferenceAdded<AdministrationExample.Shiftplan, AdministrationExample.Shift>(incUtil,(AdministrationExample.Shiftplan) notification.getNotifier(), (AdministrationExample.Shift) notification.getNewValue(), "Shiftplan_shifts_Shift"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorShiftplanRule__BWD_52_localSearch").tell(new ReferenceAdded<AdministrationExample.Shiftplan, AdministrationExample.Shift>(incUtil,(AdministrationExample.Shiftplan) notification.getNotifier(), (AdministrationExample.Shift) notification.getNewValue(), "Shiftplan_shifts_Shift"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorShiftplanRule__CONSISTENCY_61_localSearch").tell(new ReferenceAdded<AdministrationExample.Shiftplan, AdministrationExample.Shift>(incUtil,(AdministrationExample.Shiftplan) notification.getNotifier(), (AdministrationExample.Shift) notification.getNewValue(), "Shiftplan_shifts_Shift"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseShiftplanRule__BWD_119_localSearch").tell(new ReferenceAdded<AdministrationExample.Shiftplan, AdministrationExample.Shift>(incUtil,(AdministrationExample.Shiftplan) notification.getNotifier(), (AdministrationExample.Shift) notification.getNewValue(), "Shiftplan_shifts_Shift"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseShiftplanRule__CONSISTENCY_129_localSearch").tell(new ReferenceAdded<AdministrationExample.Shiftplan, AdministrationExample.Shift>(incUtil,(AdministrationExample.Shiftplan) notification.getNotifier(), (AdministrationExample.Shift) notification.getNewValue(), "Shiftplan_shifts_Shift"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToStaffRule_sp_shifts_outgoing_TRG__FILTER_NAC_TRG_163_localSearch").tell(new ReferenceAdded<AdministrationExample.Shiftplan, AdministrationExample.Shift>(incUtil,(AdministrationExample.Shiftplan) notification.getNotifier(), (AdministrationExample.Shift) notification.getNewValue(), "Shiftplan_shifts_Shift"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToStaffRule_sp_shifts_outgoing_TRG__FILTER_NAC_TRG_163_localSearch").tell(new ReferenceAdded<AdministrationExample.Shiftplan, AdministrationExample.Shift>(incUtil,(AdministrationExample.Shiftplan) notification.getNotifier(), (AdministrationExample.Shift) notification.getNewValue(), "Shiftplan_shifts_Shift"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToStaffRule__CONSISTENCY_186_localSearch").tell(new ReferenceAdded<AdministrationExample.Shiftplan, AdministrationExample.Shift>(incUtil,(AdministrationExample.Shiftplan) notification.getNotifier(), (AdministrationExample.Shift) notification.getNewValue(), "Shiftplan_shifts_Shift"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getDoctorToPatient__Marker_CONTEXT__SRC__p1(), notification -> {
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__CONSISTENCY_85_localSearch").tell(new ReferenceAdded<Hospital2Administration.DoctorToPatient__Marker, HospitalExample.Patient>(incUtil,(Hospital2Administration.DoctorToPatient__Marker) notification.getNotifier(), (HospitalExample.Patient) notification.getNewValue(), "DoctorToPatient__Marker_CONTEXT__SRC__p1_Patient"), getSelf());
		});
		feature2addEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getHospitaltoAdministrationRule__Marker_CREATE__SRC__h(), notification -> {
			incUtil.newMessage();
			name2actor.get("HospitaltoAdministrationRule__CONSISTENCY_110_localSearch").tell(new ReferenceAdded<Hospital2Administration.HospitaltoAdministrationRule__Marker, HospitalExample.Hospital>(incUtil,(Hospital2Administration.HospitaltoAdministrationRule__Marker) notification.getNotifier(), (HospitalExample.Hospital) notification.getNewValue(), "HospitaltoAdministrationRule__Marker_CREATE__SRC__h_Hospital"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getDocToStaffRule__Marker_CREATE__SRC__s1(), notification -> {
			incUtil.newMessage();
			name2actor.get("DocToStaffRule__CONSISTENCY_35_localSearch").tell(new ReferenceAdded<Hospital2Administration.DocToStaffRule__Marker, HospitalExample.Doctor>(incUtil,(Hospital2Administration.DocToStaffRule__Marker) notification.getNotifier(), (HospitalExample.Doctor) notification.getNewValue(), "DocToStaffRule__Marker_CREATE__SRC__s1_Doctor"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(AdministrationExample.AdministrationExamplePackage.eINSTANCE.getStaff_Treatment(), notification -> {
			incUtil.newMessage();
			name2actor.get("DoctorToPatient_t_treatment_incoming_TRG__FILTER_NAC_TRG_71_localSearch").tell(new ReferenceAdded<AdministrationExample.Staff, AdministrationExample.Treatment>(incUtil,(AdministrationExample.Staff) notification.getNotifier(), (AdministrationExample.Treatment) notification.getNewValue(), "Staff_treatment_Treatment"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient_t_treatment_incoming_TRG__FILTER_NAC_TRG_71_localSearch").tell(new ReferenceAdded<AdministrationExample.Staff, AdministrationExample.Treatment>(incUtil,(AdministrationExample.Staff) notification.getNotifier(), (AdministrationExample.Treatment) notification.getNewValue(), "Staff_treatment_Treatment"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__BWD_75_localSearch").tell(new ReferenceAdded<AdministrationExample.Staff, AdministrationExample.Treatment>(incUtil,(AdministrationExample.Staff) notification.getNotifier(), (AdministrationExample.Treatment) notification.getNewValue(), "Staff_treatment_Treatment"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__CONSISTENCY_85_localSearch").tell(new ReferenceAdded<AdministrationExample.Staff, AdministrationExample.Treatment>(incUtil,(AdministrationExample.Staff) notification.getNotifier(), (AdministrationExample.Treatment) notification.getNewValue(), "Staff_treatment_Treatment"), getSelf());
		});
		feature2addEdgeConsumer.put(HospitalExample.HospitalExamplePackage.eINSTANCE.getDepartment_Rooms(), notification -> {
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__BWD_75_localSearch").tell(new ReferenceAdded<HospitalExample.Department, HospitalExample.Room>(incUtil,(HospitalExample.Department) notification.getNotifier(), (HospitalExample.Room) notification.getNewValue(), "Department_rooms_Room"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__CONSISTENCY_85_localSearch").tell(new ReferenceAdded<HospitalExample.Department, HospitalExample.Room>(incUtil,(HospitalExample.Department) notification.getNotifier(), (HospitalExample.Room) notification.getNewValue(), "Department_rooms_Room"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__FWD_96_localSearch").tell(new ReferenceAdded<HospitalExample.Department, HospitalExample.Room>(incUtil,(HospitalExample.Department) notification.getNotifier(), (HospitalExample.Room) notification.getNewValue(), "Department_rooms_Room"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToRoomRule__CONSISTENCY_140_localSearch").tell(new ReferenceAdded<HospitalExample.Department, HospitalExample.Room>(incUtil,(HospitalExample.Department) notification.getNotifier(), (HospitalExample.Room) notification.getNewValue(), "Department_rooms_Room"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToRoomRule__FWD_150_localSearch").tell(new ReferenceAdded<HospitalExample.Department, HospitalExample.Room>(incUtil,(HospitalExample.Department) notification.getNotifier(), (HospitalExample.Room) notification.getNewValue(), "Department_rooms_Room"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInRoom__BWD_227_localSearch").tell(new ReferenceAdded<HospitalExample.Department, HospitalExample.Room>(incUtil,(HospitalExample.Department) notification.getNotifier(), (HospitalExample.Room) notification.getNewValue(), "Department_rooms_Room"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInRoom__CONSISTENCY_237_localSearch").tell(new ReferenceAdded<HospitalExample.Department, HospitalExample.Room>(incUtil,(HospitalExample.Department) notification.getNotifier(), (HospitalExample.Room) notification.getNewValue(), "Department_rooms_Room"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInRoom__FWD_247_localSearch").tell(new ReferenceAdded<HospitalExample.Department, HospitalExample.Room>(incUtil,(HospitalExample.Department) notification.getNotifier(), (HospitalExample.Room) notification.getNewValue(), "Department_rooms_Room"), getSelf());
			incUtil.newMessage();
			name2actor.get("RoomRule__CONSISTENCY_254_localSearch").tell(new ReferenceAdded<HospitalExample.Department, HospitalExample.Room>(incUtil,(HospitalExample.Department) notification.getNotifier(), (HospitalExample.Room) notification.getNewValue(), "Department_rooms_Room"), getSelf());
			incUtil.newMessage();
			name2actor.get("RoomRule__FWD_258_localSearch").tell(new ReferenceAdded<HospitalExample.Department, HospitalExample.Room>(incUtil,(HospitalExample.Department) notification.getNotifier(), (HospitalExample.Room) notification.getNewValue(), "Department_rooms_Room"), getSelf());
		});
		feature2addEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getDocToStaffRule__Marker_CREATE__TRG__sh(), notification -> {
			incUtil.newMessage();
			name2actor.get("DocToStaffRule__CONSISTENCY_35_localSearch").tell(new ReferenceAdded<Hospital2Administration.DocToStaffRule__Marker, AdministrationExample.Shift>(incUtil,(Hospital2Administration.DocToStaffRule__Marker) notification.getNotifier(), (AdministrationExample.Shift) notification.getNewValue(), "DocToStaffRule__Marker_CREATE__TRG__sh_Shift"), getSelf());
		});
		feature2addEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getPatientInReception__Marker_CONTEXT__SRC__h(), notification -> {
			incUtil.newMessage();
			name2actor.get("PatientInReception__CONSISTENCY_212_localSearch").tell(new ReferenceAdded<Hospital2Administration.PatientInReception__Marker, HospitalExample.Hospital>(incUtil,(Hospital2Administration.PatientInReception__Marker) notification.getNotifier(), (HospitalExample.Hospital) notification.getNewValue(), "PatientInReception__Marker_CONTEXT__SRC__h_Hospital"), getSelf());
		});
		feature2addEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getHospitalToAdministration_Source(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("DocToStaffRule__CONSISTENCY_35_localSearch").tell(new ReferenceAdded<Hospital2Administration.HospitalToAdministration, HospitalExample.Hospital>(incUtil,(Hospital2Administration.HospitalToAdministration) notification.getNotifier(), (HospitalExample.Hospital) notification.getNewValue(), "HospitalToAdministration_source_Hospital"), getSelf());
			incUtil.newMessage();
			name2actor.get("DocToStaffRule__FWD_46_localSearch").tell(new ReferenceAdded<Hospital2Administration.HospitalToAdministration, HospitalExample.Hospital>(incUtil,(Hospital2Administration.HospitalToAdministration) notification.getNotifier(), (HospitalExample.Hospital) notification.getNewValue(), "HospitalToAdministration_source_Hospital"), getSelf());
			incUtil.newMessage();
			...
			name2actor.get("NurseToStaffRule__CONSISTENCY_186_localSearch").tell(new ReferenceAdded<Hospital2Administration.HospitalToAdministration, HospitalExample.Hospital>(incUtil,(Hospital2Administration.HospitalToAdministration) notification.getNotifier(), (HospitalExample.Hospital) notification.getNewValue(), "HospitalToAdministration_source_Hospital"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToStaffRule__FWD_197_localSearch").tell(new ReferenceAdded<Hospital2Administration.HospitalToAdministration, HospitalExample.Hospital>(incUtil,(Hospital2Administration.HospitalToAdministration) notification.getNotifier(), (HospitalExample.Hospital) notification.getNewValue(), "HospitalToAdministration_source_Hospital"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInReception__BWD_203_localSearch").tell(new ReferenceAdded<Hospital2Administration.HospitalToAdministration, HospitalExample.Hospital>(incUtil,(Hospital2Administration.HospitalToAdministration) notification.getNotifier(), (HospitalExample.Hospital) notification.getNewValue(), "HospitalToAdministration_source_Hospital"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInReception__CONSISTENCY_212_localSearch").tell(new ReferenceAdded<Hospital2Administration.HospitalToAdministration, HospitalExample.Hospital>(incUtil,(Hospital2Administration.HospitalToAdministration) notification.getNotifier(), (HospitalExample.Hospital) notification.getNewValue(), "HospitalToAdministration_source_Hospital"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInReception__FWD_221_localSearch").tell(new ReferenceAdded<Hospital2Administration.HospitalToAdministration, HospitalExample.Hospital>(incUtil,(Hospital2Administration.HospitalToAdministration) notification.getNotifier(), (HospitalExample.Hospital) notification.getNewValue(), "HospitalToAdministration_source_Hospital"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInRoom__BWD_227_localSearch").tell(new ReferenceAdded<Hospital2Administration.HospitalToAdministration, HospitalExample.Hospital>(incUtil,(Hospital2Administration.HospitalToAdministration) notification.getNotifier(), (HospitalExample.Hospital) notification.getNewValue(), "HospitalToAdministration_source_Hospital"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInRoom__CONSISTENCY_237_localSearch").tell(new ReferenceAdded<Hospital2Administration.HospitalToAdministration, HospitalExample.Hospital>(incUtil,(Hospital2Administration.HospitalToAdministration) notification.getNotifier(), (HospitalExample.Hospital) notification.getNewValue(), "HospitalToAdministration_source_Hospital"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInRoom__FWD_247_localSearch").tell(new ReferenceAdded<Hospital2Administration.HospitalToAdministration, HospitalExample.Hospital>(incUtil,(Hospital2Administration.HospitalToAdministration) notification.getNotifier(), (HospitalExample.Hospital) notification.getNewValue(), "HospitalToAdministration_source_Hospital"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(AdministrationExample.AdministrationExamplePackage.eINSTANCE.getAdministration_Patient(), notification -> {
			incUtil.newMessage();
			name2actor.get("PatientInReception__BWD_203_localSearch").tell(new ReferenceAdded<AdministrationExample.Administration, AdministrationExample.Patient>(incUtil,(AdministrationExample.Administration) notification.getNotifier(), (AdministrationExample.Patient) notification.getNewValue(), "Administration_patient_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInReception__CONSISTENCY_212_localSearch").tell(new ReferenceAdded<AdministrationExample.Administration, AdministrationExample.Patient>(incUtil,(AdministrationExample.Administration) notification.getNotifier(), (AdministrationExample.Patient) notification.getNewValue(), "Administration_patient_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInRoom__BWD_227_localSearch").tell(new ReferenceAdded<AdministrationExample.Administration, AdministrationExample.Patient>(incUtil,(AdministrationExample.Administration) notification.getNotifier(), (AdministrationExample.Patient) notification.getNewValue(), "Administration_patient_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInRoom__CONSISTENCY_237_localSearch").tell(new ReferenceAdded<AdministrationExample.Administration, AdministrationExample.Patient>(incUtil,(AdministrationExample.Administration) notification.getNotifier(), (AdministrationExample.Patient) notification.getNewValue(), "Administration_patient_Patient"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getPatientInReception__Marker_CONTEXT__CORR__htov(), notification -> {
			incUtil.newMessage();
			name2actor.get("PatientInReception__CONSISTENCY_212_localSearch").tell(new ReferenceAdded<Hospital2Administration.PatientInReception__Marker, Hospital2Administration.HospitalToAdministration>(incUtil,(Hospital2Administration.PatientInReception__Marker) notification.getNotifier(), (Hospital2Administration.HospitalToAdministration) notification.getNewValue(), "PatientInReception__Marker_CONTEXT__CORR__htov_HospitalToAdministration"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(AdministrationExample.AdministrationExamplePackage.eINSTANCE.getShiftplan_Covers(), notification -> {
			incUtil.newMessage();
			name2actor.get("DoctorShiftplanRule__BWD_52_localSearch").tell(new ReferenceAdded<AdministrationExample.Shiftplan, AdministrationExample.Patient>(incUtil,(AdministrationExample.Shiftplan) notification.getNotifier(), (AdministrationExample.Patient) notification.getNewValue(), "Shiftplan_covers_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorShiftplanRule__CONSISTENCY_61_localSearch").tell(new ReferenceAdded<AdministrationExample.Shiftplan, AdministrationExample.Patient>(incUtil,(AdministrationExample.Shiftplan) notification.getNotifier(), (AdministrationExample.Patient) notification.getNewValue(), "Shiftplan_covers_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseShiftplanRule__BWD_119_localSearch").tell(new ReferenceAdded<AdministrationExample.Shiftplan, AdministrationExample.Patient>(incUtil,(AdministrationExample.Shiftplan) notification.getNotifier(), (AdministrationExample.Patient) notification.getNewValue(), "Shiftplan_covers_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseShiftplanRule__CONSISTENCY_129_localSearch").tell(new ReferenceAdded<AdministrationExample.Shiftplan, AdministrationExample.Patient>(incUtil,(AdministrationExample.Shiftplan) notification.getNotifier(), (AdministrationExample.Patient) notification.getNewValue(), "Shiftplan_covers_Patient"), getSelf());
		});
		feature2addEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getDocToStaffRule__Marker_CONTEXT__SRC__h(), notification -> {
			incUtil.newMessage();
			name2actor.get("DocToStaffRule__CONSISTENCY_35_localSearch").tell(new ReferenceAdded<Hospital2Administration.DocToStaffRule__Marker, HospitalExample.Hospital>(incUtil,(Hospital2Administration.DocToStaffRule__Marker) notification.getNotifier(), (HospitalExample.Hospital) notification.getNewValue(), "DocToStaffRule__Marker_CONTEXT__SRC__h_Hospital"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getPatientInRoom__Marker_CONTEXT__CORR__htov(), notification -> {
			incUtil.newMessage();
			name2actor.get("PatientInRoom__CONSISTENCY_237_localSearch").tell(new ReferenceAdded<Hospital2Administration.PatientInRoom__Marker, Hospital2Administration.HospitalToAdministration>(incUtil,(Hospital2Administration.PatientInRoom__Marker) notification.getNotifier(), (Hospital2Administration.HospitalToAdministration) notification.getNewValue(), "PatientInRoom__Marker_CONTEXT__CORR__htov_HospitalToAdministration"), getSelf());
		});
		feature2addEdgeConsumer.put(HospitalExample.HospitalExamplePackage.eINSTANCE.getNurse_Responsible(), notification -> {
			incUtil.newMessage();
			name2actor.get("NurseShiftplanRule__BWD_119_localSearch").tell(new ReferenceAdded<HospitalExample.Nurse, HospitalExample.Room>(incUtil,(HospitalExample.Nurse) notification.getNotifier(), (HospitalExample.Room) notification.getNewValue(), "Nurse_responsible_Room"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseShiftplanRule__CONSISTENCY_129_localSearch").tell(new ReferenceAdded<HospitalExample.Nurse, HospitalExample.Room>(incUtil,(HospitalExample.Nurse) notification.getNotifier(), (HospitalExample.Room) notification.getNewValue(), "Nurse_responsible_Room"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToRoomRule__CONSISTENCY_140_localSearch").tell(new ReferenceAdded<HospitalExample.Nurse, HospitalExample.Room>(incUtil,(HospitalExample.Nurse) notification.getNotifier(), (HospitalExample.Room) notification.getNewValue(), "Nurse_responsible_Room"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToRoomRule__FWD_150_localSearch").tell(new ReferenceAdded<HospitalExample.Nurse, HospitalExample.Room>(incUtil,(HospitalExample.Nurse) notification.getNotifier(), (HospitalExample.Room) notification.getNewValue(), "Nurse_responsible_Room"), getSelf());
		});
		feature2addEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getPatientInReception__Marker_CREATE__CORR__pTop(), notification -> {
			incUtil.newMessage();
			name2actor.get("PatientInReception__CONSISTENCY_212_localSearch").tell(new ReferenceAdded<Hospital2Administration.PatientInReception__Marker, Hospital2Administration.PatientToPatient>(incUtil,(Hospital2Administration.PatientInReception__Marker) notification.getNotifier(), (Hospital2Administration.PatientToPatient) notification.getNewValue(), "PatientInReception__Marker_CREATE__CORR__pTop_PatientToPatient"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getDoctorToPatient__Marker_CONTEXT__SRC__d(), notification -> {
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__CONSISTENCY_85_localSearch").tell(new ReferenceAdded<Hospital2Administration.DoctorToPatient__Marker, HospitalExample.Doctor>(incUtil,(Hospital2Administration.DoctorToPatient__Marker) notification.getNotifier(), (HospitalExample.Doctor) notification.getNewValue(), "DoctorToPatient__Marker_CONTEXT__SRC__d_Doctor"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getPatientInRoom__Marker_CREATE__CORR__pTop(), notification -> {
			incUtil.newMessage();
			name2actor.get("PatientInRoom__CONSISTENCY_237_localSearch").tell(new ReferenceAdded<Hospital2Administration.PatientInRoom__Marker, Hospital2Administration.PatientToPatient>(incUtil,(Hospital2Administration.PatientInRoom__Marker) notification.getNotifier(), (Hospital2Administration.PatientToPatient) notification.getNewValue(), "PatientInRoom__Marker_CREATE__CORR__pTop_PatientToPatient"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(HospitalExample.HospitalExamplePackage.eINSTANCE.getReception_Waits(), notification -> {
			incUtil.newMessage();
			name2actor.get("PatientInReception__CONSISTENCY_212_localSearch").tell(new ReferenceAdded<HospitalExample.Reception, HospitalExample.Patient>(incUtil,(HospitalExample.Reception) notification.getNotifier(), (HospitalExample.Patient) notification.getNewValue(), "Reception_waits_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInReception__FWD_221_localSearch").tell(new ReferenceAdded<HospitalExample.Reception, HospitalExample.Patient>(incUtil,(HospitalExample.Reception) notification.getNotifier(), (HospitalExample.Patient) notification.getNewValue(), "Reception_waits_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInRoom_p1_waits_incoming_SRC__FILTER_NAC_SRC_234_localSearch").tell(new ReferenceAdded<HospitalExample.Reception, HospitalExample.Patient>(incUtil,(HospitalExample.Reception) notification.getNotifier(), (HospitalExample.Patient) notification.getNewValue(), "Reception_waits_Patient"), getSelf());
		});
		feature2addEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getPatientInRoom__Marker_CREATE__SRC__p1(), notification -> {
			incUtil.newMessage();
			name2actor.get("PatientInRoom__CONSISTENCY_237_localSearch").tell(new ReferenceAdded<Hospital2Administration.PatientInRoom__Marker, HospitalExample.Patient>(incUtil,(Hospital2Administration.PatientInRoom__Marker) notification.getNotifier(), (HospitalExample.Patient) notification.getNewValue(), "PatientInRoom__Marker_CREATE__SRC__p1_Patient"), getSelf());
		});
		feature2addEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getPatientInReception__Marker_CREATE__TRG__p2(), notification -> {
			incUtil.newMessage();
			name2actor.get("PatientInReception__CONSISTENCY_212_localSearch").tell(new ReferenceAdded<Hospital2Administration.PatientInReception__Marker, AdministrationExample.Patient>(incUtil,(Hospital2Administration.PatientInReception__Marker) notification.getNotifier(), (AdministrationExample.Patient) notification.getNewValue(), "PatientInReception__Marker_CREATE__TRG__p2_Patient"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getDoctorToPatient__Marker_CONTEXT__CORR__pToP(), notification -> {
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__CONSISTENCY_85_localSearch").tell(new ReferenceAdded<Hospital2Administration.DoctorToPatient__Marker, Hospital2Administration.PatientToPatient>(incUtil,(Hospital2Administration.DoctorToPatient__Marker) notification.getNotifier(), (Hospital2Administration.PatientToPatient) notification.getNewValue(), "DoctorToPatient__Marker_CONTEXT__CORR__pToP_PatientToPatient"), getSelf());
		});
		feature2addEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getDoctorToPatient__Marker_CONTEXT__TRG__s(), notification -> {
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__CONSISTENCY_85_localSearch").tell(new ReferenceAdded<Hospital2Administration.DoctorToPatient__Marker, AdministrationExample.Staff>(incUtil,(Hospital2Administration.DoctorToPatient__Marker) notification.getNotifier(), (AdministrationExample.Staff) notification.getNewValue(), "DoctorToPatient__Marker_CONTEXT__TRG__s_Staff"), getSelf());
		});
		feature2addEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getHospitalToAdministration_Target(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("DocToStaffRule__CONSISTENCY_35_localSearch").tell(new ReferenceAdded<Hospital2Administration.HospitalToAdministration, AdministrationExample.Administration>(incUtil,(Hospital2Administration.HospitalToAdministration) notification.getNotifier(), (AdministrationExample.Administration) notification.getNewValue(), "HospitalToAdministration_target_Administration"), getSelf());
			incUtil.newMessage();
			name2actor.get("DocToStaffRule__FWD_46_localSearch").tell(new ReferenceAdded<Hospital2Administration.HospitalToAdministration, AdministrationExample.Administration>(incUtil,(Hospital2Administration.HospitalToAdministration) notification.getNotifier(), (AdministrationExample.Administration) notification.getNewValue(), "HospitalToAdministration_target_Administration"), getSelf());
			incUtil.newMessage();
			name2actor.get("HospitaltoAdministrationRule__CONSISTENCY_110_localSearch").tell(new ReferenceAdded<Hospital2Administration.HospitalToAdministration, AdministrationExample.Administration>(incUtil,(Hospital2Administration.HospitalToAdministration) notification.getNotifier(), (AdministrationExample.Administration) notification.getNewValue(), "HospitalToAdministration_target_Administration"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToStaffRule__CONSISTENCY_186_localSearch").tell(new ReferenceAdded<Hospital2Administration.HospitalToAdministration, AdministrationExample.Administration>(incUtil,(Hospital2Administration.HospitalToAdministration) notification.getNotifier(), (AdministrationExample.Administration) notification.getNewValue(), "HospitalToAdministration_target_Administration"), getSelf());
			...
			name2actor.get("NurseToStaffRule__FWD_197_localSearch").tell(new ReferenceAdded<Hospital2Administration.HospitalToAdministration, AdministrationExample.Administration>(incUtil,(Hospital2Administration.HospitalToAdministration) notification.getNotifier(), (AdministrationExample.Administration) notification.getNewValue(), "HospitalToAdministration_target_Administration"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInReception__BWD_203_localSearch").tell(new ReferenceAdded<Hospital2Administration.HospitalToAdministration, AdministrationExample.Administration>(incUtil,(Hospital2Administration.HospitalToAdministration) notification.getNotifier(), (AdministrationExample.Administration) notification.getNewValue(), "HospitalToAdministration_target_Administration"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInReception__CONSISTENCY_212_localSearch").tell(new ReferenceAdded<Hospital2Administration.HospitalToAdministration, AdministrationExample.Administration>(incUtil,(Hospital2Administration.HospitalToAdministration) notification.getNotifier(), (AdministrationExample.Administration) notification.getNewValue(), "HospitalToAdministration_target_Administration"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInReception__FWD_221_localSearch").tell(new ReferenceAdded<Hospital2Administration.HospitalToAdministration, AdministrationExample.Administration>(incUtil,(Hospital2Administration.HospitalToAdministration) notification.getNotifier(), (AdministrationExample.Administration) notification.getNewValue(), "HospitalToAdministration_target_Administration"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInRoom__BWD_227_localSearch").tell(new ReferenceAdded<Hospital2Administration.HospitalToAdministration, AdministrationExample.Administration>(incUtil,(Hospital2Administration.HospitalToAdministration) notification.getNotifier(), (AdministrationExample.Administration) notification.getNewValue(), "HospitalToAdministration_target_Administration"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInRoom__CONSISTENCY_237_localSearch").tell(new ReferenceAdded<Hospital2Administration.HospitalToAdministration, AdministrationExample.Administration>(incUtil,(Hospital2Administration.HospitalToAdministration) notification.getNotifier(), (AdministrationExample.Administration) notification.getNewValue(), "HospitalToAdministration_target_Administration"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInRoom__FWD_247_localSearch").tell(new ReferenceAdded<Hospital2Administration.HospitalToAdministration, AdministrationExample.Administration>(incUtil,(Hospital2Administration.HospitalToAdministration) notification.getNotifier(), (AdministrationExample.Administration) notification.getNewValue(), "HospitalToAdministration_target_Administration"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getPatientInReception__Marker_CREATE__SRC__p1(), notification -> {
			incUtil.newMessage();
			name2actor.get("PatientInReception__CONSISTENCY_212_localSearch").tell(new ReferenceAdded<Hospital2Administration.PatientInReception__Marker, HospitalExample.Patient>(incUtil,(Hospital2Administration.PatientInReception__Marker) notification.getNotifier(), (HospitalExample.Patient) notification.getNewValue(), "PatientInReception__Marker_CREATE__SRC__p1_Patient"), getSelf());
		});
		feature2addEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getStaffToStaff_Target(), notification -> {
			incUtil.newMessage();
			name2actor.get("DocToStaffRule__CONSISTENCY_35_localSearch").tell(new ReferenceAdded<Hospital2Administration.StaffToStaff, AdministrationExample.Staff>(incUtil,(Hospital2Administration.StaffToStaff) notification.getNotifier(), (AdministrationExample.Staff) notification.getNewValue(), "StaffToStaff_target_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorShiftplanRule__BWD_52_localSearch").tell(new ReferenceAdded<Hospital2Administration.StaffToStaff, AdministrationExample.Staff>(incUtil,(Hospital2Administration.StaffToStaff) notification.getNotifier(), (AdministrationExample.Staff) notification.getNewValue(), "StaffToStaff_target_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorShiftplanRule__CONSISTENCY_61_localSearch").tell(new ReferenceAdded<Hospital2Administration.StaffToStaff, AdministrationExample.Staff>(incUtil,(Hospital2Administration.StaffToStaff) notification.getNotifier(), (AdministrationExample.Staff) notification.getNewValue(), "StaffToStaff_target_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__BWD_75_localSearch").tell(new ReferenceAdded<Hospital2Administration.StaffToStaff, AdministrationExample.Staff>(incUtil,(Hospital2Administration.StaffToStaff) notification.getNotifier(), (AdministrationExample.Staff) notification.getNewValue(), "StaffToStaff_target_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__CONSISTENCY_85_localSearch").tell(new ReferenceAdded<Hospital2Administration.StaffToStaff, AdministrationExample.Staff>(incUtil,(Hospital2Administration.StaffToStaff) notification.getNotifier(), (AdministrationExample.Staff) notification.getNewValue(), "StaffToStaff_target_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__FWD_96_localSearch").tell(new ReferenceAdded<Hospital2Administration.StaffToStaff, AdministrationExample.Staff>(incUtil,(Hospital2Administration.StaffToStaff) notification.getNotifier(), (AdministrationExample.Staff) notification.getNewValue(), "StaffToStaff_target_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseShiftplanRule__BWD_119_localSearch").tell(new ReferenceAdded<Hospital2Administration.StaffToStaff, AdministrationExample.Staff>(incUtil,(Hospital2Administration.StaffToStaff) notification.getNotifier(), (AdministrationExample.Staff) notification.getNewValue(), "StaffToStaff_target_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseShiftplanRule__CONSISTENCY_129_localSearch").tell(new ReferenceAdded<Hospital2Administration.StaffToStaff, AdministrationExample.Staff>(incUtil,(Hospital2Administration.StaffToStaff) notification.getNotifier(), (AdministrationExample.Staff) notification.getNewValue(), "StaffToStaff_target_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToRoomRule__CONSISTENCY_140_localSearch").tell(new ReferenceAdded<Hospital2Administration.StaffToStaff, AdministrationExample.Staff>(incUtil,(Hospital2Administration.StaffToStaff) notification.getNotifier(), (AdministrationExample.Staff) notification.getNewValue(), "StaffToStaff_target_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToRoomRule__FWD_150_localSearch").tell(new ReferenceAdded<Hospital2Administration.StaffToStaff, AdministrationExample.Staff>(incUtil,(Hospital2Administration.StaffToStaff) notification.getNotifier(), (AdministrationExample.Staff) notification.getNewValue(), "StaffToStaff_target_Staff"), getSelf());
			incUtil.newMessage();
		...
		feature2addEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getDoctorToPatient__Marker_CONTEXT__SRC__ro(), notification -> {
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__CONSISTENCY_85_localSearch").tell(new ReferenceAdded<Hospital2Administration.DoctorToPatient__Marker, HospitalExample.Room>(incUtil,(Hospital2Administration.DoctorToPatient__Marker) notification.getNotifier(), (HospitalExample.Room) notification.getNewValue(), "DoctorToPatient__Marker_CONTEXT__SRC__ro_Room"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getPatientInRoom__Marker_CONTEXT__SRC__ro(), notification -> {
			incUtil.newMessage();
			name2actor.get("PatientInRoom__CONSISTENCY_237_localSearch").tell(new ReferenceAdded<Hospital2Administration.PatientInRoom__Marker, HospitalExample.Room>(incUtil,(Hospital2Administration.PatientInRoom__Marker) notification.getNotifier(), (HospitalExample.Room) notification.getNewValue(), "PatientInRoom__Marker_CONTEXT__SRC__ro_Room"), getSelf());
		});
		feature2addEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getPatientInReception__Marker_CONTEXT__SRC__r(), notification -> {
			incUtil.newMessage();
			name2actor.get("PatientInReception__CONSISTENCY_212_localSearch").tell(new ReferenceAdded<Hospital2Administration.PatientInReception__Marker, HospitalExample.Reception>(incUtil,(Hospital2Administration.PatientInReception__Marker) notification.getNotifier(), (HospitalExample.Reception) notification.getNewValue(), "PatientInReception__Marker_CONTEXT__SRC__r_Reception"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getHospitaltoAdministrationRule__Marker_CREATE__CORR__htov(), notification -> {
			incUtil.newMessage();
			name2actor.get("HospitaltoAdministrationRule__CONSISTENCY_110_localSearch").tell(new ReferenceAdded<Hospital2Administration.HospitaltoAdministrationRule__Marker, Hospital2Administration.HospitalToAdministration>(incUtil,(Hospital2Administration.HospitaltoAdministrationRule__Marker) notification.getNotifier(), (Hospital2Administration.HospitalToAdministration) notification.getNewValue(), "HospitaltoAdministrationRule__Marker_CREATE__CORR__htov_HospitalToAdministration"), getSelf());
		});
		feature2addEdgeConsumer.put(HospitalExample.HospitalExamplePackage.eINSTANCE.getHospital_Reception(), notification -> {
			incUtil.newMessage();
			name2actor.get("HospitaltoAdministrationRule_h_reception_outgoing_SRC__FILTER_NAC_SRC_106_localSearch").tell(new ReferenceAdded<HospitalExample.Hospital, HospitalExample.Reception>(incUtil,(HospitalExample.Hospital) notification.getNotifier(), (HospitalExample.Reception) notification.getNewValue(), "Hospital_reception_Reception"), getSelf());
			incUtil.newMessage();
			name2actor.get("HospitaltoAdministrationRule_h_reception_outgoing_SRC__FILTER_NAC_SRC_106_localSearch").tell(new ReferenceAdded<HospitalExample.Hospital, HospitalExample.Reception>(incUtil,(HospitalExample.Hospital) notification.getNotifier(), (HospitalExample.Reception) notification.getNewValue(), "Hospital_reception_Reception"), getSelf());
			incUtil.newMessage();
			name2actor.get("HospitaltoAdministrationRule__CONSISTENCY_110_localSearch").tell(new ReferenceAdded<HospitalExample.Hospital, HospitalExample.Reception>(incUtil,(HospitalExample.Hospital) notification.getNotifier(), (HospitalExample.Reception) notification.getNewValue(), "Hospital_reception_Reception"), getSelf());
			incUtil.newMessage();
			name2actor.get("HospitaltoAdministrationRule__FWD_116_localSearch").tell(new ReferenceAdded<HospitalExample.Hospital, HospitalExample.Reception>(incUtil,(HospitalExample.Hospital) notification.getNotifier(), (HospitalExample.Reception) notification.getNewValue(), "Hospital_reception_Reception"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInReception__BWD_203_localSearch").tell(new ReferenceAdded<HospitalExample.Hospital, HospitalExample.Reception>(incUtil,(HospitalExample.Hospital) notification.getNotifier(), (HospitalExample.Reception) notification.getNewValue(), "Hospital_reception_Reception"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInReception__CONSISTENCY_212_localSearch").tell(new ReferenceAdded<HospitalExample.Hospital, HospitalExample.Reception>(incUtil,(HospitalExample.Hospital) notification.getNotifier(), (HospitalExample.Reception) notification.getNewValue(), "Hospital_reception_Reception"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInReception__FWD_221_localSearch").tell(new ReferenceAdded<HospitalExample.Hospital, HospitalExample.Reception>(incUtil,(HospitalExample.Hospital) notification.getNotifier(), (HospitalExample.Reception) notification.getNewValue(), "Hospital_reception_Reception"), getSelf());
		});
		feature2addEdgeConsumer.put(HospitalExample.HospitalExamplePackage.eINSTANCE.getStaff_Works(), notification -> {
			incUtil.newMessage();
			name2actor.get("DocToStaffRule__CONSISTENCY_35_localSearch").tell(new ReferenceAdded<HospitalExample.Staff, HospitalExample.Department>(incUtil,(HospitalExample.Staff) notification.getNotifier(), (HospitalExample.Department) notification.getNewValue(), "Staff_works_Department"), getSelf());
			incUtil.newMessage();
			name2actor.get("DocToStaffRule__FWD_46_localSearch").tell(new ReferenceAdded<HospitalExample.Staff, HospitalExample.Department>(incUtil,(HospitalExample.Staff) notification.getNotifier(), (HospitalExample.Department) notification.getNewValue(), "Staff_works_Department"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__BWD_75_localSearch").tell(new ReferenceAdded<HospitalExample.Staff, HospitalExample.Department>(incUtil,(HospitalExample.Staff) notification.getNotifier(), (HospitalExample.Department) notification.getNewValue(), "Staff_works_Department"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__CONSISTENCY_85_localSearch").tell(new ReferenceAdded<HospitalExample.Staff, HospitalExample.Department>(incUtil,(HospitalExample.Staff) notification.getNotifier(), (HospitalExample.Department) notification.getNewValue(), "Staff_works_Department"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__FWD_96_localSearch").tell(new ReferenceAdded<HospitalExample.Staff, HospitalExample.Department>(incUtil,(HospitalExample.Staff) notification.getNotifier(), (HospitalExample.Department) notification.getNewValue(), "Staff_works_Department"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToRoomRule__CONSISTENCY_140_localSearch").tell(new ReferenceAdded<HospitalExample.Staff, HospitalExample.Department>(incUtil,(HospitalExample.Staff) notification.getNotifier(), (HospitalExample.Department) notification.getNewValue(), "Staff_works_Department"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToRoomRule__FWD_150_localSearch").tell(new ReferenceAdded<HospitalExample.Staff, HospitalExample.Department>(incUtil,(HospitalExample.Staff) notification.getNotifier(), (HospitalExample.Department) notification.getNewValue(), "Staff_works_Department"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToStaffRule__CONSISTENCY_186_localSearch").tell(new ReferenceAdded<HospitalExample.Staff, HospitalExample.Department>(incUtil,(HospitalExample.Staff) notification.getNotifier(), (HospitalExample.Department) notification.getNewValue(), "Staff_works_Department"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToStaffRule__FWD_197_localSearch").tell(new ReferenceAdded<HospitalExample.Staff, HospitalExample.Department>(incUtil,(HospitalExample.Staff) notification.getNotifier(), (HospitalExample.Department) notification.getNewValue(), "Staff_works_Department"), getSelf());
		});
		feature2addEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getPatientToPatient_Source(), notification -> {
			incUtil.newMessage();
			name2actor.get("DoctorShiftplanRule__BWD_52_localSearch").tell(new ReferenceAdded<Hospital2Administration.PatientToPatient, HospitalExample.Patient>(incUtil,(Hospital2Administration.PatientToPatient) notification.getNotifier(), (HospitalExample.Patient) notification.getNewValue(), "PatientToPatient_source_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorShiftplanRule__CONSISTENCY_61_localSearch").tell(new ReferenceAdded<Hospital2Administration.PatientToPatient, HospitalExample.Patient>(incUtil,(Hospital2Administration.PatientToPatient) notification.getNotifier(), (HospitalExample.Patient) notification.getNewValue(), "PatientToPatient_source_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__BWD_75_localSearch").tell(new ReferenceAdded<Hospital2Administration.PatientToPatient, HospitalExample.Patient>(incUtil,(Hospital2Administration.PatientToPatient) notification.getNotifier(), (HospitalExample.Patient) notification.getNewValue(), "PatientToPatient_source_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__CONSISTENCY_85_localSearch").tell(new ReferenceAdded<Hospital2Administration.PatientToPatient, HospitalExample.Patient>(incUtil,(Hospital2Administration.PatientToPatient) notification.getNotifier(), (HospitalExample.Patient) notification.getNewValue(), "PatientToPatient_source_Patient"), getSelf());
			incUtil.newMessage();
			...
			name2actor.get("NurseShiftplanRule__BWD_119_localSearch").tell(new ReferenceAdded<Hospital2Administration.PatientToPatient, HospitalExample.Patient>(incUtil,(Hospital2Administration.PatientToPatient) notification.getNotifier(), (HospitalExample.Patient) notification.getNewValue(), "PatientToPatient_source_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseShiftplanRule__CONSISTENCY_129_localSearch").tell(new ReferenceAdded<Hospital2Administration.PatientToPatient, HospitalExample.Patient>(incUtil,(Hospital2Administration.PatientToPatient) notification.getNotifier(), (HospitalExample.Patient) notification.getNewValue(), "PatientToPatient_source_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToRoomRule__CONSISTENCY_140_localSearch").tell(new ReferenceAdded<Hospital2Administration.PatientToPatient, HospitalExample.Patient>(incUtil,(Hospital2Administration.PatientToPatient) notification.getNotifier(), (HospitalExample.Patient) notification.getNewValue(), "PatientToPatient_source_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToRoomRule__FWD_150_localSearch").tell(new ReferenceAdded<Hospital2Administration.PatientToPatient, HospitalExample.Patient>(incUtil,(Hospital2Administration.PatientToPatient) notification.getNotifier(), (HospitalExample.Patient) notification.getNewValue(), "PatientToPatient_source_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInReception__CONSISTENCY_212_localSearch").tell(new ReferenceAdded<Hospital2Administration.PatientToPatient, HospitalExample.Patient>(incUtil,(Hospital2Administration.PatientToPatient) notification.getNotifier(), (HospitalExample.Patient) notification.getNewValue(), "PatientToPatient_source_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInRoom__CONSISTENCY_237_localSearch").tell(new ReferenceAdded<Hospital2Administration.PatientToPatient, HospitalExample.Patient>(incUtil,(Hospital2Administration.PatientToPatient) notification.getNotifier(), (HospitalExample.Patient) notification.getNewValue(), "PatientToPatient_source_Patient"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getStaffToStaff_Source(), notification -> {
			incUtil.newMessage();
			name2actor.get("DocToStaffRule__CONSISTENCY_35_localSearch").tell(new ReferenceAdded<Hospital2Administration.StaffToStaff, HospitalExample.Staff>(incUtil,(Hospital2Administration.StaffToStaff) notification.getNotifier(), (HospitalExample.Staff) notification.getNewValue(), "StaffToStaff_source_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorShiftplanRule__BWD_52_localSearch").tell(new ReferenceAdded<Hospital2Administration.StaffToStaff, HospitalExample.Staff>(incUtil,(Hospital2Administration.StaffToStaff) notification.getNotifier(), (HospitalExample.Staff) notification.getNewValue(), "StaffToStaff_source_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorShiftplanRule__CONSISTENCY_61_localSearch").tell(new ReferenceAdded<Hospital2Administration.StaffToStaff, HospitalExample.Staff>(incUtil,(Hospital2Administration.StaffToStaff) notification.getNotifier(), (HospitalExample.Staff) notification.getNewValue(), "StaffToStaff_source_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__BWD_75_localSearch").tell(new ReferenceAdded<Hospital2Administration.StaffToStaff, HospitalExample.Staff>(incUtil,(Hospital2Administration.StaffToStaff) notification.getNotifier(), (HospitalExample.Staff) notification.getNewValue(), "StaffToStaff_source_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__CONSISTENCY_85_localSearch").tell(new ReferenceAdded<Hospital2Administration.StaffToStaff, HospitalExample.Staff>(incUtil,(Hospital2Administration.StaffToStaff) notification.getNotifier(), (HospitalExample.Staff) notification.getNewValue(), "StaffToStaff_source_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__FWD_96_localSearch").tell(new ReferenceAdded<Hospital2Administration.StaffToStaff, HospitalExample.Staff>(incUtil,(Hospital2Administration.StaffToStaff) notification.getNotifier(), (HospitalExample.Staff) notification.getNewValue(), "StaffToStaff_source_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseShiftplanRule__BWD_119_localSearch").tell(new ReferenceAdded<Hospital2Administration.StaffToStaff, HospitalExample.Staff>(incUtil,(Hospital2Administration.StaffToStaff) notification.getNotifier(), (HospitalExample.Staff) notification.getNewValue(), "StaffToStaff_source_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseShiftplanRule__CONSISTENCY_129_localSearch").tell(new ReferenceAdded<Hospital2Administration.StaffToStaff, HospitalExample.Staff>(incUtil,(Hospital2Administration.StaffToStaff) notification.getNotifier(), (HospitalExample.Staff) notification.getNewValue(), "StaffToStaff_source_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToRoomRule__CONSISTENCY_140_localSearch").tell(new ReferenceAdded<Hospital2Administration.StaffToStaff, HospitalExample.Staff>(incUtil,(Hospital2Administration.StaffToStaff) notification.getNotifier(), (HospitalExample.Staff) notification.getNewValue(), "StaffToStaff_source_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToRoomRule__FWD_150_localSearch").tell(new ReferenceAdded<Hospital2Administration.StaffToStaff, HospitalExample.Staff>(incUtil,(Hospital2Administration.StaffToStaff) notification.getNotifier(), (HospitalExample.Staff) notification.getNewValue(), "StaffToStaff_source_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToStaffRule__CONSISTENCY_186_localSearch").tell(new ReferenceAdded<Hospital2Administration.StaffToStaff, HospitalExample.Staff>(incUtil,(Hospital2Administration.StaffToStaff) notification.getNotifier(), (HospitalExample.Staff) notification.getNewValue(), "StaffToStaff_source_Staff"), getSelf());
		});
		feature2addEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getDoctorToPatient__Marker_CONTEXT__CORR__dToS(), notification -> {
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__CONSISTENCY_85_localSearch").tell(new ReferenceAdded<Hospital2Administration.DoctorToPatient__Marker, Hospital2Administration.StaffToStaff>(incUtil,(Hospital2Administration.DoctorToPatient__Marker) notification.getNotifier(), (Hospital2Administration.StaffToStaff) notification.getNewValue(), "DoctorToPatient__Marker_CONTEXT__CORR__dToS_StaffToStaff"), getSelf());
		});
	}
	...
	private void initializeRemoveEdge() {
		...
		feature2removeEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getNurseToRoomRule__Marker_CONTEXT__TRG__p2(), notification -> {
			incUtil.newMessage();
			name2actor.get("NurseToRoomRule__CONSISTENCY_140_localSearch").tell(new ReferenceDeleted<Hospital2Administration.NurseToRoomRule__Marker, AdministrationExample.Patient>(incUtil, (Hospital2Administration.NurseToRoomRule__Marker) notification.getNotifier(), (AdministrationExample.Patient) notification.getOldValue(), "NurseToRoomRule__Marker_CONTEXT__TRG__p2_Patient"), getSelf());
		});
		feature2removeEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getPatientInRoom__Marker_CONTEXT__TRG__v(), notification -> {
			incUtil.newMessage();
			name2actor.get("PatientInRoom__CONSISTENCY_237_localSearch").tell(new ReferenceDeleted<Hospital2Administration.PatientInRoom__Marker, AdministrationExample.Administration>(incUtil, (Hospital2Administration.PatientInRoom__Marker) notification.getNotifier(), (AdministrationExample.Administration) notification.getOldValue(), "PatientInRoom__Marker_CONTEXT__TRG__v_Administration"), getSelf());
		});
		feature2removeEdgeConsumer.put(HospitalExample.HospitalExamplePackage.eINSTANCE.getPatient_Doctor(), notification -> {
			incUtil.newMessage();
			name2actor.get("DoctorShiftplanRule__BWD_52_localSearch").tell(new ReferenceDeleted<HospitalExample.Patient, HospitalExample.Doctor>(incUtil, (HospitalExample.Patient) notification.getNotifier(), (HospitalExample.Doctor) notification.getOldValue(), "Patient_doctor_Doctor"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorShiftplanRule__CONSISTENCY_61_localSearch").tell(new ReferenceDeleted<HospitalExample.Patient, HospitalExample.Doctor>(incUtil, (HospitalExample.Patient) notification.getNotifier(), (HospitalExample.Doctor) notification.getOldValue(), "Patient_doctor_Doctor"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__CONSISTENCY_85_localSearch").tell(new ReferenceDeleted<HospitalExample.Patient, HospitalExample.Doctor>(incUtil, (HospitalExample.Patient) notification.getNotifier(), (HospitalExample.Doctor) notification.getOldValue(), "Patient_doctor_Doctor"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__FWD_96_localSearch").tell(new ReferenceDeleted<HospitalExample.Patient, HospitalExample.Doctor>(incUtil, (HospitalExample.Patient) notification.getNotifier(), (HospitalExample.Doctor) notification.getOldValue(), "Patient_doctor_Doctor"), getSelf());
		});
		feature2removeEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getDoctorShiftplanRule__Marker_CONTEXT__TRG__sh(), notification -> {
			incUtil.newMessage();
			name2actor.get("DoctorShiftplanRule__CONSISTENCY_61_localSearch").tell(new ReferenceDeleted<Hospital2Administration.DoctorShiftplanRule__Marker, AdministrationExample.Shift>(incUtil, (Hospital2Administration.DoctorShiftplanRule__Marker) notification.getNotifier(), (AdministrationExample.Shift) notification.getOldValue(), "DoctorShiftplanRule__Marker_CONTEXT__TRG__sh_Shift"), getSelf());
		});
		feature2removeEdgeConsumer.put(HospitalExample.HospitalExamplePackage.eINSTANCE.getRoom_Lies(), notification -> {
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__BWD_75_localSearch").tell(new ReferenceDeleted<HospitalExample.Room, HospitalExample.Patient>(incUtil, (HospitalExample.Room) notification.getNotifier(), (HospitalExample.Patient) notification.getOldValue(), "Room_lies_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__CONSISTENCY_85_localSearch").tell(new ReferenceDeleted<HospitalExample.Room, HospitalExample.Patient>(incUtil, (HospitalExample.Room) notification.getNotifier(), (HospitalExample.Patient) notification.getOldValue(), "Room_lies_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__FWD_96_localSearch").tell(new ReferenceDeleted<HospitalExample.Room, HospitalExample.Patient>(incUtil, (HospitalExample.Room) notification.getNotifier(), (HospitalExample.Patient) notification.getOldValue(), "Room_lies_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseShiftplanRule__BWD_119_localSearch").tell(new ReferenceDeleted<HospitalExample.Room, HospitalExample.Patient>(incUtil, (HospitalExample.Room) notification.getNotifier(), (HospitalExample.Patient) notification.getOldValue(), "Room_lies_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseShiftplanRule__CONSISTENCY_129_localSearch").tell(new ReferenceDeleted<HospitalExample.Room, HospitalExample.Patient>(incUtil, (HospitalExample.Room) notification.getNotifier(), (HospitalExample.Patient) notification.getOldValue(), "Room_lies_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToRoomRule__CONSISTENCY_140_localSearch").tell(new ReferenceDeleted<HospitalExample.Room, HospitalExample.Patient>(incUtil, (HospitalExample.Room) notification.getNotifier(), (HospitalExample.Patient) notification.getOldValue(), "Room_lies_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToRoomRule__FWD_150_localSearch").tell(new ReferenceDeleted<HospitalExample.Room, HospitalExample.Patient>(incUtil, (HospitalExample.Room) notification.getNotifier(), (HospitalExample.Patient) notification.getOldValue(), "Room_lies_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInReception_p1_lies_incoming_SRC__FILTER_NAC_SRC_209_localSearch").tell(new ReferenceDeleted<HospitalExample.Room, HospitalExample.Patient>(incUtil, (HospitalExample.Room) notification.getNotifier(), (HospitalExample.Patient) notification.getOldValue(), "Room_lies_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInRoom__CONSISTENCY_237_localSearch").tell(new ReferenceDeleted<HospitalExample.Room, HospitalExample.Patient>(incUtil, (HospitalExample.Room) notification.getNotifier(), (HospitalExample.Patient) notification.getOldValue(), "Room_lies_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInRoom__FWD_247_localSearch").tell(new ReferenceDeleted<HospitalExample.Room, HospitalExample.Patient>(incUtil, (HospitalExample.Room) notification.getNotifier(), (HospitalExample.Patient) notification.getOldValue(), "Room_lies_Patient"), getSelf());
		});
		feature2removeEdgeConsumer.put(AdministrationExample.AdministrationExamplePackage.eINSTANCE.getStaff_ShiftPlan(), notification -> {
			incUtil.newMessage();
			name2actor.get("Staff_shiftPlan_0_reference").tell(new ReferenceDeleted<AdministrationExample.Staff, AdministrationExample.Shiftplan>(incUtil, (AdministrationExample.Staff) notification.getNotifier(), (AdministrationExample.Shiftplan) notification.getOldValue(), "Staff_shiftPlan_Shiftplan"), getSelf());
			incUtil.newMessage();
			name2actor.get("Staff_shiftPlan_1_reference").tell(new ReferenceDeleted<AdministrationExample.Staff, AdministrationExample.Shiftplan>(incUtil, (AdministrationExample.Staff) notification.getNotifier(), (AdministrationExample.Shiftplan) notification.getOldValue(), "Staff_shiftPlan_Shiftplan"), getSelf());
			incUtil.newMessage();
			...
			name2actor.get("DocToStaffRule_s2_shiftPlan_outgoing_TRG__FILTER_NAC_TRG_8_localSearch").tell(new ReferenceDeleted<AdministrationExample.Staff, AdministrationExample.Shiftplan>(incUtil, (AdministrationExample.Staff) notification.getNotifier(), (AdministrationExample.Shiftplan) notification.getOldValue(), "Staff_shiftPlan_Shiftplan"), getSelf());
			incUtil.newMessage();
			name2actor.get("DocToStaffRule__CONSISTENCY_35_localSearch").tell(new ReferenceDeleted<AdministrationExample.Staff, AdministrationExample.Shiftplan>(incUtil, (AdministrationExample.Staff) notification.getNotifier(), (AdministrationExample.Shiftplan) notification.getOldValue(), "Staff_shiftPlan_Shiftplan"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorShiftplanRule__BWD_52_localSearch").tell(new ReferenceDeleted<AdministrationExample.Staff, AdministrationExample.Shiftplan>(incUtil, (AdministrationExample.Staff) notification.getNotifier(), (AdministrationExample.Shiftplan) notification.getOldValue(), "Staff_shiftPlan_Shiftplan"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorShiftplanRule__CONSISTENCY_61_localSearch").tell(new ReferenceDeleted<AdministrationExample.Staff, AdministrationExample.Shiftplan>(incUtil, (AdministrationExample.Staff) notification.getNotifier(), (AdministrationExample.Shiftplan) notification.getOldValue(), "Staff_shiftPlan_Shiftplan"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseShiftplanRule__BWD_119_localSearch").tell(new ReferenceDeleted<AdministrationExample.Staff, AdministrationExample.Shiftplan>(incUtil, (AdministrationExample.Staff) notification.getNotifier(), (AdministrationExample.Shiftplan) notification.getOldValue(), "Staff_shiftPlan_Shiftplan"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseShiftplanRule__CONSISTENCY_129_localSearch").tell(new ReferenceDeleted<AdministrationExample.Staff, AdministrationExample.Shiftplan>(incUtil, (AdministrationExample.Staff) notification.getNotifier(), (AdministrationExample.Shiftplan) notification.getOldValue(), "Staff_shiftPlan_Shiftplan"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToStaffRule_s2_shiftPlan_outgoing_TRG__FILTER_NAC_TRG_159_localSearch").tell(new ReferenceDeleted<AdministrationExample.Staff, AdministrationExample.Shiftplan>(incUtil, (AdministrationExample.Staff) notification.getNotifier(), (AdministrationExample.Shiftplan) notification.getOldValue(), "Staff_shiftPlan_Shiftplan"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToStaffRule_s2_shiftPlan_outgoing_TRG__FILTER_NAC_TRG_159_localSearch").tell(new ReferenceDeleted<AdministrationExample.Staff, AdministrationExample.Shiftplan>(incUtil, (AdministrationExample.Staff) notification.getNotifier(), (AdministrationExample.Shiftplan) notification.getOldValue(), "Staff_shiftPlan_Shiftplan"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToStaffRule__CONSISTENCY_186_localSearch").tell(new ReferenceDeleted<AdministrationExample.Staff, AdministrationExample.Shiftplan>(incUtil, (AdministrationExample.Staff) notification.getNotifier(), (AdministrationExample.Shiftplan) notification.getOldValue(), "Staff_shiftPlan_Shiftplan"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getDocToStaffRule__Marker_CREATE__TRG__sp(), notification -> {
			incUtil.newMessage();
			name2actor.get("DocToStaffRule__CONSISTENCY_35_localSearch").tell(new ReferenceDeleted<Hospital2Administration.DocToStaffRule__Marker, AdministrationExample.Shiftplan>(incUtil, (Hospital2Administration.DocToStaffRule__Marker) notification.getNotifier(), (AdministrationExample.Shiftplan) notification.getOldValue(), "DocToStaffRule__Marker_CREATE__TRG__sp_Shiftplan"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getDoctorToPatient__Marker_CONTEXT__TRG__p2(), notification -> {
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__CONSISTENCY_85_localSearch").tell(new ReferenceDeleted<Hospital2Administration.DoctorToPatient__Marker, AdministrationExample.Patient>(incUtil, (Hospital2Administration.DoctorToPatient__Marker) notification.getNotifier(), (AdministrationExample.Patient) notification.getOldValue(), "DoctorToPatient__Marker_CONTEXT__TRG__p2_Patient"), getSelf());
		});
		feature2removeEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getPatientInReception__Marker_CONTEXT__TRG__v(), notification -> {
			incUtil.newMessage();
			name2actor.get("PatientInReception__CONSISTENCY_212_localSearch").tell(new ReferenceDeleted<Hospital2Administration.PatientInReception__Marker, AdministrationExample.Administration>(incUtil, (Hospital2Administration.PatientInReception__Marker) notification.getNotifier(), (AdministrationExample.Administration) notification.getOldValue(), "PatientInReception__Marker_CONTEXT__TRG__v_Administration"), getSelf());
		});
		feature2removeEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getPatientInRoom__Marker_CONTEXT__SRC__h(), notification -> {
			incUtil.newMessage();
			name2actor.get("PatientInRoom__CONSISTENCY_237_localSearch").tell(new ReferenceDeleted<Hospital2Administration.PatientInRoom__Marker, HospitalExample.Hospital>(incUtil, (Hospital2Administration.PatientInRoom__Marker) notification.getNotifier(), (HospitalExample.Hospital) notification.getOldValue(), "PatientInRoom__Marker_CONTEXT__SRC__h_Hospital"), getSelf());
		});
		feature2removeEdgeConsumer.put(AdministrationExample.AdministrationExamplePackage.eINSTANCE.getAdministration_Staff(), notification -> {
			incUtil.newMessage();
			name2actor.get("Administration_staff_0_reference").tell(new ReferenceDeleted<AdministrationExample.Administration, AdministrationExample.Staff>(incUtil, (AdministrationExample.Administration) notification.getNotifier(), (AdministrationExample.Staff) notification.getOldValue(), "Administration_staff_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("Administration_staff_1_reference").tell(new ReferenceDeleted<AdministrationExample.Administration, AdministrationExample.Staff>(incUtil, (AdministrationExample.Administration) notification.getNotifier(), (AdministrationExample.Staff) notification.getOldValue(), "Administration_staff_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("DocToStaffRule__CONSISTENCY_35_localSearch").tell(new ReferenceDeleted<AdministrationExample.Administration, AdministrationExample.Staff>(incUtil, (AdministrationExample.Administration) notification.getNotifier(), (AdministrationExample.Staff) notification.getOldValue(), "Administration_staff_Staff"), getSelf());
			incUtil.newMessage();
		...
		feature2removeEdgeConsumer.put(AdministrationExample.AdministrationExamplePackage.eINSTANCE.getPatient_Treatment(), notification -> {
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__BWD_75_localSearch").tell(new ReferenceDeleted<AdministrationExample.Patient, AdministrationExample.Treatment>(incUtil, (AdministrationExample.Patient) notification.getNotifier(), (AdministrationExample.Treatment) notification.getOldValue(), "Patient_treatment_Treatment"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__CONSISTENCY_85_localSearch").tell(new ReferenceDeleted<AdministrationExample.Patient, AdministrationExample.Treatment>(incUtil, (AdministrationExample.Patient) notification.getNotifier(), (AdministrationExample.Treatment) notification.getOldValue(), "Patient_treatment_Treatment"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(HospitalExample.HospitalExamplePackage.eINSTANCE.getHospital_Staff(), notification -> {
			incUtil.newMessage();
			name2actor.get("DocToStaffRule__CONSISTENCY_35_localSearch").tell(new ReferenceDeleted<HospitalExample.Hospital, HospitalExample.Staff>(incUtil, (HospitalExample.Hospital) notification.getNotifier(), (HospitalExample.Staff) notification.getOldValue(), "Hospital_staff_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("DocToStaffRule__FWD_46_localSearch").tell(new ReferenceDeleted<HospitalExample.Hospital, HospitalExample.Staff>(incUtil, (HospitalExample.Hospital) notification.getNotifier(), (HospitalExample.Staff) notification.getOldValue(), "Hospital_staff_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToStaffRule__CONSISTENCY_186_localSearch").tell(new ReferenceDeleted<HospitalExample.Hospital, HospitalExample.Staff>(incUtil, (HospitalExample.Hospital) notification.getNotifier(), (HospitalExample.Staff) notification.getOldValue(), "Hospital_staff_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToStaffRule__FWD_197_localSearch").tell(new ReferenceDeleted<HospitalExample.Hospital, HospitalExample.Staff>(incUtil, (HospitalExample.Hospital) notification.getNotifier(), (HospitalExample.Staff) notification.getOldValue(), "Hospital_staff_Staff"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getPatientToPatient_Target(), notification -> {
			incUtil.newMessage();
			name2actor.get("DoctorShiftplanRule__BWD_52_localSearch").tell(new ReferenceDeleted<Hospital2Administration.PatientToPatient, AdministrationExample.Patient>(incUtil, (Hospital2Administration.PatientToPatient) notification.getNotifier(), (AdministrationExample.Patient) notification.getOldValue(), "PatientToPatient_target_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorShiftplanRule__CONSISTENCY_61_localSearch").tell(new ReferenceDeleted<Hospital2Administration.PatientToPatient, AdministrationExample.Patient>(incUtil, (Hospital2Administration.PatientToPatient) notification.getNotifier(), (AdministrationExample.Patient) notification.getOldValue(), "PatientToPatient_target_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__BWD_75_localSearch").tell(new ReferenceDeleted<Hospital2Administration.PatientToPatient, AdministrationExample.Patient>(incUtil, (Hospital2Administration.PatientToPatient) notification.getNotifier(), (AdministrationExample.Patient) notification.getOldValue(), "PatientToPatient_target_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__CONSISTENCY_85_localSearch").tell(new ReferenceDeleted<Hospital2Administration.PatientToPatient, AdministrationExample.Patient>(incUtil, (Hospital2Administration.PatientToPatient) notification.getNotifier(), (AdministrationExample.Patient) notification.getOldValue(), "PatientToPatient_target_Patient"), getSelf());
			incUtil.newMessage();
			...
			name2actor.get("NurseShiftplanRule__BWD_119_localSearch").tell(new ReferenceDeleted<Hospital2Administration.PatientToPatient, AdministrationExample.Patient>(incUtil, (Hospital2Administration.PatientToPatient) notification.getNotifier(), (AdministrationExample.Patient) notification.getOldValue(), "PatientToPatient_target_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseShiftplanRule__CONSISTENCY_129_localSearch").tell(new ReferenceDeleted<Hospital2Administration.PatientToPatient, AdministrationExample.Patient>(incUtil, (Hospital2Administration.PatientToPatient) notification.getNotifier(), (AdministrationExample.Patient) notification.getOldValue(), "PatientToPatient_target_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToRoomRule__CONSISTENCY_140_localSearch").tell(new ReferenceDeleted<Hospital2Administration.PatientToPatient, AdministrationExample.Patient>(incUtil, (Hospital2Administration.PatientToPatient) notification.getNotifier(), (AdministrationExample.Patient) notification.getOldValue(), "PatientToPatient_target_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToRoomRule__FWD_150_localSearch").tell(new ReferenceDeleted<Hospital2Administration.PatientToPatient, AdministrationExample.Patient>(incUtil, (Hospital2Administration.PatientToPatient) notification.getNotifier(), (AdministrationExample.Patient) notification.getOldValue(), "PatientToPatient_target_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInReception__CONSISTENCY_212_localSearch").tell(new ReferenceDeleted<Hospital2Administration.PatientToPatient, AdministrationExample.Patient>(incUtil, (Hospital2Administration.PatientToPatient) notification.getNotifier(), (AdministrationExample.Patient) notification.getOldValue(), "PatientToPatient_target_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInRoom__CONSISTENCY_237_localSearch").tell(new ReferenceDeleted<Hospital2Administration.PatientToPatient, AdministrationExample.Patient>(incUtil, (Hospital2Administration.PatientToPatient) notification.getNotifier(), (AdministrationExample.Patient) notification.getOldValue(), "PatientToPatient_target_Patient"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getDocToStaffRule__Marker_CONTEXT__TRG__v(), notification -> {
			incUtil.newMessage();
			name2actor.get("DocToStaffRule__CONSISTENCY_35_localSearch").tell(new ReferenceDeleted<Hospital2Administration.DocToStaffRule__Marker, AdministrationExample.Administration>(incUtil, (Hospital2Administration.DocToStaffRule__Marker) notification.getNotifier(), (AdministrationExample.Administration) notification.getOldValue(), "DocToStaffRule__Marker_CONTEXT__TRG__v_Administration"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(HospitalExample.HospitalExamplePackage.eINSTANCE.getHospital_Department(), notification -> {
			incUtil.newMessage();
			name2actor.get("DepartmentRule__CONSISTENCY_1_localSearch").tell(new ReferenceDeleted<HospitalExample.Hospital, HospitalExample.Department>(incUtil, (HospitalExample.Hospital) notification.getNotifier(), (HospitalExample.Department) notification.getOldValue(), "Hospital_department_Department"), getSelf());
			incUtil.newMessage();
			name2actor.get("DepartmentRule__FWD_5_localSearch").tell(new ReferenceDeleted<HospitalExample.Hospital, HospitalExample.Department>(incUtil, (HospitalExample.Hospital) notification.getNotifier(), (HospitalExample.Department) notification.getOldValue(), "Hospital_department_Department"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInRoom__BWD_227_localSearch").tell(new ReferenceDeleted<HospitalExample.Hospital, HospitalExample.Department>(incUtil, (HospitalExample.Hospital) notification.getNotifier(), (HospitalExample.Department) notification.getOldValue(), "Hospital_department_Department"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInRoom__CONSISTENCY_237_localSearch").tell(new ReferenceDeleted<HospitalExample.Hospital, HospitalExample.Department>(incUtil, (HospitalExample.Hospital) notification.getNotifier(), (HospitalExample.Department) notification.getOldValue(), "Hospital_department_Department"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInRoom__FWD_247_localSearch").tell(new ReferenceDeleted<HospitalExample.Hospital, HospitalExample.Department>(incUtil, (HospitalExample.Hospital) notification.getNotifier(), (HospitalExample.Department) notification.getOldValue(), "Hospital_department_Department"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getHospitaltoAdministrationRule__Marker_CREATE__TRG__v(), notification -> {
			incUtil.newMessage();
			name2actor.get("HospitaltoAdministrationRule__CONSISTENCY_110_localSearch").tell(new ReferenceDeleted<Hospital2Administration.HospitaltoAdministrationRule__Marker, AdministrationExample.Administration>(incUtil, (Hospital2Administration.HospitaltoAdministrationRule__Marker) notification.getNotifier(), (AdministrationExample.Administration) notification.getOldValue(), "HospitaltoAdministrationRule__Marker_CREATE__TRG__v_Administration"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getHospitaltoAdministrationRule__Marker_CREATE__SRC__r(), notification -> {
			incUtil.newMessage();
			name2actor.get("HospitaltoAdministrationRule__CONSISTENCY_110_localSearch").tell(new ReferenceDeleted<Hospital2Administration.HospitaltoAdministrationRule__Marker, HospitalExample.Reception>(incUtil, (Hospital2Administration.HospitaltoAdministrationRule__Marker) notification.getNotifier(), (HospitalExample.Reception) notification.getOldValue(), "HospitaltoAdministrationRule__Marker_CREATE__SRC__r_Reception"), getSelf());
		});
		feature2removeEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getDoctorToPatient__Marker_CREATE__TRG__t(), notification -> {
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__CONSISTENCY_85_localSearch").tell(new ReferenceDeleted<Hospital2Administration.DoctorToPatient__Marker, AdministrationExample.Treatment>(incUtil, (Hospital2Administration.DoctorToPatient__Marker) notification.getNotifier(), (AdministrationExample.Treatment) notification.getOldValue(), "DoctorToPatient__Marker_CREATE__TRG__t_Treatment"), getSelf());
		});
		feature2removeEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getPatientInRoom__Marker_CREATE__TRG__p2(), notification -> {
			incUtil.newMessage();
			name2actor.get("PatientInRoom__CONSISTENCY_237_localSearch").tell(new ReferenceDeleted<Hospital2Administration.PatientInRoom__Marker, AdministrationExample.Patient>(incUtil, (Hospital2Administration.PatientInRoom__Marker) notification.getNotifier(), (AdministrationExample.Patient) notification.getOldValue(), "PatientInRoom__Marker_CREATE__TRG__p2_Patient"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(AdministrationExample.AdministrationExamplePackage.eINSTANCE.getShiftplan_Shifts(), notification -> {
			incUtil.newMessage();
			name2actor.get("Shiftplan_shifts_0_reference").tell(new ReferenceDeleted<AdministrationExample.Shiftplan, AdministrationExample.Shift>(incUtil, (AdministrationExample.Shiftplan) notification.getNotifier(), (AdministrationExample.Shift) notification.getOldValue(), "Shiftplan_shifts_Shift"), getSelf());
			incUtil.newMessage();
			...
			name2actor.get("DocToStaffRule_sp_shifts_outgoing_TRG__FILTER_NAC_TRG_12_localSearch").tell(new ReferenceDeleted<AdministrationExample.Shiftplan, AdministrationExample.Shift>(incUtil, (AdministrationExample.Shiftplan) notification.getNotifier(), (AdministrationExample.Shift) notification.getOldValue(), "Shiftplan_shifts_Shift"), getSelf());
			incUtil.newMessage();
			name2actor.get("DocToStaffRule__CONSISTENCY_35_localSearch").tell(new ReferenceDeleted<AdministrationExample.Shiftplan, AdministrationExample.Shift>(incUtil, (AdministrationExample.Shiftplan) notification.getNotifier(), (AdministrationExample.Shift) notification.getOldValue(), "Shiftplan_shifts_Shift"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorShiftplanRule__BWD_52_localSearch").tell(new ReferenceDeleted<AdministrationExample.Shiftplan, AdministrationExample.Shift>(incUtil, (AdministrationExample.Shiftplan) notification.getNotifier(), (AdministrationExample.Shift) notification.getOldValue(), "Shiftplan_shifts_Shift"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorShiftplanRule__CONSISTENCY_61_localSearch").tell(new ReferenceDeleted<AdministrationExample.Shiftplan, AdministrationExample.Shift>(incUtil, (AdministrationExample.Shiftplan) notification.getNotifier(), (AdministrationExample.Shift) notification.getOldValue(), "Shiftplan_shifts_Shift"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseShiftplanRule__BWD_119_localSearch").tell(new ReferenceDeleted<AdministrationExample.Shiftplan, AdministrationExample.Shift>(incUtil, (AdministrationExample.Shiftplan) notification.getNotifier(), (AdministrationExample.Shift) notification.getOldValue(), "Shiftplan_shifts_Shift"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseShiftplanRule__CONSISTENCY_129_localSearch").tell(new ReferenceDeleted<AdministrationExample.Shiftplan, AdministrationExample.Shift>(incUtil, (AdministrationExample.Shiftplan) notification.getNotifier(), (AdministrationExample.Shift) notification.getOldValue(), "Shiftplan_shifts_Shift"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToStaffRule_sp_shifts_outgoing_TRG__FILTER_NAC_TRG_163_localSearch").tell(new ReferenceDeleted<AdministrationExample.Shiftplan, AdministrationExample.Shift>(incUtil, (AdministrationExample.Shiftplan) notification.getNotifier(), (AdministrationExample.Shift) notification.getOldValue(), "Shiftplan_shifts_Shift"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToStaffRule_sp_shifts_outgoing_TRG__FILTER_NAC_TRG_163_localSearch").tell(new ReferenceDeleted<AdministrationExample.Shiftplan, AdministrationExample.Shift>(incUtil, (AdministrationExample.Shiftplan) notification.getNotifier(), (AdministrationExample.Shift) notification.getOldValue(), "Shiftplan_shifts_Shift"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToStaffRule__CONSISTENCY_186_localSearch").tell(new ReferenceDeleted<AdministrationExample.Shiftplan, AdministrationExample.Shift>(incUtil, (AdministrationExample.Shiftplan) notification.getNotifier(), (AdministrationExample.Shift) notification.getOldValue(), "Shiftplan_shifts_Shift"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getDoctorToPatient__Marker_CONTEXT__SRC__p1(), notification -> {
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__CONSISTENCY_85_localSearch").tell(new ReferenceDeleted<Hospital2Administration.DoctorToPatient__Marker, HospitalExample.Patient>(incUtil, (Hospital2Administration.DoctorToPatient__Marker) notification.getNotifier(), (HospitalExample.Patient) notification.getOldValue(), "DoctorToPatient__Marker_CONTEXT__SRC__p1_Patient"), getSelf());
		});
		feature2removeEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getHospitaltoAdministrationRule__Marker_CREATE__SRC__h(), notification -> {
			incUtil.newMessage();
			name2actor.get("HospitaltoAdministrationRule__CONSISTENCY_110_localSearch").tell(new ReferenceDeleted<Hospital2Administration.HospitaltoAdministrationRule__Marker, HospitalExample.Hospital>(incUtil, (Hospital2Administration.HospitaltoAdministrationRule__Marker) notification.getNotifier(), (HospitalExample.Hospital) notification.getOldValue(), "HospitaltoAdministrationRule__Marker_CREATE__SRC__h_Hospital"), getSelf());
		});
		feature2removeEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getDoctorToPatient__Marker_CONTEXT__SRC__dep(), notification -> {
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__CONSISTENCY_85_localSearch").tell(new ReferenceDeleted<Hospital2Administration.DoctorToPatient__Marker, HospitalExample.Department>(incUtil, (Hospital2Administration.DoctorToPatient__Marker) notification.getNotifier(), (HospitalExample.Department) notification.getOldValue(), "DoctorToPatient__Marker_CONTEXT__SRC__dep_Department"), getSelf());
		});
		feature2removeEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getDocToStaffRule__Marker_CREATE__SRC__s1(), notification -> {
			incUtil.newMessage();
			name2actor.get("DocToStaffRule__CONSISTENCY_35_localSearch").tell(new ReferenceDeleted<Hospital2Administration.DocToStaffRule__Marker, HospitalExample.Doctor>(incUtil, (Hospital2Administration.DocToStaffRule__Marker) notification.getNotifier(), (HospitalExample.Doctor) notification.getOldValue(), "DocToStaffRule__Marker_CREATE__SRC__s1_Doctor"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(AdministrationExample.AdministrationExamplePackage.eINSTANCE.getStaff_Treatment(), notification -> {
			...
			name2actor.get("DoctorToPatient_t_treatment_incoming_TRG__FILTER_NAC_TRG_71_localSearch").tell(new ReferenceDeleted<AdministrationExample.Staff, AdministrationExample.Treatment>(incUtil, (AdministrationExample.Staff) notification.getNotifier(), (AdministrationExample.Treatment) notification.getOldValue(), "Staff_treatment_Treatment"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__BWD_75_localSearch").tell(new ReferenceDeleted<AdministrationExample.Staff, AdministrationExample.Treatment>(incUtil, (AdministrationExample.Staff) notification.getNotifier(), (AdministrationExample.Treatment) notification.getOldValue(), "Staff_treatment_Treatment"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__CONSISTENCY_85_localSearch").tell(new ReferenceDeleted<AdministrationExample.Staff, AdministrationExample.Treatment>(incUtil, (AdministrationExample.Staff) notification.getNotifier(), (AdministrationExample.Treatment) notification.getOldValue(), "Staff_treatment_Treatment"), getSelf());
		});
		feature2removeEdgeConsumer.put(HospitalExample.HospitalExamplePackage.eINSTANCE.getDepartment_Rooms(), notification -> {
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__BWD_75_localSearch").tell(new ReferenceDeleted<HospitalExample.Department, HospitalExample.Room>(incUtil, (HospitalExample.Department) notification.getNotifier(), (HospitalExample.Room) notification.getOldValue(), "Department_rooms_Room"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__CONSISTENCY_85_localSearch").tell(new ReferenceDeleted<HospitalExample.Department, HospitalExample.Room>(incUtil, (HospitalExample.Department) notification.getNotifier(), (HospitalExample.Room) notification.getOldValue(), "Department_rooms_Room"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__FWD_96_localSearch").tell(new ReferenceDeleted<HospitalExample.Department, HospitalExample.Room>(incUtil, (HospitalExample.Department) notification.getNotifier(), (HospitalExample.Room) notification.getOldValue(), "Department_rooms_Room"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToRoomRule__CONSISTENCY_140_localSearch").tell(new ReferenceDeleted<HospitalExample.Department, HospitalExample.Room>(incUtil, (HospitalExample.Department) notification.getNotifier(), (HospitalExample.Room) notification.getOldValue(), "Department_rooms_Room"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToRoomRule__FWD_150_localSearch").tell(new ReferenceDeleted<HospitalExample.Department, HospitalExample.Room>(incUtil, (HospitalExample.Department) notification.getNotifier(), (HospitalExample.Room) notification.getOldValue(), "Department_rooms_Room"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInRoom__BWD_227_localSearch").tell(new ReferenceDeleted<HospitalExample.Department, HospitalExample.Room>(incUtil, (HospitalExample.Department) notification.getNotifier(), (HospitalExample.Room) notification.getOldValue(), "Department_rooms_Room"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInRoom__CONSISTENCY_237_localSearch").tell(new ReferenceDeleted<HospitalExample.Department, HospitalExample.Room>(incUtil, (HospitalExample.Department) notification.getNotifier(), (HospitalExample.Room) notification.getOldValue(), "Department_rooms_Room"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInRoom__FWD_247_localSearch").tell(new ReferenceDeleted<HospitalExample.Department, HospitalExample.Room>(incUtil, (HospitalExample.Department) notification.getNotifier(), (HospitalExample.Room) notification.getOldValue(), "Department_rooms_Room"), getSelf());
			incUtil.newMessage();
			name2actor.get("RoomRule__CONSISTENCY_254_localSearch").tell(new ReferenceDeleted<HospitalExample.Department, HospitalExample.Room>(incUtil, (HospitalExample.Department) notification.getNotifier(), (HospitalExample.Room) notification.getOldValue(), "Department_rooms_Room"), getSelf());
			incUtil.newMessage();
			name2actor.get("RoomRule__FWD_258_localSearch").tell(new ReferenceDeleted<HospitalExample.Department, HospitalExample.Room>(incUtil, (HospitalExample.Department) notification.getNotifier(), (HospitalExample.Room) notification.getOldValue(), "Department_rooms_Room"), getSelf());
		});
		feature2removeEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getDocToStaffRule__Marker_CREATE__TRG__sh(), notification -> {
			incUtil.newMessage();
			name2actor.get("DocToStaffRule__CONSISTENCY_35_localSearch").tell(new ReferenceDeleted<Hospital2Administration.DocToStaffRule__Marker, AdministrationExample.Shift>(incUtil, (Hospital2Administration.DocToStaffRule__Marker) notification.getNotifier(), (AdministrationExample.Shift) notification.getOldValue(), "DocToStaffRule__Marker_CREATE__TRG__sh_Shift"), getSelf());
		});
		feature2removeEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getPatientInReception__Marker_CONTEXT__SRC__h(), notification -> {
			incUtil.newMessage();
			name2actor.get("PatientInReception__CONSISTENCY_212_localSearch").tell(new ReferenceDeleted<Hospital2Administration.PatientInReception__Marker, HospitalExample.Hospital>(incUtil, (Hospital2Administration.PatientInReception__Marker) notification.getNotifier(), (HospitalExample.Hospital) notification.getOldValue(), "PatientInReception__Marker_CONTEXT__SRC__h_Hospital"), getSelf());
		});
		feature2removeEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getHospitalToAdministration_Source(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("DocToStaffRule__CONSISTENCY_35_localSearch").tell(new ReferenceDeleted<Hospital2Administration.HospitalToAdministration, HospitalExample.Hospital>(incUtil, (Hospital2Administration.HospitalToAdministration) notification.getNotifier(), (HospitalExample.Hospital) notification.getOldValue(), "HospitalToAdministration_source_Hospital"), getSelf());
			incUtil.newMessage();
			name2actor.get("DocToStaffRule__FWD_46_localSearch").tell(new ReferenceDeleted<Hospital2Administration.HospitalToAdministration, HospitalExample.Hospital>(incUtil, (Hospital2Administration.HospitalToAdministration) notification.getNotifier(), (HospitalExample.Hospital) notification.getOldValue(), "HospitalToAdministration_source_Hospital"), getSelf());
			incUtil.newMessage();
			...
			name2actor.get("NurseToStaffRule__FWD_197_localSearch").tell(new ReferenceDeleted<Hospital2Administration.HospitalToAdministration, HospitalExample.Hospital>(incUtil, (Hospital2Administration.HospitalToAdministration) notification.getNotifier(), (HospitalExample.Hospital) notification.getOldValue(), "HospitalToAdministration_source_Hospital"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInReception__BWD_203_localSearch").tell(new ReferenceDeleted<Hospital2Administration.HospitalToAdministration, HospitalExample.Hospital>(incUtil, (Hospital2Administration.HospitalToAdministration) notification.getNotifier(), (HospitalExample.Hospital) notification.getOldValue(), "HospitalToAdministration_source_Hospital"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInReception__CONSISTENCY_212_localSearch").tell(new ReferenceDeleted<Hospital2Administration.HospitalToAdministration, HospitalExample.Hospital>(incUtil, (Hospital2Administration.HospitalToAdministration) notification.getNotifier(), (HospitalExample.Hospital) notification.getOldValue(), "HospitalToAdministration_source_Hospital"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInReception__FWD_221_localSearch").tell(new ReferenceDeleted<Hospital2Administration.HospitalToAdministration, HospitalExample.Hospital>(incUtil, (Hospital2Administration.HospitalToAdministration) notification.getNotifier(), (HospitalExample.Hospital) notification.getOldValue(), "HospitalToAdministration_source_Hospital"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInRoom__BWD_227_localSearch").tell(new ReferenceDeleted<Hospital2Administration.HospitalToAdministration, HospitalExample.Hospital>(incUtil, (Hospital2Administration.HospitalToAdministration) notification.getNotifier(), (HospitalExample.Hospital) notification.getOldValue(), "HospitalToAdministration_source_Hospital"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInRoom__CONSISTENCY_237_localSearch").tell(new ReferenceDeleted<Hospital2Administration.HospitalToAdministration, HospitalExample.Hospital>(incUtil, (Hospital2Administration.HospitalToAdministration) notification.getNotifier(), (HospitalExample.Hospital) notification.getOldValue(), "HospitalToAdministration_source_Hospital"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInRoom__FWD_247_localSearch").tell(new ReferenceDeleted<Hospital2Administration.HospitalToAdministration, HospitalExample.Hospital>(incUtil, (Hospital2Administration.HospitalToAdministration) notification.getNotifier(), (HospitalExample.Hospital) notification.getOldValue(), "HospitalToAdministration_source_Hospital"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(AdministrationExample.AdministrationExamplePackage.eINSTANCE.getAdministration_Patient(), notification -> {
			incUtil.newMessage();
			name2actor.get("PatientInReception__BWD_203_localSearch").tell(new ReferenceDeleted<AdministrationExample.Administration, AdministrationExample.Patient>(incUtil, (AdministrationExample.Administration) notification.getNotifier(), (AdministrationExample.Patient) notification.getOldValue(), "Administration_patient_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInReception__CONSISTENCY_212_localSearch").tell(new ReferenceDeleted<AdministrationExample.Administration, AdministrationExample.Patient>(incUtil, (AdministrationExample.Administration) notification.getNotifier(), (AdministrationExample.Patient) notification.getOldValue(), "Administration_patient_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInRoom__BWD_227_localSearch").tell(new ReferenceDeleted<AdministrationExample.Administration, AdministrationExample.Patient>(incUtil, (AdministrationExample.Administration) notification.getNotifier(), (AdministrationExample.Patient) notification.getOldValue(), "Administration_patient_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInRoom__CONSISTENCY_237_localSearch").tell(new ReferenceDeleted<AdministrationExample.Administration, AdministrationExample.Patient>(incUtil, (AdministrationExample.Administration) notification.getNotifier(), (AdministrationExample.Patient) notification.getOldValue(), "Administration_patient_Patient"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getPatientInReception__Marker_CONTEXT__CORR__htov(), notification -> {
			incUtil.newMessage();
			name2actor.get("PatientInReception__CONSISTENCY_212_localSearch").tell(new ReferenceDeleted<Hospital2Administration.PatientInReception__Marker, Hospital2Administration.HospitalToAdministration>(incUtil, (Hospital2Administration.PatientInReception__Marker) notification.getNotifier(), (Hospital2Administration.HospitalToAdministration) notification.getOldValue(), "PatientInReception__Marker_CONTEXT__CORR__htov_HospitalToAdministration"), getSelf());
		});
		feature2removeEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getRoomRule__Marker_CREATE__SRC__ro(), notification -> {
			incUtil.newMessage();
			name2actor.get("RoomRule__CONSISTENCY_254_localSearch").tell(new ReferenceDeleted<Hospital2Administration.RoomRule__Marker, HospitalExample.Room>(incUtil, (Hospital2Administration.RoomRule__Marker) notification.getNotifier(), (HospitalExample.Room) notification.getOldValue(), "RoomRule__Marker_CREATE__SRC__ro_Room"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(AdministrationExample.AdministrationExamplePackage.eINSTANCE.getShiftplan_Covers(), notification -> {
			incUtil.newMessage();
			name2actor.get("DoctorShiftplanRule__BWD_52_localSearch").tell(new ReferenceDeleted<AdministrationExample.Shiftplan, AdministrationExample.Patient>(incUtil, (AdministrationExample.Shiftplan) notification.getNotifier(), (AdministrationExample.Patient) notification.getOldValue(), "Shiftplan_covers_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorShiftplanRule__CONSISTENCY_61_localSearch").tell(new ReferenceDeleted<AdministrationExample.Shiftplan, AdministrationExample.Patient>(incUtil, (AdministrationExample.Shiftplan) notification.getNotifier(), (AdministrationExample.Patient) notification.getOldValue(), "Shiftplan_covers_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseShiftplanRule__BWD_119_localSearch").tell(new ReferenceDeleted<AdministrationExample.Shiftplan, AdministrationExample.Patient>(incUtil, (AdministrationExample.Shiftplan) notification.getNotifier(), (AdministrationExample.Patient) notification.getOldValue(), "Shiftplan_covers_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseShiftplanRule__CONSISTENCY_129_localSearch").tell(new ReferenceDeleted<AdministrationExample.Shiftplan, AdministrationExample.Patient>(incUtil, (AdministrationExample.Shiftplan) notification.getNotifier(), (AdministrationExample.Patient) notification.getOldValue(), "Shiftplan_covers_Patient"), getSelf());
		});
		feature2removeEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getDocToStaffRule__Marker_CONTEXT__SRC__h(), notification -> {
			incUtil.newMessage();
			name2actor.get("DocToStaffRule__CONSISTENCY_35_localSearch").tell(new ReferenceDeleted<Hospital2Administration.DocToStaffRule__Marker, HospitalExample.Hospital>(incUtil, (Hospital2Administration.DocToStaffRule__Marker) notification.getNotifier(), (HospitalExample.Hospital) notification.getOldValue(), "DocToStaffRule__Marker_CONTEXT__SRC__h_Hospital"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getPatientInRoom__Marker_CONTEXT__CORR__htov(), notification -> {
			incUtil.newMessage();
			name2actor.get("PatientInRoom__CONSISTENCY_237_localSearch").tell(new ReferenceDeleted<Hospital2Administration.PatientInRoom__Marker, Hospital2Administration.HospitalToAdministration>(incUtil, (Hospital2Administration.PatientInRoom__Marker) notification.getNotifier(), (Hospital2Administration.HospitalToAdministration) notification.getOldValue(), "PatientInRoom__Marker_CONTEXT__CORR__htov_HospitalToAdministration"), getSelf());
		});
		feature2removeEdgeConsumer.put(HospitalExample.HospitalExamplePackage.eINSTANCE.getNurse_Responsible(), notification -> {
			incUtil.newMessage();
			name2actor.get("NurseShiftplanRule__BWD_119_localSearch").tell(new ReferenceDeleted<HospitalExample.Nurse, HospitalExample.Room>(incUtil, (HospitalExample.Nurse) notification.getNotifier(), (HospitalExample.Room) notification.getOldValue(), "Nurse_responsible_Room"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseShiftplanRule__CONSISTENCY_129_localSearch").tell(new ReferenceDeleted<HospitalExample.Nurse, HospitalExample.Room>(incUtil, (HospitalExample.Nurse) notification.getNotifier(), (HospitalExample.Room) notification.getOldValue(), "Nurse_responsible_Room"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToRoomRule__CONSISTENCY_140_localSearch").tell(new ReferenceDeleted<HospitalExample.Nurse, HospitalExample.Room>(incUtil, (HospitalExample.Nurse) notification.getNotifier(), (HospitalExample.Room) notification.getOldValue(), "Nurse_responsible_Room"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToRoomRule__FWD_150_localSearch").tell(new ReferenceDeleted<HospitalExample.Nurse, HospitalExample.Room>(incUtil, (HospitalExample.Nurse) notification.getNotifier(), (HospitalExample.Room) notification.getOldValue(), "Nurse_responsible_Room"), getSelf());
		});
		feature2removeEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getPatientInReception__Marker_CREATE__CORR__pTop(), notification -> {
			incUtil.newMessage();
			name2actor.get("PatientInReception__CONSISTENCY_212_localSearch").tell(new ReferenceDeleted<Hospital2Administration.PatientInReception__Marker, Hospital2Administration.PatientToPatient>(incUtil, (Hospital2Administration.PatientInReception__Marker) notification.getNotifier(), (Hospital2Administration.PatientToPatient) notification.getOldValue(), "PatientInReception__Marker_CREATE__CORR__pTop_PatientToPatient"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getDoctorToPatient__Marker_CONTEXT__SRC__d(), notification -> {
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__CONSISTENCY_85_localSearch").tell(new ReferenceDeleted<Hospital2Administration.DoctorToPatient__Marker, HospitalExample.Doctor>(incUtil, (Hospital2Administration.DoctorToPatient__Marker) notification.getNotifier(), (HospitalExample.Doctor) notification.getOldValue(), "DoctorToPatient__Marker_CONTEXT__SRC__d_Doctor"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getPatientInRoom__Marker_CREATE__CORR__pTop(), notification -> {
			incUtil.newMessage();
			name2actor.get("PatientInRoom__CONSISTENCY_237_localSearch").tell(new ReferenceDeleted<Hospital2Administration.PatientInRoom__Marker, Hospital2Administration.PatientToPatient>(incUtil, (Hospital2Administration.PatientInRoom__Marker) notification.getNotifier(), (Hospital2Administration.PatientToPatient) notification.getOldValue(), "PatientInRoom__Marker_CREATE__CORR__pTop_PatientToPatient"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(HospitalExample.HospitalExamplePackage.eINSTANCE.getReception_Waits(), notification -> {
			incUtil.newMessage();
			name2actor.get("PatientInReception__CONSISTENCY_212_localSearch").tell(new ReferenceDeleted<HospitalExample.Reception, HospitalExample.Patient>(incUtil, (HospitalExample.Reception) notification.getNotifier(), (HospitalExample.Patient) notification.getOldValue(), "Reception_waits_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInReception__FWD_221_localSearch").tell(new ReferenceDeleted<HospitalExample.Reception, HospitalExample.Patient>(incUtil, (HospitalExample.Reception) notification.getNotifier(), (HospitalExample.Patient) notification.getOldValue(), "Reception_waits_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInRoom_p1_waits_incoming_SRC__FILTER_NAC_SRC_234_localSearch").tell(new ReferenceDeleted<HospitalExample.Reception, HospitalExample.Patient>(incUtil, (HospitalExample.Reception) notification.getNotifier(), (HospitalExample.Patient) notification.getOldValue(), "Reception_waits_Patient"), getSelf());
		});
		feature2removeEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getPatientInRoom__Marker_CREATE__SRC__p1(), notification -> {
			incUtil.newMessage();
			name2actor.get("PatientInRoom__CONSISTENCY_237_localSearch").tell(new ReferenceDeleted<Hospital2Administration.PatientInRoom__Marker, HospitalExample.Patient>(incUtil, (Hospital2Administration.PatientInRoom__Marker) notification.getNotifier(), (HospitalExample.Patient) notification.getOldValue(), "PatientInRoom__Marker_CREATE__SRC__p1_Patient"), getSelf());
		});
		feature2removeEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getPatientInReception__Marker_CREATE__TRG__p2(), notification -> {
			incUtil.newMessage();
			name2actor.get("PatientInReception__CONSISTENCY_212_localSearch").tell(new ReferenceDeleted<Hospital2Administration.PatientInReception__Marker, AdministrationExample.Patient>(incUtil, (Hospital2Administration.PatientInReception__Marker) notification.getNotifier(), (AdministrationExample.Patient) notification.getOldValue(), "PatientInReception__Marker_CREATE__TRG__p2_Patient"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getDoctorToPatient__Marker_CONTEXT__CORR__pToP(), notification -> {
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__CONSISTENCY_85_localSearch").tell(new ReferenceDeleted<Hospital2Administration.DoctorToPatient__Marker, Hospital2Administration.PatientToPatient>(incUtil, (Hospital2Administration.DoctorToPatient__Marker) notification.getNotifier(), (Hospital2Administration.PatientToPatient) notification.getOldValue(), "DoctorToPatient__Marker_CONTEXT__CORR__pToP_PatientToPatient"), getSelf());
		});
		feature2removeEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getDoctorToPatient__Marker_CONTEXT__TRG__s(), notification -> {
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__CONSISTENCY_85_localSearch").tell(new ReferenceDeleted<Hospital2Administration.DoctorToPatient__Marker, AdministrationExample.Staff>(incUtil, (Hospital2Administration.DoctorToPatient__Marker) notification.getNotifier(), (AdministrationExample.Staff) notification.getOldValue(), "DoctorToPatient__Marker_CONTEXT__TRG__s_Staff"), getSelf());
		});
		feature2removeEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getHospitalToAdministration_Target(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("DocToStaffRule__CONSISTENCY_35_localSearch").tell(new ReferenceDeleted<Hospital2Administration.HospitalToAdministration, AdministrationExample.Administration>(incUtil, (Hospital2Administration.HospitalToAdministration) notification.getNotifier(), (AdministrationExample.Administration) notification.getOldValue(), "HospitalToAdministration_target_Administration"), getSelf());
			incUtil.newMessage();
			name2actor.get("DocToStaffRule__FWD_46_localSearch").tell(new ReferenceDeleted<Hospital2Administration.HospitalToAdministration, AdministrationExample.Administration>(incUtil, (Hospital2Administration.HospitalToAdministration) notification.getNotifier(), (AdministrationExample.Administration) notification.getOldValue(), "HospitalToAdministration_target_Administration"), getSelf());
			incUtil.newMessage();
			name2actor.get("HospitaltoAdministrationRule__CONSISTENCY_110_localSearch").tell(new ReferenceDeleted<Hospital2Administration.HospitalToAdministration, AdministrationExample.Administration>(incUtil, (Hospital2Administration.HospitalToAdministration) notification.getNotifier(), (AdministrationExample.Administration) notification.getOldValue(), "HospitalToAdministration_target_Administration"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToStaffRule__CONSISTENCY_186_localSearch").tell(new ReferenceDeleted<Hospital2Administration.HospitalToAdministration, AdministrationExample.Administration>(incUtil, (Hospital2Administration.HospitalToAdministration) notification.getNotifier(), (AdministrationExample.Administration) notification.getOldValue(), "HospitalToAdministration_target_Administration"), getSelf());
			...
			name2actor.get("NurseToStaffRule__FWD_197_localSearch").tell(new ReferenceDeleted<Hospital2Administration.HospitalToAdministration, AdministrationExample.Administration>(incUtil, (Hospital2Administration.HospitalToAdministration) notification.getNotifier(), (AdministrationExample.Administration) notification.getOldValue(), "HospitalToAdministration_target_Administration"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInReception__BWD_203_localSearch").tell(new ReferenceDeleted<Hospital2Administration.HospitalToAdministration, AdministrationExample.Administration>(incUtil, (Hospital2Administration.HospitalToAdministration) notification.getNotifier(), (AdministrationExample.Administration) notification.getOldValue(), "HospitalToAdministration_target_Administration"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInReception__CONSISTENCY_212_localSearch").tell(new ReferenceDeleted<Hospital2Administration.HospitalToAdministration, AdministrationExample.Administration>(incUtil, (Hospital2Administration.HospitalToAdministration) notification.getNotifier(), (AdministrationExample.Administration) notification.getOldValue(), "HospitalToAdministration_target_Administration"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInReception__FWD_221_localSearch").tell(new ReferenceDeleted<Hospital2Administration.HospitalToAdministration, AdministrationExample.Administration>(incUtil, (Hospital2Administration.HospitalToAdministration) notification.getNotifier(), (AdministrationExample.Administration) notification.getOldValue(), "HospitalToAdministration_target_Administration"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInRoom__BWD_227_localSearch").tell(new ReferenceDeleted<Hospital2Administration.HospitalToAdministration, AdministrationExample.Administration>(incUtil, (Hospital2Administration.HospitalToAdministration) notification.getNotifier(), (AdministrationExample.Administration) notification.getOldValue(), "HospitalToAdministration_target_Administration"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInRoom__CONSISTENCY_237_localSearch").tell(new ReferenceDeleted<Hospital2Administration.HospitalToAdministration, AdministrationExample.Administration>(incUtil, (Hospital2Administration.HospitalToAdministration) notification.getNotifier(), (AdministrationExample.Administration) notification.getOldValue(), "HospitalToAdministration_target_Administration"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInRoom__FWD_247_localSearch").tell(new ReferenceDeleted<Hospital2Administration.HospitalToAdministration, AdministrationExample.Administration>(incUtil, (Hospital2Administration.HospitalToAdministration) notification.getNotifier(), (AdministrationExample.Administration) notification.getOldValue(), "HospitalToAdministration_target_Administration"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getPatientInReception__Marker_CREATE__SRC__p1(), notification -> {
			incUtil.newMessage();
			name2actor.get("PatientInReception__CONSISTENCY_212_localSearch").tell(new ReferenceDeleted<Hospital2Administration.PatientInReception__Marker, HospitalExample.Patient>(incUtil, (Hospital2Administration.PatientInReception__Marker) notification.getNotifier(), (HospitalExample.Patient) notification.getOldValue(), "PatientInReception__Marker_CREATE__SRC__p1_Patient"), getSelf());
		});
		feature2removeEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getStaffToStaff_Target(), notification -> {
			incUtil.newMessage();
			name2actor.get("DocToStaffRule__CONSISTENCY_35_localSearch").tell(new ReferenceDeleted<Hospital2Administration.StaffToStaff, AdministrationExample.Staff>(incUtil, (Hospital2Administration.StaffToStaff) notification.getNotifier(), (AdministrationExample.Staff) notification.getOldValue(), "StaffToStaff_target_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorShiftplanRule__BWD_52_localSearch").tell(new ReferenceDeleted<Hospital2Administration.StaffToStaff, AdministrationExample.Staff>(incUtil, (Hospital2Administration.StaffToStaff) notification.getNotifier(), (AdministrationExample.Staff) notification.getOldValue(), "StaffToStaff_target_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorShiftplanRule__CONSISTENCY_61_localSearch").tell(new ReferenceDeleted<Hospital2Administration.StaffToStaff, AdministrationExample.Staff>(incUtil, (Hospital2Administration.StaffToStaff) notification.getNotifier(), (AdministrationExample.Staff) notification.getOldValue(), "StaffToStaff_target_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__BWD_75_localSearch").tell(new ReferenceDeleted<Hospital2Administration.StaffToStaff, AdministrationExample.Staff>(incUtil, (Hospital2Administration.StaffToStaff) notification.getNotifier(), (AdministrationExample.Staff) notification.getOldValue(), "StaffToStaff_target_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__CONSISTENCY_85_localSearch").tell(new ReferenceDeleted<Hospital2Administration.StaffToStaff, AdministrationExample.Staff>(incUtil, (Hospital2Administration.StaffToStaff) notification.getNotifier(), (AdministrationExample.Staff) notification.getOldValue(), "StaffToStaff_target_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__FWD_96_localSearch").tell(new ReferenceDeleted<Hospital2Administration.StaffToStaff, AdministrationExample.Staff>(incUtil, (Hospital2Administration.StaffToStaff) notification.getNotifier(), (AdministrationExample.Staff) notification.getOldValue(), "StaffToStaff_target_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseShiftplanRule__BWD_119_localSearch").tell(new ReferenceDeleted<Hospital2Administration.StaffToStaff, AdministrationExample.Staff>(incUtil, (Hospital2Administration.StaffToStaff) notification.getNotifier(), (AdministrationExample.Staff) notification.getOldValue(), "StaffToStaff_target_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseShiftplanRule__CONSISTENCY_129_localSearch").tell(new ReferenceDeleted<Hospital2Administration.StaffToStaff, AdministrationExample.Staff>(incUtil, (Hospital2Administration.StaffToStaff) notification.getNotifier(), (AdministrationExample.Staff) notification.getOldValue(), "StaffToStaff_target_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToRoomRule__CONSISTENCY_140_localSearch").tell(new ReferenceDeleted<Hospital2Administration.StaffToStaff, AdministrationExample.Staff>(incUtil, (Hospital2Administration.StaffToStaff) notification.getNotifier(), (AdministrationExample.Staff) notification.getOldValue(), "StaffToStaff_target_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToRoomRule__FWD_150_localSearch").tell(new ReferenceDeleted<Hospital2Administration.StaffToStaff, AdministrationExample.Staff>(incUtil, (Hospital2Administration.StaffToStaff) notification.getNotifier(), (AdministrationExample.Staff) notification.getOldValue(), "StaffToStaff_target_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToStaffRule__CONSISTENCY_186_localSearch").tell(new ReferenceDeleted<Hospital2Administration.StaffToStaff, AdministrationExample.Staff>(incUtil, (Hospital2Administration.StaffToStaff) notification.getNotifier(), (AdministrationExample.Staff) notification.getOldValue(), "StaffToStaff_target_Staff"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getDoctorToPatient__Marker_CONTEXT__SRC__ro(), notification -> {
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__CONSISTENCY_85_localSearch").tell(new ReferenceDeleted<Hospital2Administration.DoctorToPatient__Marker, HospitalExample.Room>(incUtil, (Hospital2Administration.DoctorToPatient__Marker) notification.getNotifier(), (HospitalExample.Room) notification.getOldValue(), "DoctorToPatient__Marker_CONTEXT__SRC__ro_Room"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getPatientInRoom__Marker_CONTEXT__SRC__ro(), notification -> {
			incUtil.newMessage();
			name2actor.get("PatientInRoom__CONSISTENCY_237_localSearch").tell(new ReferenceDeleted<Hospital2Administration.PatientInRoom__Marker, HospitalExample.Room>(incUtil, (Hospital2Administration.PatientInRoom__Marker) notification.getNotifier(), (HospitalExample.Room) notification.getOldValue(), "PatientInRoom__Marker_CONTEXT__SRC__ro_Room"), getSelf());
		});
		feature2removeEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getPatientInReception__Marker_CONTEXT__SRC__r(), notification -> {
			incUtil.newMessage();
			name2actor.get("PatientInReception__CONSISTENCY_212_localSearch").tell(new ReferenceDeleted<Hospital2Administration.PatientInReception__Marker, HospitalExample.Reception>(incUtil, (Hospital2Administration.PatientInReception__Marker) notification.getNotifier(), (HospitalExample.Reception) notification.getOldValue(), "PatientInReception__Marker_CONTEXT__SRC__r_Reception"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(HospitalExample.HospitalExamplePackage.eINSTANCE.getHospital_Reception(), notification -> {
			...
			name2actor.get("HospitaltoAdministrationRule_h_reception_outgoing_SRC__FILTER_NAC_SRC_106_localSearch").tell(new ReferenceDeleted<HospitalExample.Hospital, HospitalExample.Reception>(incUtil, (HospitalExample.Hospital) notification.getNotifier(), (HospitalExample.Reception) notification.getOldValue(), "Hospital_reception_Reception"), getSelf());
			incUtil.newMessage();
			name2actor.get("HospitaltoAdministrationRule__CONSISTENCY_110_localSearch").tell(new ReferenceDeleted<HospitalExample.Hospital, HospitalExample.Reception>(incUtil, (HospitalExample.Hospital) notification.getNotifier(), (HospitalExample.Reception) notification.getOldValue(), "Hospital_reception_Reception"), getSelf());
			incUtil.newMessage();
			name2actor.get("HospitaltoAdministrationRule__FWD_116_localSearch").tell(new ReferenceDeleted<HospitalExample.Hospital, HospitalExample.Reception>(incUtil, (HospitalExample.Hospital) notification.getNotifier(), (HospitalExample.Reception) notification.getOldValue(), "Hospital_reception_Reception"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInReception__BWD_203_localSearch").tell(new ReferenceDeleted<HospitalExample.Hospital, HospitalExample.Reception>(incUtil, (HospitalExample.Hospital) notification.getNotifier(), (HospitalExample.Reception) notification.getOldValue(), "Hospital_reception_Reception"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInReception__CONSISTENCY_212_localSearch").tell(new ReferenceDeleted<HospitalExample.Hospital, HospitalExample.Reception>(incUtil, (HospitalExample.Hospital) notification.getNotifier(), (HospitalExample.Reception) notification.getOldValue(), "Hospital_reception_Reception"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInReception__FWD_221_localSearch").tell(new ReferenceDeleted<HospitalExample.Hospital, HospitalExample.Reception>(incUtil, (HospitalExample.Hospital) notification.getNotifier(), (HospitalExample.Reception) notification.getOldValue(), "Hospital_reception_Reception"), getSelf());
		});
		feature2removeEdgeConsumer.put(HospitalExample.HospitalExamplePackage.eINSTANCE.getStaff_Works(), notification -> {
			incUtil.newMessage();
			name2actor.get("DocToStaffRule__CONSISTENCY_35_localSearch").tell(new ReferenceDeleted<HospitalExample.Staff, HospitalExample.Department>(incUtil, (HospitalExample.Staff) notification.getNotifier(), (HospitalExample.Department) notification.getOldValue(), "Staff_works_Department"), getSelf());
			incUtil.newMessage();
			name2actor.get("DocToStaffRule__FWD_46_localSearch").tell(new ReferenceDeleted<HospitalExample.Staff, HospitalExample.Department>(incUtil, (HospitalExample.Staff) notification.getNotifier(), (HospitalExample.Department) notification.getOldValue(), "Staff_works_Department"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__BWD_75_localSearch").tell(new ReferenceDeleted<HospitalExample.Staff, HospitalExample.Department>(incUtil, (HospitalExample.Staff) notification.getNotifier(), (HospitalExample.Department) notification.getOldValue(), "Staff_works_Department"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__CONSISTENCY_85_localSearch").tell(new ReferenceDeleted<HospitalExample.Staff, HospitalExample.Department>(incUtil, (HospitalExample.Staff) notification.getNotifier(), (HospitalExample.Department) notification.getOldValue(), "Staff_works_Department"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__FWD_96_localSearch").tell(new ReferenceDeleted<HospitalExample.Staff, HospitalExample.Department>(incUtil, (HospitalExample.Staff) notification.getNotifier(), (HospitalExample.Department) notification.getOldValue(), "Staff_works_Department"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToRoomRule__CONSISTENCY_140_localSearch").tell(new ReferenceDeleted<HospitalExample.Staff, HospitalExample.Department>(incUtil, (HospitalExample.Staff) notification.getNotifier(), (HospitalExample.Department) notification.getOldValue(), "Staff_works_Department"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToRoomRule__FWD_150_localSearch").tell(new ReferenceDeleted<HospitalExample.Staff, HospitalExample.Department>(incUtil, (HospitalExample.Staff) notification.getNotifier(), (HospitalExample.Department) notification.getOldValue(), "Staff_works_Department"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToStaffRule__CONSISTENCY_186_localSearch").tell(new ReferenceDeleted<HospitalExample.Staff, HospitalExample.Department>(incUtil, (HospitalExample.Staff) notification.getNotifier(), (HospitalExample.Department) notification.getOldValue(), "Staff_works_Department"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToStaffRule__FWD_197_localSearch").tell(new ReferenceDeleted<HospitalExample.Staff, HospitalExample.Department>(incUtil, (HospitalExample.Staff) notification.getNotifier(), (HospitalExample.Department) notification.getOldValue(), "Staff_works_Department"), getSelf());
		});
		feature2removeEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getPatientToPatient_Source(), notification -> {
			incUtil.newMessage();
			name2actor.get("DoctorShiftplanRule__BWD_52_localSearch").tell(new ReferenceDeleted<Hospital2Administration.PatientToPatient, HospitalExample.Patient>(incUtil, (Hospital2Administration.PatientToPatient) notification.getNotifier(), (HospitalExample.Patient) notification.getOldValue(), "PatientToPatient_source_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorShiftplanRule__CONSISTENCY_61_localSearch").tell(new ReferenceDeleted<Hospital2Administration.PatientToPatient, HospitalExample.Patient>(incUtil, (Hospital2Administration.PatientToPatient) notification.getNotifier(), (HospitalExample.Patient) notification.getOldValue(), "PatientToPatient_source_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__BWD_75_localSearch").tell(new ReferenceDeleted<Hospital2Administration.PatientToPatient, HospitalExample.Patient>(incUtil, (Hospital2Administration.PatientToPatient) notification.getNotifier(), (HospitalExample.Patient) notification.getOldValue(), "PatientToPatient_source_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__CONSISTENCY_85_localSearch").tell(new ReferenceDeleted<Hospital2Administration.PatientToPatient, HospitalExample.Patient>(incUtil, (Hospital2Administration.PatientToPatient) notification.getNotifier(), (HospitalExample.Patient) notification.getOldValue(), "PatientToPatient_source_Patient"), getSelf());
			incUtil.newMessage();
			...
			name2actor.get("NurseShiftplanRule__BWD_119_localSearch").tell(new ReferenceDeleted<Hospital2Administration.PatientToPatient, HospitalExample.Patient>(incUtil, (Hospital2Administration.PatientToPatient) notification.getNotifier(), (HospitalExample.Patient) notification.getOldValue(), "PatientToPatient_source_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseShiftplanRule__CONSISTENCY_129_localSearch").tell(new ReferenceDeleted<Hospital2Administration.PatientToPatient, HospitalExample.Patient>(incUtil, (Hospital2Administration.PatientToPatient) notification.getNotifier(), (HospitalExample.Patient) notification.getOldValue(), "PatientToPatient_source_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToRoomRule__CONSISTENCY_140_localSearch").tell(new ReferenceDeleted<Hospital2Administration.PatientToPatient, HospitalExample.Patient>(incUtil, (Hospital2Administration.PatientToPatient) notification.getNotifier(), (HospitalExample.Patient) notification.getOldValue(), "PatientToPatient_source_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToRoomRule__FWD_150_localSearch").tell(new ReferenceDeleted<Hospital2Administration.PatientToPatient, HospitalExample.Patient>(incUtil, (Hospital2Administration.PatientToPatient) notification.getNotifier(), (HospitalExample.Patient) notification.getOldValue(), "PatientToPatient_source_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInReception__CONSISTENCY_212_localSearch").tell(new ReferenceDeleted<Hospital2Administration.PatientToPatient, HospitalExample.Patient>(incUtil, (Hospital2Administration.PatientToPatient) notification.getNotifier(), (HospitalExample.Patient) notification.getOldValue(), "PatientToPatient_source_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInRoom__CONSISTENCY_237_localSearch").tell(new ReferenceDeleted<Hospital2Administration.PatientToPatient, HospitalExample.Patient>(incUtil, (Hospital2Administration.PatientToPatient) notification.getNotifier(), (HospitalExample.Patient) notification.getOldValue(), "PatientToPatient_source_Patient"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getStaffToStaff_Source(), notification -> {
			incUtil.newMessage();
			name2actor.get("DocToStaffRule__CONSISTENCY_35_localSearch").tell(new ReferenceDeleted<Hospital2Administration.StaffToStaff, HospitalExample.Staff>(incUtil, (Hospital2Administration.StaffToStaff) notification.getNotifier(), (HospitalExample.Staff) notification.getOldValue(), "StaffToStaff_source_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorShiftplanRule__BWD_52_localSearch").tell(new ReferenceDeleted<Hospital2Administration.StaffToStaff, HospitalExample.Staff>(incUtil, (Hospital2Administration.StaffToStaff) notification.getNotifier(), (HospitalExample.Staff) notification.getOldValue(), "StaffToStaff_source_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorShiftplanRule__CONSISTENCY_61_localSearch").tell(new ReferenceDeleted<Hospital2Administration.StaffToStaff, HospitalExample.Staff>(incUtil, (Hospital2Administration.StaffToStaff) notification.getNotifier(), (HospitalExample.Staff) notification.getOldValue(), "StaffToStaff_source_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__BWD_75_localSearch").tell(new ReferenceDeleted<Hospital2Administration.StaffToStaff, HospitalExample.Staff>(incUtil, (Hospital2Administration.StaffToStaff) notification.getNotifier(), (HospitalExample.Staff) notification.getOldValue(), "StaffToStaff_source_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__CONSISTENCY_85_localSearch").tell(new ReferenceDeleted<Hospital2Administration.StaffToStaff, HospitalExample.Staff>(incUtil, (Hospital2Administration.StaffToStaff) notification.getNotifier(), (HospitalExample.Staff) notification.getOldValue(), "StaffToStaff_source_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__FWD_96_localSearch").tell(new ReferenceDeleted<Hospital2Administration.StaffToStaff, HospitalExample.Staff>(incUtil, (Hospital2Administration.StaffToStaff) notification.getNotifier(), (HospitalExample.Staff) notification.getOldValue(), "StaffToStaff_source_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseShiftplanRule__BWD_119_localSearch").tell(new ReferenceDeleted<Hospital2Administration.StaffToStaff, HospitalExample.Staff>(incUtil, (Hospital2Administration.StaffToStaff) notification.getNotifier(), (HospitalExample.Staff) notification.getOldValue(), "StaffToStaff_source_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseShiftplanRule__CONSISTENCY_129_localSearch").tell(new ReferenceDeleted<Hospital2Administration.StaffToStaff, HospitalExample.Staff>(incUtil, (Hospital2Administration.StaffToStaff) notification.getNotifier(), (HospitalExample.Staff) notification.getOldValue(), "StaffToStaff_source_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToRoomRule__CONSISTENCY_140_localSearch").tell(new ReferenceDeleted<Hospital2Administration.StaffToStaff, HospitalExample.Staff>(incUtil, (Hospital2Administration.StaffToStaff) notification.getNotifier(), (HospitalExample.Staff) notification.getOldValue(), "StaffToStaff_source_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToRoomRule__FWD_150_localSearch").tell(new ReferenceDeleted<Hospital2Administration.StaffToStaff, HospitalExample.Staff>(incUtil, (Hospital2Administration.StaffToStaff) notification.getNotifier(), (HospitalExample.Staff) notification.getOldValue(), "StaffToStaff_source_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToStaffRule__CONSISTENCY_186_localSearch").tell(new ReferenceDeleted<Hospital2Administration.StaffToStaff, HospitalExample.Staff>(incUtil, (Hospital2Administration.StaffToStaff) notification.getNotifier(), (HospitalExample.Staff) notification.getOldValue(), "StaffToStaff_source_Staff"), getSelf());
		});
		feature2removeEdgeConsumer.put(Hospital2Administration.Hospital2AdministrationPackage.eINSTANCE.getDoctorToPatient__Marker_CONTEXT__CORR__dToS(), notification -> {
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__CONSISTENCY_85_localSearch").tell(new ReferenceDeleted<Hospital2Administration.DoctorToPatient__Marker, Hospital2Administration.StaffToStaff>(incUtil, (Hospital2Administration.DoctorToPatient__Marker) notification.getNotifier(), (Hospital2Administration.StaffToStaff) notification.getOldValue(), "DoctorToPatient__Marker_CONTEXT__CORR__dToS_StaffToStaff"), getSelf());
		});
	}
	...
	private void handleRemoveAdapter(Notification notification) {
		...
		if (node instanceof AdministrationExample.Staff) {
			incUtil.newMessage();
			name2actor.get("Staff_object_SP4").tell(new ObjectDeleted<AdministrationExample.Staff>(incUtil, (AdministrationExample.Staff) node), getSelf());
		}
