...
public class DocToStaffRule__FWD_46_localSearch extends GenericLocalSearchActor{
			...
			case "Department_object_SP4": 
				{
					...
					// d
					HMatch match_0 = new LocalSearchMatch("DocToStaffRule__FWD_46_localSearch", 5);
			...
			case "Hospital_object_SP0": 
				{
					...
					// h
					HMatch match_1 = new LocalSearchMatch("DocToStaffRule__FWD_46_localSearch", 5);
			...
			case "HospitalToAdministration_object_SP3": 
				{
					...
					// htov
					HMatch match_2 = new LocalSearchMatch("DocToStaffRule__FWD_46_localSearch", 5);
			...
			case "Administration_object_SP3": 
				{
					...
					// v
					HMatch match_3 = new LocalSearchMatch("DocToStaffRule__FWD_46_localSearch", 5);
			...
			case "Doctor_object_SP1": 
				{
					...
					// s1
					HMatch match_4 = new LocalSearchMatch("DocToStaffRule__FWD_46_localSearch", 5);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "Hospital_staff_Staff": 
			...
			{
				HMatch match = new LocalSearchMatch("DocToStaffRule__FWD_46_localSearch", 5);
				Object[] objs = match.getNodes();
				objs[1] = msg.source;
				objs[4] = msg.target;
				currentDepth++;
