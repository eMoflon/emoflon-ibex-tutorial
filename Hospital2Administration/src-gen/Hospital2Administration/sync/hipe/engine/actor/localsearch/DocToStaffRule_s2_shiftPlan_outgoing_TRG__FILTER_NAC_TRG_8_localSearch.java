...
public class DocToStaffRule_s2_shiftPlan_outgoing_TRG__FILTER_NAC_TRG_8_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunctionRight(node.getPorts().getPort().get(0), getSelf(), name2actor.get("DocToStaffRule__BWD_30_nacjunction"), this::returnTrue , 0  , false ));
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(2), getSelf(), name2actor.get("DocToStaffRule_s2_shiftPlan_outgoing_TRG__FILTER_NAC_TRG_production"), this::returnTrue , 1  , false ));
	}
			...
			case "Staff_object_SP2": 
				{
					...
					// s2
					HMatch match_0 = new LocalSearchMatch("DocToStaffRule_s2_shiftPlan_outgoing_TRG__FILTER_NAC_TRG_8_localSearch", 3);
			...
			case "Shiftplan_object_SP3": 
				{
					...
					// sp
					HMatch match_1 = new LocalSearchMatch("DocToStaffRule_s2_shiftPlan_outgoing_TRG__FILTER_NAC_TRG_8_localSearch", 3);
					match_1.getNodes()[1] = objs[0];
					start(edge_explorer_3_1_orchestration, match_1);
					
					// FILTER_NAC_NODE
					HMatch match_2 = new LocalSearchMatch("DocToStaffRule_s2_shiftPlan_outgoing_TRG__FILTER_NAC_TRG_8_localSearch", 3);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "Staff_shiftPlan_Shiftplan": 
			{
				HMatch match = new LocalSearchMatch("DocToStaffRule_s2_shiftPlan_outgoing_TRG__FILTER_NAC_TRG_8_localSearch", 3);
				Object[] objs = match.getNodes();
				objs[0] = msg.source;
				objs[2] = msg.target;
				currentDepth++;
