...
public class DoctorShiftplanRule__BWD_52_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						...
						edge_explorer_5 = new EdgeExplorer(this, 4, 7, edge_explorer_5_methods);
			...
			case "Patient_object_SP0": 
				{
					...
					// p1
					HMatch match_0 = new LocalSearchMatch("DoctorShiftplanRule__BWD_52_localSearch", 8);
			...
			case "Patient_1_object_SP0": 
				{
					...
					// p2
					HMatch match_1 = new LocalSearchMatch("DoctorShiftplanRule__BWD_52_localSearch", 8);
			...
			case "PatientToPatient_object_SP0": 
				{
					...
					// pToP
					HMatch match_2 = new LocalSearchMatch("DoctorShiftplanRule__BWD_52_localSearch", 8);
			...
			case "Doctor_object_SP0": 
				{
					...
					// s1
					HMatch match_3 = new LocalSearchMatch("DoctorShiftplanRule__BWD_52_localSearch", 8);
					match_3.getNodes()[3] = objs[0];
					start(edge_explorer_8_1_orchestration, match_3);
				}
				break;
			case "Staff_object_SP4": 
				{
					
					// s2
					HMatch match_4 = new LocalSearchMatch("DoctorShiftplanRule__BWD_52_localSearch", 8);
			...
			case "StaffToStaff_object_SP1": 
				{
					...
					// sToS
					HMatch match_5 = new LocalSearchMatch("DoctorShiftplanRule__BWD_52_localSearch", 8);
			...
			case "Shift_object_SP0": 
				{
					...
					// sh
					HMatch match_6 = new LocalSearchMatch("DoctorShiftplanRule__BWD_52_localSearch", 8);
			...
			case "Shiftplan_object_SP1": 
				{
					...
					// sp
					HMatch match_7 = new LocalSearchMatch("DoctorShiftplanRule__BWD_52_localSearch", 8);
		...
		case "StaffToStaff_target_Staff": 
			{
				...
				HMatch match = new LocalSearchMatch("DoctorShiftplanRule__BWD_52_localSearch", 8);
				Object[] objs = match.getNodes();
				objs[5] = msg.source;
				objs[4] = msg.target;
				currentDepth++;
