...
public class DoctorShiftplanRule__CONSISTENCY_61_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> ((Hospital2Administration.DoctorShiftplanRule__Marker) o).getCONTEXT__CORR__pToP();
						edge_explorer = new CachedEdgeExplorer(this, 8, 6, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> ((Hospital2Administration.DoctorShiftplanRule__Marker) o).getCONTEXT__TRG__p2();
						edge_explorer_3 = new CachedEdgeExplorer(this, 8, 2, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> ((Hospital2Administration.DoctorShiftplanRule__Marker) o).getCONTEXT__SRC__s1();
						edge_explorer_4 = new CachedEdgeExplorer(this, 8, 1, edge_explorer_4_methods);
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						...
						edge_explorer_5 = new EdgeExplorer(this, 5, 2, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> ((Hospital2Administration.DoctorShiftplanRule__Marker) o).getCONTEXT__TRG__s2();
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> ((Hospital2Administration.DoctorShiftplanRule__Marker) o).getCONTEXT__CORR__sToS();
						edge_explorer_7 = new CachedEdgeExplorer(this, 8, 7, edge_explorer_7_methods);
		name2explorer.put("edge_explorer_7", edge_explorer_7);
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.multi_lookup = (o) -> ((AdministrationExample.Shiftplan) o).getShifts();
						edge_explorer_8_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof AdministrationExample.Shiftplan) return edge_explorer_8_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
						edge_explorer_8 = new EdgeExplorer(this, 5, 4, edge_explorer_8_methods);
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> ((Hospital2Administration.DoctorShiftplanRule__Marker) o).getCONTEXT__SRC__p1();
						edge_explorer_10 = new CachedEdgeExplorer(this, 8, 0, edge_explorer_10_methods);
		name2explorer.put("edge_explorer_10", edge_explorer_10);
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> ((Hospital2Administration.PatientToPatient) o).getSource();
						edge_explorer_11 = new CachedEdgeExplorer(this, 6, 0, edge_explorer_11_methods);
		name2explorer.put("edge_explorer_11", edge_explorer_11);
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.StaffToStaff) o).getSource(); return (result instanceof HospitalExample.Doctor ? result : null);};
						edge_explorer_12 = new CachedEdgeExplorer(this, 7, 1, edge_explorer_12_methods);
		name2explorer.put("edge_explorer_12", edge_explorer_12);
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> ((HospitalExample.Patient) o).getDoctor();
						edge_explorer_13_methods.multi_opposite_lookup = (o) -> ((HospitalExample.Doctor) o).getCaresfor();
						edge_explorer_13 = new EdgeExplorer(this, 0, 1, edge_explorer_13_methods);
		name2explorer.put("edge_explorer_13", edge_explorer_13);
		EdgeLookupMethods edge_explorer_14_methods = new EdgeLookupMethods();
						edge_explorer_14_methods.unique_lookup = (o) -> ((Hospital2Administration.PatientToPatient) o).getTarget();
						edge_explorer_14 = new CachedEdgeExplorer(this, 6, 2, edge_explorer_14_methods);
		name2explorer.put("edge_explorer_14", edge_explorer_14);
		EdgeLookupMethods edge_explorer_15_methods = new EdgeLookupMethods();
						edge_explorer_15_methods.unique_lookup = (o) -> ((Hospital2Administration.DoctorShiftplanRule__Marker) o).getCONTEXT__TRG__sp();
						edge_explorer_15 = new CachedEdgeExplorer(this, 8, 5, edge_explorer_15_methods);
		name2explorer.put("edge_explorer_15", edge_explorer_15);
		EdgeLookupMethods edge_explorer_16_methods = new EdgeLookupMethods();
						edge_explorer_16_methods.unique_lookup = (o) -> ((Hospital2Administration.StaffToStaff) o).getTarget();
		...
		EdgeLookupMethods edge_explorer_17_methods = new EdgeLookupMethods();
						edge_explorer_17_methods.unique_lookup = (o) -> ((Hospital2Administration.DoctorShiftplanRule__Marker) o).getCONTEXT__TRG__sh();
						edge_explorer_17 = new CachedEdgeExplorer(this, 8, 4, edge_explorer_17_methods);
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("DoctorShiftplanRule__CONSISTENCY_production"), this::returnTrue  , false ));
	}
			...
			case "Patient_object_SP1": 
				{
					...
					// p1
					HMatch match_0 = new LocalSearchMatch("DoctorShiftplanRule__CONSISTENCY_61_localSearch", 9);
			...
			case "Doctor_object_SP1": 
				{
					...
					// s1
					HMatch match_1 = new LocalSearchMatch("DoctorShiftplanRule__CONSISTENCY_61_localSearch", 9);
					match_1.getNodes()[1] = objs[0];
					start(edge_explorer_4_1_orchestration, match_1);
				}
				break;
			case "Patient_1_object_SP1": 
				{
					
					// p2
					HMatch match_2 = new LocalSearchMatch("DoctorShiftplanRule__CONSISTENCY_61_localSearch", 9);
			...
			case "Staff_object_SP0": 
				{
					...
					// s2
					HMatch match_3 = new LocalSearchMatch("DoctorShiftplanRule__CONSISTENCY_61_localSearch", 9);
			...
			case "Shift_object_SP1": 
				{
					...
					// sh
					HMatch match_4 = new LocalSearchMatch("DoctorShiftplanRule__CONSISTENCY_61_localSearch", 9);
			...
			case "Shiftplan_object_SP2": 
				{
					...
					// sp
					HMatch match_5 = new LocalSearchMatch("DoctorShiftplanRule__CONSISTENCY_61_localSearch", 9);
			...
			case "PatientToPatient_object_SP1": 
				{
					...
					// pToP
					HMatch match_6 = new LocalSearchMatch("DoctorShiftplanRule__CONSISTENCY_61_localSearch", 9);
			...
			case "StaffToStaff_object_SP2": 
				{
					...
					// sToS
					HMatch match_7 = new LocalSearchMatch("DoctorShiftplanRule__CONSISTENCY_61_localSearch", 9);
					match_7.getNodes()[7] = objs[0];
					start(edge_explorer_7_1_orchestration, match_7);
				}
				break;
			case "DoctorShiftplanRule__Marker_object": 
				{
					...
					// DoctorShiftplanRule_eMoflon_ProtocolNode
					HMatch match_8 = new LocalSearchMatch("DoctorShiftplanRule__CONSISTENCY_61_localSearch", 9);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		switch(msg.refName) {
		case "DoctorShiftplanRule__Marker_CONTEXT__CORR__pToP_PatientToPatient": 
			{
				edge_explorer.registerEdge(msg.source, msg.target);
				HMatch match = new LocalSearchMatch("DoctorShiftplanRule__CONSISTENCY_61_localSearch", 9);
				Object[] objs = match.getNodes();
				objs[8] = msg.source;
				objs[6] = msg.target;
				currentDepth++;
			...
			break;
		case "DoctorShiftplanRule__Marker_CONTEXT__TRG__p2_Patient": 
			{
			...
			break;
		case "DoctorShiftplanRule__Marker_CONTEXT__SRC__s1_Doctor": 
			{
		...
		case "Shiftplan_covers_Patient": 
			...
			break;
		case "DoctorShiftplanRule__Marker_CONTEXT__TRG__s2_Staff": 
			{
			...
			break;
		case "DoctorShiftplanRule__Marker_CONTEXT__CORR__sToS_StaffToStaff": 
			{
		...
		case "Staff_shiftPlan_Shiftplan": 
			...
			break;
		case "DoctorShiftplanRule__Marker_CONTEXT__SRC__p1_Patient": 
			{
		...
		case "PatientToPatient_target_Patient": 
			...
			break;
		case "DoctorShiftplanRule__Marker_CONTEXT__TRG__sp_Shiftplan": 
			{
		...
		case "StaffToStaff_target_Staff": 
			...
			break;
		case "DoctorShiftplanRule__Marker_CONTEXT__TRG__sh_Shift": 
			{
	...
	protected void registerMatch(HMatch match) {
		...
		// register DoctorShiftplanRule_eMoflon_ProtocolNode
	...
	protected void deregisterMatch(HMatch match) {
		...
		// deregister DoctorShiftplanRule_eMoflon_ProtocolNode
		Collection<HMatch> matches_8 = obj2matches.get(objs[8]);
		if(matches_8 != null) {
