...
public class DoctorShiftplanRule__CONSISTENCY_61_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> ((Hospital2Administration.DoctorShiftplanRule__Marker) o).getCONTEXT__TRG__sp();
						edge_explorer = new CachedEdgeExplorer(this, 8, 5, edge_explorer_methods);
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> ((Hospital2Administration.DoctorShiftplanRule__Marker) o).getCONTEXT__CORR__pToP();
						edge_explorer_5 = new CachedEdgeExplorer(this, 8, 6, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> ((Hospital2Administration.DoctorShiftplanRule__Marker) o).getCONTEXT__TRG__sh();
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> ((Hospital2Administration.PatientToPatient) o).getTarget();
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.multi_lookup = (o) -> ((AdministrationExample.Shiftplan) o).getCovers();
						edge_explorer_8_methods.multi_opposite_lookup = (o) -> ((AdministrationExample.Patient) o).getCoveredBy();
						edge_explorer_8 = new EdgeExplorer(this, 5, 2, edge_explorer_8_methods);
		name2explorer.put("edge_explorer_8", edge_explorer_8);
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> ((Hospital2Administration.DoctorShiftplanRule__Marker) o).getCONTEXT__TRG__p2();
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> ((Hospital2Administration.DoctorShiftplanRule__Marker) o).getCONTEXT__TRG__s2();
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> ((Hospital2Administration.StaffToStaff) o).getTarget();
						edge_explorer_11 = new CachedEdgeExplorer(this, 7, 3, edge_explorer_11_methods);
		name2explorer.put("edge_explorer_11", edge_explorer_11);
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> ((Hospital2Administration.DoctorShiftplanRule__Marker) o).getCONTEXT__SRC__p1();
						edge_explorer_12 = new CachedEdgeExplorer(this, 8, 0, edge_explorer_12_methods);
		name2explorer.put("edge_explorer_12", edge_explorer_12);
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> ((Hospital2Administration.PatientToPatient) o).getSource();
						edge_explorer_13 = new CachedEdgeExplorer(this, 6, 0, edge_explorer_13_methods);
		...
		EdgeLookupMethods edge_explorer_14_methods = new EdgeLookupMethods();
						...
						edge_explorer_14 = new CachedEdgeExplorer(this, 7, 1, edge_explorer_14_methods);
		name2explorer.put("edge_explorer_14", edge_explorer_14);
		EdgeLookupMethods edge_explorer_15_methods = new EdgeLookupMethods();
						edge_explorer_15_methods.unique_lookup = (o) -> ((Hospital2Administration.DoctorShiftplanRule__Marker) o).getCONTEXT__CORR__sToS();
						edge_explorer_15 = new CachedEdgeExplorer(this, 8, 7, edge_explorer_15_methods);
		name2explorer.put("edge_explorer_15", edge_explorer_15);
		EdgeLookupMethods edge_explorer_16_methods = new EdgeLookupMethods();
						edge_explorer_16_methods.unique_lookup = (o) -> ((Hospital2Administration.DoctorShiftplanRule__Marker) o).getCONTEXT__SRC__s1();
						edge_explorer_16 = new CachedEdgeExplorer(this, 8, 1, edge_explorer_16_methods);
		name2explorer.put("edge_explorer_16", edge_explorer_16);
		EdgeLookupMethods edge_explorer_17_methods = new EdgeLookupMethods();
						edge_explorer_17_methods.unique_lookup = (o) -> ((HospitalExample.Patient) o).getDoctor();
						edge_explorer_17_methods.multi_opposite_lookup = (o) -> ((HospitalExample.Doctor) o).getCaresfor();
						edge_explorer_17 = new EdgeExplorer(this, 0, 1, edge_explorer_17_methods);
	...
	protected void initializeOrchestration() {
		...
		edge_explorer_11_0_orchestration = initializeOrchestration(node.getOrchestrations().get(15).getPlan());
		edge_explorer_11_1_orchestration = initializeOrchestration(node.getOrchestrations().get(16).getPlan());
		...
		edge_explorer_14_1_orchestration = initializeOrchestration(node.getOrchestrations().get(21).getPlan());
			...
			case "Patient_object_SP1": 
				{
					...
					start(edge_explorer_12_1_orchestration, match_0);
				}
				break;
			case "Doctor_object_SP1": 
				{
					...
					start(edge_explorer_14_1_orchestration, match_1);
				}
				break;
