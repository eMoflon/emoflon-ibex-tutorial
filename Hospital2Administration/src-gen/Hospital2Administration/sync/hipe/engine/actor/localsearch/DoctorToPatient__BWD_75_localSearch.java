...
public class DoctorToPatient__BWD_75_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> ((HospitalExample.Staff) o).getWorks();
						edge_explorer_3_methods.multi_opposite_lookup = (o) -> ((HospitalExample.Department) o).getStaff().stream().filter(obj -> obj instanceof HospitalExample.Doctor).collect(Collectors.toList());
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.StaffToStaff) o).getSource(); return (result instanceof HospitalExample.Doctor ? result : null);};
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> ((AdministrationExample.Patient) o).getTreatment();
						edge_explorer_8_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof AdministrationExample.Patient) return o.equals(edge_explorer_8_methods.unique_lookup.apply(result)) ? result : null; else return null;};
						edge_explorer_8 = new EdgeExplorer(this, 4, 8, edge_explorer_8_methods);
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						...
						edge_explorer_9 = new CachedEdgeExplorer(this, 1, 7, edge_explorer_9_methods);
			...
			case "Doctor_object_SP0": 
				{
					...
					// d
					HMatch match_0 = new LocalSearchMatch("DoctorToPatient__BWD_75_localSearch", 9);
			...
			case "StaffToStaff_object_SP0": 
				{
					...
					// dToS
					HMatch match_1 = new LocalSearchMatch("DoctorToPatient__BWD_75_localSearch", 9);
			...
			case "Department_object_SP0": 
				{
					...
					// dep
					HMatch match_2 = new LocalSearchMatch("DoctorToPatient__BWD_75_localSearch", 9);
			...
			case "Patient_object_SP2": 
				{
					...
					// p1
					HMatch match_3 = new LocalSearchMatch("DoctorToPatient__BWD_75_localSearch", 9);
			...
			case "Patient_1_object_SP2": 
				{
					...
					// p2
					HMatch match_4 = new LocalSearchMatch("DoctorToPatient__BWD_75_localSearch", 9);
			...
			case "PatientToPatient_object_SP2": 
				{
					...
					// pToP
					HMatch match_5 = new LocalSearchMatch("DoctorToPatient__BWD_75_localSearch", 9);
			...
			case "Room_object_SP0": 
				{
					...
					// ro
					HMatch match_6 = new LocalSearchMatch("DoctorToPatient__BWD_75_localSearch", 9);
			...
			case "Staff_object_SP1": 
				{
					...
					// s
					HMatch match_7 = new LocalSearchMatch("DoctorToPatient__BWD_75_localSearch", 9);
			...
			case "Treatment_object": 
				{
					...
					// t
					HMatch match_8 = new LocalSearchMatch("DoctorToPatient__BWD_75_localSearch", 9);
		...
		switch(match.creator) {
			...
			case "DoctorToPatient_t_treatment_incoming_TRG__FILTER_NAC_TRG_71_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("DoctorToPatient__BWD_75_localSearch", 9);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
		...
		case "PatientToPatient_target_Patient": 
			{
				...
				HMatch match = new LocalSearchMatch("DoctorToPatient__BWD_75_localSearch", 9);
				Object[] objs = match.getNodes();
				objs[5] = msg.source;
				objs[4] = msg.target;
				currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_carelevelToMedication csp_10 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_carelevelToMedication();
		csp_10.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, p1.getLevel(), "Enum::Carelevel"));
		csp_10.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, t.getMedication(), "Enum::Medication"));
		csp_10.solve();
