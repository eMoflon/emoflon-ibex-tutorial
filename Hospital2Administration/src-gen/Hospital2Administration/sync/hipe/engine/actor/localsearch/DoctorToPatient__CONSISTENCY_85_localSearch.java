...
public class DoctorToPatient__CONSISTENCY_85_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> ((Hospital2Administration.DoctorToPatient__Marker) o).getCONTEXT__SRC__ro();
						edge_explorer = new CachedEdgeExplorer(this, 9, 3, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> ((Hospital2Administration.DoctorToPatient__Marker) o).getCONTEXT__CORR__pToP();
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> ((Hospital2Administration.DoctorToPatient__Marker) o).getCONTEXT__TRG__p2();
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> ((Hospital2Administration.DoctorToPatient__Marker) o).getCONTEXT__SRC__p1();
						edge_explorer_9 = new CachedEdgeExplorer(this, 9, 2, edge_explorer_9_methods);
		name2explorer.put("edge_explorer_9", edge_explorer_9);
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> ((AdministrationExample.Patient) o).getTreatment();
						edge_explorer_10_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof AdministrationExample.Patient) return o.equals(edge_explorer_10_methods.unique_lookup.apply(result)) ? result : null; else return null;};
						edge_explorer_10 = new EdgeExplorer(this, 4, 6, edge_explorer_10_methods);
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.multi_lookup = (o) -> ((AdministrationExample.Staff) o).getTreatment();
						edge_explorer_12 = new CachedEdgeExplorer(this, 5, 6, edge_explorer_12_methods);
		name2explorer.put("edge_explorer_12", edge_explorer_12);
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.multi_lookup = (o) -> ((HospitalExample.Department) o).getRooms();
						edge_explorer_13_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof HospitalExample.Department) return edge_explorer_13_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
						edge_explorer_13 = new EdgeExplorer(this, 1, 3, edge_explorer_13_methods);
		...
		EdgeLookupMethods edge_explorer_15_methods = new EdgeLookupMethods();
						edge_explorer_15_methods.unique_lookup = (o) -> ((Hospital2Administration.PatientToPatient) o).getSource();
						edge_explorer_15 = new CachedEdgeExplorer(this, 8, 2, edge_explorer_15_methods);
		name2explorer.put("edge_explorer_15", edge_explorer_15);
		EdgeLookupMethods edge_explorer_16_methods = new EdgeLookupMethods();
						edge_explorer_16_methods.unique_lookup = (o) -> ((Hospital2Administration.DoctorToPatient__Marker) o).getCONTEXT__CORR__dToS();
		...
		EdgeLookupMethods edge_explorer_19_methods = new EdgeLookupMethods();
						...
						edge_explorer_19 = new CachedEdgeExplorer(this, 7, 0, edge_explorer_19_methods);
		name2explorer.put("edge_explorer_19", edge_explorer_19);
		EdgeLookupMethods edge_explorer_20_methods = new EdgeLookupMethods();
						edge_explorer_20_methods.unique_lookup = (o) -> ((Hospital2Administration.DoctorToPatient__Marker) o).getCONTEXT__SRC__dep();
						edge_explorer_20 = new CachedEdgeExplorer(this, 9, 1, edge_explorer_20_methods);
			...
			case "Staff_object_SP3": 
				{
					...
					start(edge_explorer_12_1_orchestration, match_5);
				}
				break;
