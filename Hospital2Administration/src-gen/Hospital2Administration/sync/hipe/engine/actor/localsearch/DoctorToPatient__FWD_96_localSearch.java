...
public class DoctorToPatient__FWD_96_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> ((HospitalExample.Patient) o).getDoctor();
						edge_explorer_4_methods.multi_opposite_lookup = (o) -> ((HospitalExample.Doctor) o).getCaresfor();
			...
			case "Doctor_object_SP0": 
				{
					...
					// d
					HMatch match_0 = new LocalSearchMatch("DoctorToPatient__FWD_96_localSearch", 8);
			...
			case "StaffToStaff_object_SP2": 
				{
					...
					// dToS
					HMatch match_1 = new LocalSearchMatch("DoctorToPatient__FWD_96_localSearch", 8);
			...
			case "Department_object_SP2": 
				{
					...
					// dep
					HMatch match_2 = new LocalSearchMatch("DoctorToPatient__FWD_96_localSearch", 8);
			...
			case "Patient_object_SP0": 
				{
					...
					// p1
					HMatch match_3 = new LocalSearchMatch("DoctorToPatient__FWD_96_localSearch", 8);
			...
			case "Patient_1_object_SP0": 
				{
					...
					// p2
					HMatch match_4 = new LocalSearchMatch("DoctorToPatient__FWD_96_localSearch", 8);
			...
			case "PatientToPatient_object_SP1": 
				{
					...
					// pToP
					HMatch match_5 = new LocalSearchMatch("DoctorToPatient__FWD_96_localSearch", 8);
			...
			case "Room_object_SP2": 
				{
					...
					// ro
					HMatch match_6 = new LocalSearchMatch("DoctorToPatient__FWD_96_localSearch", 8);
			...
			case "Staff_object_SP4": 
				{
					...
					// s
					HMatch match_7 = new LocalSearchMatch("DoctorToPatient__FWD_96_localSearch", 8);
		...
		case "StaffToStaff_target_Staff": 
			{
				...
				HMatch match = new LocalSearchMatch("DoctorToPatient__FWD_96_localSearch", 8);
				Object[] objs = match.getNodes();
				objs[1] = msg.source;
				objs[7] = msg.target;
				currentDepth++;
