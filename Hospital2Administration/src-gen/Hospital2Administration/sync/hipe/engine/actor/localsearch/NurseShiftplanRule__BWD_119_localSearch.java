...
public class NurseShiftplanRule__BWD_119_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						...
						edge_explorer_7 = new EdgeExplorer(this, 8, 7, edge_explorer_7_methods);
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.multi_lookup = (o) -> ((AdministrationExample.Shiftplan) o).getCovers();
						edge_explorer_10_methods.multi_opposite_lookup = (o) -> ((AdministrationExample.Patient) o).getCoveredBy();
						edge_explorer_10 = new EdgeExplorer(this, 8, 1, edge_explorer_10_methods);
	...
	protected void initializeOrchestration() {
		...
		edge_explorer_7_2_orchestration = initializeOrchestration(node.getOrchestrations().get(14).getPlan());
