...
public class NurseShiftplanRule__BWD_119_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						...
						edge_explorer = new EdgeExplorer(this, 4, 3, edge_explorer_methods);
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						...
						edge_explorer_10 = new EdgeExplorer(this, 5, 8, edge_explorer_10_methods);
			...
			case "Patient_object_SP1": 
				{
					...
					// p1
					HMatch match_0 = new LocalSearchMatch("NurseShiftplanRule__BWD_119_localSearch", 9);
			...
			case "Patient_1_object_SP1": 
				{
					...
					// p2
					HMatch match_1 = new LocalSearchMatch("NurseShiftplanRule__BWD_119_localSearch", 9);
			...
			case "PatientToPatient_object_SP2": 
				{
					...
					// pToP
					HMatch match_2 = new LocalSearchMatch("NurseShiftplanRule__BWD_119_localSearch", 9);
			...
			case "Room_object_SP3": 
				{
					...
					// ro
					HMatch match_3 = new LocalSearchMatch("NurseShiftplanRule__BWD_119_localSearch", 9);
			...
			case "Nurse_object_SP0": 
				{
					...
					// s1
					HMatch match_4 = new LocalSearchMatch("NurseShiftplanRule__BWD_119_localSearch", 9);
			...
			case "Staff_object_SP0": 
				{
					...
					// s2
					HMatch match_5 = new LocalSearchMatch("NurseShiftplanRule__BWD_119_localSearch", 9);
			...
			case "StaffToStaff_object_SP0": 
				{
					...
					// sToS
					HMatch match_6 = new LocalSearchMatch("NurseShiftplanRule__BWD_119_localSearch", 9);
			...
			case "Shift_object_SP2": 
				{
					...
					// sh
					HMatch match_7 = new LocalSearchMatch("NurseShiftplanRule__BWD_119_localSearch", 9);
					match_7.getNodes()[7] = objs[0];
					start(edge_explorer_9_1_orchestration, match_7);
				}
				break;
			case "Shiftplan_object_SP3": 
				{
					
					// sp
					HMatch match_8 = new LocalSearchMatch("NurseShiftplanRule__BWD_119_localSearch", 9);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "Nurse_responsible_Room": 
			{
				HMatch match = new LocalSearchMatch("NurseShiftplanRule__BWD_119_localSearch", 9);
				Object[] objs = match.getNodes();
				objs[4] = msg.source;
				objs[3] = msg.target;
				currentDepth++;
