...
public class NurseShiftplanRule__CONSISTENCY_129_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						...
						edge_explorer = new CachedEdgeExplorer(this, 8, 2, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> ((HospitalExample.Nurse) o).getResponsible();
						edge_explorer_3_methods.multi_opposite_lookup = (o) -> ((HospitalExample.Room) o).getNurses();
						edge_explorer_3 = new EdgeExplorer(this, 2, 1, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> ((Hospital2Administration.NurseShiftplanRule__Marker) o).getCONTEXT__CORR__pToP();
						edge_explorer_4 = new CachedEdgeExplorer(this, 9, 7, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> ((Hospital2Administration.StaffToStaff) o).getTarget();
						edge_explorer_5 = new CachedEdgeExplorer(this, 8, 4, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.multi_lookup = (o) -> ((AdministrationExample.Shiftplan) o).getCovers();
						edge_explorer_6_methods.multi_opposite_lookup = (o) -> ((AdministrationExample.Patient) o).getCoveredBy();
						edge_explorer_6 = new EdgeExplorer(this, 6, 3, edge_explorer_6_methods);
		name2explorer.put("edge_explorer_6", edge_explorer_6);
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> ((Hospital2Administration.NurseShiftplanRule__Marker) o).getCONTEXT__CORR__sToS();
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> ((Hospital2Administration.NurseShiftplanRule__Marker) o).getCONTEXT__SRC__s1();
						edge_explorer_8 = new CachedEdgeExplorer(this, 9, 2, edge_explorer_8_methods);
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> ((Hospital2Administration.PatientToPatient) o).getTarget();
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.multi_lookup = (o) -> ((AdministrationExample.Shiftplan) o).getShifts();
						edge_explorer_11_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof AdministrationExample.Shiftplan) return edge_explorer_11_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
						edge_explorer_11 = new EdgeExplorer(this, 6, 5, edge_explorer_11_methods);
		name2explorer.put("edge_explorer_11", edge_explorer_11);
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> ((Hospital2Administration.NurseShiftplanRule__Marker) o).getCONTEXT__TRG__sh();
						edge_explorer_12 = new CachedEdgeExplorer(this, 9, 5, edge_explorer_12_methods);
		name2explorer.put("edge_explorer_12", edge_explorer_12);
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.multi_lookup = (o) -> ((HospitalExample.Room) o).getLies();
						edge_explorer_13_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof HospitalExample.Room) return edge_explorer_13_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
		...
		EdgeLookupMethods edge_explorer_14_methods = new EdgeLookupMethods();
						edge_explorer_14_methods.unique_lookup = (o) -> ((Hospital2Administration.NurseShiftplanRule__Marker) o).getCONTEXT__SRC__p1();
						edge_explorer_14 = new CachedEdgeExplorer(this, 9, 0, edge_explorer_14_methods);
		name2explorer.put("edge_explorer_14", edge_explorer_14);
		EdgeLookupMethods edge_explorer_15_methods = new EdgeLookupMethods();
						edge_explorer_15_methods.unique_lookup = (o) -> ((Hospital2Administration.NurseShiftplanRule__Marker) o).getCONTEXT__SRC__ro();
						edge_explorer_15 = new CachedEdgeExplorer(this, 9, 1, edge_explorer_15_methods);
		name2explorer.put("edge_explorer_15", edge_explorer_15);
		EdgeLookupMethods edge_explorer_16_methods = new EdgeLookupMethods();
						edge_explorer_16_methods.unique_lookup = (o) -> ((AdministrationExample.Staff) o).getShiftPlan();
						edge_explorer_16_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof AdministrationExample.Staff) return o.equals(edge_explorer_16_methods.unique_lookup.apply(result)) ? result : null; else return null;};
		...
		EdgeLookupMethods edge_explorer_17_methods = new EdgeLookupMethods();
						edge_explorer_17_methods.unique_lookup = (o) -> ((Hospital2Administration.PatientToPatient) o).getSource();
						edge_explorer_17 = new CachedEdgeExplorer(this, 7, 0, edge_explorer_17_methods);
		name2explorer.put("edge_explorer_17", edge_explorer_17);
		EdgeLookupMethods edge_explorer_18_methods = new EdgeLookupMethods();
						edge_explorer_18_methods.unique_lookup = (o) -> ((Hospital2Administration.NurseShiftplanRule__Marker) o).getCONTEXT__TRG__sp();
						edge_explorer_18 = new CachedEdgeExplorer(this, 9, 6, edge_explorer_18_methods);
		name2explorer.put("edge_explorer_18", edge_explorer_18);
		EdgeLookupMethods edge_explorer_19_methods = new EdgeLookupMethods();
						edge_explorer_19_methods.unique_lookup = (o) -> ((Hospital2Administration.NurseShiftplanRule__Marker) o).getCONTEXT__TRG__s2();
						edge_explorer_19 = new CachedEdgeExplorer(this, 9, 4, edge_explorer_19_methods);
			...
			case "Patient_object_SP2": 
				{
					...
					// p1
					HMatch match_0 = new LocalSearchMatch("NurseShiftplanRule__CONSISTENCY_129_localSearch", 10);
					match_0.getNodes()[0] = objs[0];
					start(edge_explorer_13_1_orchestration, match_0);
				}
				break;
			case "Room_object_SP0": 
				{
					...
					// ro
					HMatch match_1 = new LocalSearchMatch("NurseShiftplanRule__CONSISTENCY_129_localSearch", 10);
			...
			case "Nurse_object_SP1": 
				{
					...
					// s1
					HMatch match_2 = new LocalSearchMatch("NurseShiftplanRule__CONSISTENCY_129_localSearch", 10);
			...
			case "Patient_1_object_SP2": 
				{
					...
					// p2
					HMatch match_3 = new LocalSearchMatch("NurseShiftplanRule__CONSISTENCY_129_localSearch", 10);
			...
			case "Staff_object_SP1": 
				{
					...
					// s2
					HMatch match_4 = new LocalSearchMatch("NurseShiftplanRule__CONSISTENCY_129_localSearch", 10);
			...
			case "Shift_object_SP0": 
				{
					...
					// sh
					HMatch match_5 = new LocalSearchMatch("NurseShiftplanRule__CONSISTENCY_129_localSearch", 10);
			...
			case "Shiftplan_object_SP0": 
				{
					...
					// sp
					HMatch match_6 = new LocalSearchMatch("NurseShiftplanRule__CONSISTENCY_129_localSearch", 10);
			...
			case "PatientToPatient_object_SP0": 
				{
					...
					// pToP
					HMatch match_7 = new LocalSearchMatch("NurseShiftplanRule__CONSISTENCY_129_localSearch", 10);
			...
			case "StaffToStaff_object_SP1": 
				{
					...
					// sToS
					HMatch match_8 = new LocalSearchMatch("NurseShiftplanRule__CONSISTENCY_129_localSearch", 10);
			...
			case "NurseShiftplanRule__Marker_object": 
				{
					...
					HMatch match_9 = new LocalSearchMatch("NurseShiftplanRule__CONSISTENCY_129_localSearch", 10);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "StaffToStaff_source_Staff": 
			if(msg.target instanceof HospitalExample.Nurse) {
			{
				...
				HMatch match = new LocalSearchMatch("NurseShiftplanRule__CONSISTENCY_129_localSearch", 10);
				Object[] objs = match.getNodes();
				objs[8] = msg.source;
				objs[2] = msg.target;
				currentDepth++;
