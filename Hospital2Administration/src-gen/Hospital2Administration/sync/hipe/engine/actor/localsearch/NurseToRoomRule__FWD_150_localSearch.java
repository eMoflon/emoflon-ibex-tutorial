...
public class NurseToRoomRule__FWD_150_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						...
						edge_explorer_5 = new CachedEdgeExplorer(this, 2, 7, edge_explorer_5_methods);
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						...
						edge_explorer_8 = new EdgeExplorer(this, 0, 6, edge_explorer_8_methods);
			...
			case "Department_object_SP4": 
				{
					...
					// dep
					HMatch match_0 = new LocalSearchMatch("NurseToRoomRule__FWD_150_localSearch", 8);
			...
			case "Nurse_object_SP1": 
				{
					...
					// n
					HMatch match_1 = new LocalSearchMatch("NurseToRoomRule__FWD_150_localSearch", 8);
			...
			case "StaffToStaff_object_SP0": 
				{
					...
					// nToS
					HMatch match_2 = new LocalSearchMatch("NurseToRoomRule__FWD_150_localSearch", 8);
			...
			case "Patient_object_SP0": 
				{
					...
					// p1
					HMatch match_3 = new LocalSearchMatch("NurseToRoomRule__FWD_150_localSearch", 8);
			...
			case "Patient_1_object_SP0": 
				{
					...
					// p2
					HMatch match_4 = new LocalSearchMatch("NurseToRoomRule__FWD_150_localSearch", 8);
			...
			case "PatientToPatient_object_SP2": 
				{
					...
					// pTop
					HMatch match_5 = new LocalSearchMatch("NurseToRoomRule__FWD_150_localSearch", 8);
			...
			case "Room_object_SP2": 
				{
					...
					// r
					HMatch match_6 = new LocalSearchMatch("NurseToRoomRule__FWD_150_localSearch", 8);
			...
			case "Staff_object_SP3": 
				{
					...
					// s
					HMatch match_7 = new LocalSearchMatch("NurseToRoomRule__FWD_150_localSearch", 8);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "Staff_works_Department": 
			...
			{
				HMatch match = new LocalSearchMatch("NurseToRoomRule__FWD_150_localSearch", 8);
				Object[] objs = match.getNodes();
				objs[1] = msg.source;
				objs[0] = msg.target;
				currentDepth++;
