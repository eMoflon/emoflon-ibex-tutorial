...
public class NurseToStaffRule__CONSISTENCY_186_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> ((Hospital2Administration.NurseToStaffRule__Marker) o).getCREATE__TRG__sp();
						edge_explorer = new CachedEdgeExplorer(this, 9, 5, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> ((Hospital2Administration.NurseToStaffRule__Marker) o).getCONTEXT__SRC__d();
						edge_explorer_3 = new CachedEdgeExplorer(this, 9, 0, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> ((Hospital2Administration.NurseToStaffRule__Marker) o).getCREATE__CORR__stot();
						edge_explorer_4 = new CachedEdgeExplorer(this, 9, 8, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> ((Hospital2Administration.StaffToStaff) o).getTarget();
						edge_explorer_5 = new CachedEdgeExplorer(this, 8, 3, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.multi_lookup = (o) -> ((AdministrationExample.Shiftplan) o).getShifts();
						edge_explorer_6_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof AdministrationExample.Shiftplan) return edge_explorer_6_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
						edge_explorer_6 = new EdgeExplorer(this, 5, 4, edge_explorer_6_methods);
		name2explorer.put("edge_explorer_6", edge_explorer_6);
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.multi_lookup = (o) -> ((HospitalExample.Hospital) o).getStaff().stream().filter(obj -> obj instanceof HospitalExample.Nurse).collect(Collectors.toList());
						edge_explorer_7_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof HospitalExample.Hospital) return edge_explorer_7_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
						edge_explorer_7 = new EdgeExplorer(this, 1, 2, edge_explorer_7_methods);
		name2explorer.put("edge_explorer_7", edge_explorer_7);
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> ((Hospital2Administration.NurseToStaffRule__Marker) o).getCONTEXT__SRC__h();
						edge_explorer_8 = new CachedEdgeExplorer(this, 9, 1, edge_explorer_8_methods);
		name2explorer.put("edge_explorer_8", edge_explorer_8);
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> ((Hospital2Administration.NurseToStaffRule__Marker) o).getCREATE__TRG__sh();
						edge_explorer_9 = new CachedEdgeExplorer(this, 9, 4, edge_explorer_9_methods);
		name2explorer.put("edge_explorer_9", edge_explorer_9);
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> ((HospitalExample.Staff) o).getWorks();
						edge_explorer_10_methods.multi_opposite_lookup = (o) -> ((HospitalExample.Department) o).getStaff().stream().filter(obj -> obj instanceof HospitalExample.Nurse).collect(Collectors.toList());
						edge_explorer_10 = new EdgeExplorer(this, 2, 0, edge_explorer_10_methods);
		name2explorer.put("edge_explorer_10", edge_explorer_10);
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.multi_lookup = (o) -> ((AdministrationExample.Administration) o).getStaff();
						edge_explorer_11_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof AdministrationExample.Administration) return edge_explorer_11_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
						edge_explorer_11 = new EdgeExplorer(this, 6, 3, edge_explorer_11_methods);
		name2explorer.put("edge_explorer_11", edge_explorer_11);
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> ((AdministrationExample.Staff) o).getShiftPlan();
						edge_explorer_12_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof AdministrationExample.Staff) return o.equals(edge_explorer_12_methods.unique_lookup.apply(result)) ? result : null; else return null;};
						edge_explorer_12 = new EdgeExplorer(this, 3, 5, edge_explorer_12_methods);
		name2explorer.put("edge_explorer_12", edge_explorer_12);
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> ((Hospital2Administration.NurseToStaffRule__Marker) o).getCREATE__TRG__s2();
						edge_explorer_13 = new CachedEdgeExplorer(this, 9, 3, edge_explorer_13_methods);
		name2explorer.put("edge_explorer_13", edge_explorer_13);
		EdgeLookupMethods edge_explorer_14_methods = new EdgeLookupMethods();
						edge_explorer_14_methods.unique_lookup = (o) -> ((Hospital2Administration.NurseToStaffRule__Marker) o).getCONTEXT__CORR__htov();
						edge_explorer_14 = new CachedEdgeExplorer(this, 9, 7, edge_explorer_14_methods);
		...
		EdgeLookupMethods edge_explorer_15_methods = new EdgeLookupMethods();
						...
						edge_explorer_15 = new CachedEdgeExplorer(this, 7, 1, edge_explorer_15_methods);
		...
		EdgeLookupMethods edge_explorer_16_methods = new EdgeLookupMethods();
						...
						edge_explorer_16 = new CachedEdgeExplorer(this, 8, 2, edge_explorer_16_methods);
		name2explorer.put("edge_explorer_16", edge_explorer_16);
		EdgeLookupMethods edge_explorer_17_methods = new EdgeLookupMethods();
						edge_explorer_17_methods.unique_lookup = (o) -> ((Hospital2Administration.NurseToStaffRule__Marker) o).getCONTEXT__TRG__v();
						edge_explorer_17 = new CachedEdgeExplorer(this, 9, 6, edge_explorer_17_methods);
		name2explorer.put("edge_explorer_17", edge_explorer_17);
		EdgeLookupMethods edge_explorer_18_methods = new EdgeLookupMethods();
						edge_explorer_18_methods.unique_lookup = (o) -> ((Hospital2Administration.NurseToStaffRule__Marker) o).getCREATE__SRC__s1();
						edge_explorer_18 = new CachedEdgeExplorer(this, 9, 2, edge_explorer_18_methods);
		name2explorer.put("edge_explorer_18", edge_explorer_18);
		EdgeLookupMethods edge_explorer_19_methods = new EdgeLookupMethods();
						edge_explorer_19_methods.unique_lookup = (o) -> ((Hospital2Administration.HospitalToAdministration) o).getTarget();
						edge_explorer_19 = new CachedEdgeExplorer(this, 7, 6, edge_explorer_19_methods);
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("NurseToStaffRule__CONSISTENCY_production"), this::returnTrue , 0  , false ));
	}
			...
			case "Department_object_SP1": 
				{
					...
					// d
					HMatch match_0 = new LocalSearchMatch("NurseToStaffRule__CONSISTENCY_186_localSearch", 10);
			...
			case "Hospital_object_SP0": 
				{
					...
					// h
					HMatch match_1 = new LocalSearchMatch("NurseToStaffRule__CONSISTENCY_186_localSearch", 10);
			...
			case "Nurse_object_SP0": 
				{
					...
					// s1
					HMatch match_2 = new LocalSearchMatch("NurseToStaffRule__CONSISTENCY_186_localSearch", 10);
					match_2.getNodes()[2] = objs[0];
					start(edge_explorer_7_2_orchestration, match_2);
				}
				break;
			case "Staff_object_SP2": 
				{
					...
					// s2
					HMatch match_3 = new LocalSearchMatch("NurseToStaffRule__CONSISTENCY_186_localSearch", 10);
			...
			case "Shift_object_SP2": 
				{
					...
					// sh
					HMatch match_4 = new LocalSearchMatch("NurseToStaffRule__CONSISTENCY_186_localSearch", 10);
			...
			case "Shiftplan_object_SP0": 
				{
					...
					// sp
					HMatch match_5 = new LocalSearchMatch("NurseToStaffRule__CONSISTENCY_186_localSearch", 10);
					match_5.getNodes()[5] = objs[0];
					start(edge_explorer_2_orchestration, match_5);
				}
				break;
			case "Administration_object_SP3": 
				{
					
					// v
					HMatch match_6 = new LocalSearchMatch("NurseToStaffRule__CONSISTENCY_186_localSearch", 10);
					match_6.getNodes()[6] = objs[0];
					start(edge_explorer_11_1_orchestration, match_6);
				}
				break;
			case "HospitalToAdministration_object_SP1": 
				{
					edge_explorer_15.registerSourceObject(objs[0]);
					edge_explorer_19.registerSourceObject(objs[0]);
					
					// htov
					HMatch match_7 = new LocalSearchMatch("NurseToStaffRule__CONSISTENCY_186_localSearch", 10);
			...
			case "StaffToStaff_object_SP1": 
				{
					...
					// stot
					HMatch match_8 = new LocalSearchMatch("NurseToStaffRule__CONSISTENCY_186_localSearch", 10);
					match_8.getNodes()[8] = objs[0];
					start(edge_explorer_4_1_orchestration, match_8);
				}
				break;
			case "NurseToStaffRule__Marker_object": 
				{
					...
					// NurseToStaffRule_eMoflon_ProtocolNode
					HMatch match_9 = new LocalSearchMatch("NurseToStaffRule__CONSISTENCY_186_localSearch", 10);
					match_9.getNodes()[9] = objs[0];
					start(edge_explorer_1_orchestration, match_9);
				}
				break;
			case "NurseToStaffRule_s2_shiftPlan_outgoing_TRG__FILTER_NAC_TRG_159_localSearch": 
				{
				...
				break;
			case "NurseToStaffRule_sp_shifts_outgoing_TRG__FILTER_NAC_TRG_163_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "NurseToStaffRule_s2_shiftPlan_outgoing_TRG__FILTER_NAC_TRG_159_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("NurseToStaffRule__CONSISTENCY_186_localSearch", 10);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
			...
			case "NurseToStaffRule_sp_shifts_outgoing_TRG__FILTER_NAC_TRG_163_localSearch": 
				if(nac_checker_0.deregister(match)) {
					HMatch acMatch_1 = new LocalSearchMatch("NurseToStaffRule__CONSISTENCY_186_localSearch", 10);
					Object[] acMatch_nodes_1 = acMatch_1.getNodes();
	...
	protected void addReference(ReferenceAdded msg) {
		...
		switch(msg.refName) {
		case "NurseToStaffRule__Marker_CREATE__TRG__sp_Shiftplan": 
			{
				edge_explorer.registerEdge(msg.source, msg.target);
				HMatch match = new LocalSearchMatch("NurseToStaffRule__CONSISTENCY_186_localSearch", 10);
				Object[] objs = match.getNodes();
				objs[9] = msg.source;
				objs[5] = msg.target;
				currentDepth++;
			...
			break;
		case "NurseToStaffRule__Marker_CONTEXT__SRC__d_Department": 
			{
			...
			break;
		case "NurseToStaffRule__Marker_CREATE__CORR__stot_StaffToStaff": 
			{
		...
		case "Hospital_staff_Staff": 
			...
			break;
		case "NurseToStaffRule__Marker_CONTEXT__SRC__h_Hospital": 
			{
			...
			break;
		case "NurseToStaffRule__Marker_CREATE__TRG__sh_Shift": 
			{
		...
		case "Staff_shiftPlan_Shiftplan": 
			...
			break;
		case "NurseToStaffRule__Marker_CREATE__TRG__s2_Staff": 
			{
			...
			break;
		case "NurseToStaffRule__Marker_CONTEXT__CORR__htov_HospitalToAdministration": 
			{
		...
		case "StaffToStaff_source_Staff": 
			...
			break;
		case "NurseToStaffRule__Marker_CONTEXT__TRG__v_Administration": 
			{
			...
			break;
		case "NurseToStaffRule__Marker_CREATE__SRC__s1_Nurse": 
			{
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register NurseToStaffRule_s2_shiftPlan_outgoing_TRG__FILTER_NAC_TRG
		...
		// register NurseToStaffRule_sp_shifts_outgoing_TRG__FILTER_NAC_TRG
		...
		// register NurseToStaffRule_eMoflon_ProtocolNode
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister NurseToStaffRule_s2_shiftPlan_outgoing_TRG__FILTER_NAC_TRG
		OverlapMatch oMatch_0 = new OverlapMatch(2);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[3];
		oMatch_Nodes_0[1] = objs[5];
		...
		// deregister NurseToStaffRule_sp_shifts_outgoing_TRG__FILTER_NAC_TRG
		OverlapMatch oMatch_1 = new OverlapMatch(2);
		Object[] oMatch_Nodes_1 = oMatch_1.getNodes();
		oMatch_Nodes_1[0] = objs[4];
		oMatch_Nodes_1[1] = objs[5];
		...
		// deregister NurseToStaffRule_eMoflon_ProtocolNode
		Collection<HMatch> matches_9 = obj2matches.get(objs[9]);
		if(matches_9 != null) {
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof HospitalExample.Nurse) {
			HMatch match_2 = new LocalSearchMatch("NurseToStaffRule__CONSISTENCY_186_localSearch", 10);
			match_2.getNodes()[2] = obj;
			Collection<HMatch> formerMatches_2 = obj2matches.get(obj);
			if(formerMatches_2 != null) {
				
				formerMatches_2 = formerMatches_2.stream().filter(m -> !constraint_checker_0.check(m) || !constraint_checker_1.check(m)).collect(Collectors.toList());
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_14.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, d.getDID(), "int"));
		csp_14.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, s2.getDInt(), "int"));
		csp_14.solve();
	...
	public boolean constraint_checker_0_method(HMatch match) {
		HospitalExample.Nurse s1 = (HospitalExample.Nurse) match.getNodes()[2];
		AdministrationExample.Staff s2 = (AdministrationExample.Staff) match.getNodes()[3];
		
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_incrementingStaffID csp_15 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_incrementingStaffID();
		csp_15.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, s1.getStaffID(), "int"));
		csp_15.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, s2.getStaffID(), "int"));
		csp_15.solve();
	...
	public boolean constraint_checker_1_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_nametoname csp_16 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_nametoname();
		csp_16.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, " ", "java.lang.String"));
		csp_16.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, s2.getFirstName(), "java.lang.String"));
		csp_16.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, s2.getLastName(), "java.lang.String"));
		csp_16.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, s1.getName(), "java.lang.String"));
		csp_16.solve();
	...
	public boolean constraint_checker_2_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_nursesalary csp_17 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_nursesalary();
		csp_17.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, s2.getSalary(), "double"));
		csp_17.solve();
