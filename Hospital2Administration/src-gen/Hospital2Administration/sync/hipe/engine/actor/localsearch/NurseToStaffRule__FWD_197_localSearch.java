...
public class NurseToStaffRule__FWD_197_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						...
						edge_explorer_3_methods.multi_opposite_lookup = (o) -> ((HospitalExample.Department) o).getStaff().stream().filter(obj -> obj instanceof HospitalExample.Nurse).collect(Collectors.toList());
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.multi_lookup = (o) -> ((HospitalExample.Hospital) o).getStaff().stream().filter(obj -> obj instanceof HospitalExample.Nurse).collect(Collectors.toList());
						edge_explorer_5_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof HospitalExample.Hospital) return edge_explorer_5_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
						edge_explorer_5 = new EdgeExplorer(this, 1, 4, edge_explorer_5_methods);
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("NurseToStaffRule__FWD_production"), this::returnTrue  , false ));
	}
			...
			case "Department_object_SP2": 
				{
					...
					// d
					HMatch match_0 = new LocalSearchMatch("NurseToStaffRule__FWD_197_localSearch", 5);
			...
			case "Hospital_object_SP1": 
				{
					...
					// h
					HMatch match_1 = new LocalSearchMatch("NurseToStaffRule__FWD_197_localSearch", 5);
			...
			case "HospitalToAdministration_object_SP2": 
				{
					...
					// htov
					HMatch match_2 = new LocalSearchMatch("NurseToStaffRule__FWD_197_localSearch", 5);
			...
			case "Administration_object_SP0": 
				{
					...
					// v
					HMatch match_3 = new LocalSearchMatch("NurseToStaffRule__FWD_197_localSearch", 5);
			...
			case "Nurse_object_SP1": 
				{
					...
					// s1
					HMatch match_4 = new LocalSearchMatch("NurseToStaffRule__FWD_197_localSearch", 5);
		...
		case "HospitalToAdministration_source_Hospital": 
			{
				...
				HMatch match = new LocalSearchMatch("NurseToStaffRule__FWD_197_localSearch", 5);
				Object[] objs = match.getNodes();
				objs[2] = msg.source;
				objs[1] = msg.target;
				currentDepth++;
