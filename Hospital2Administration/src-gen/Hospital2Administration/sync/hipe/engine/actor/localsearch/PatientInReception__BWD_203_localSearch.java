...
public class PatientInReception__BWD_203_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						...
						edge_explorer_3 = new EdgeExplorer(this, 3, 4, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> ((HospitalExample.Hospital) o).getReception();
						edge_explorer_4_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof HospitalExample.Hospital) return o.equals(edge_explorer_4_methods.unique_lookup.apply(result)) ? result : null; else return null;};
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("PatientInReception__BWD_production"), this::returnTrue  , false ));
	}
			...
			case "Hospital_object_SP2": 
				{
					...
					// h
					HMatch match_0 = new LocalSearchMatch("PatientInReception__BWD_203_localSearch", 5);
			...
			case "HospitalToAdministration_object_SP3": 
				{
					...
					// htov
					HMatch match_1 = new LocalSearchMatch("PatientInReception__BWD_203_localSearch", 5);
			...
			case "Reception_object_SP1": 
				{
					...
					// r
					HMatch match_2 = new LocalSearchMatch("PatientInReception__BWD_203_localSearch", 5);
			...
			case "Administration_object_SP1": 
				{
					...
					// v
					HMatch match_3 = new LocalSearchMatch("PatientInReception__BWD_203_localSearch", 5);
			...
			case "Patient_1_object_SP1": 
				{
					...
					// p2
					HMatch match_4 = new LocalSearchMatch("PatientInReception__BWD_203_localSearch", 5);
		...
		case "HospitalToAdministration_target_Administration": 
			{
				...
				HMatch match = new LocalSearchMatch("PatientInReception__BWD_203_localSearch", 5);
				Object[] objs = match.getNodes();
				objs[1] = msg.source;
				objs[3] = msg.target;
				currentDepth++;
