...
public class PatientInReception__FWD_221_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("PatientInReception__FWD_production"), this::returnTrue  , false ));
	}
			...
			case "Hospital_object_SP0": 
				{
					...
					// h
					HMatch match_0 = new LocalSearchMatch("PatientInReception__FWD_221_localSearch", 5);
			...
			case "HospitalToAdministration_object_SP1": 
				{
					...
					// htov
					HMatch match_1 = new LocalSearchMatch("PatientInReception__FWD_221_localSearch", 5);
			...
			case "Reception_object_SP1": 
				{
					...
					// r
					HMatch match_2 = new LocalSearchMatch("PatientInReception__FWD_221_localSearch", 5);
			...
			case "Administration_object_SP3": 
				{
					...
					// v
					HMatch match_3 = new LocalSearchMatch("PatientInReception__FWD_221_localSearch", 5);
			...
			case "Patient_object_SP3": 
				{
					...
					// p1
					HMatch match_4 = new LocalSearchMatch("PatientInReception__FWD_221_localSearch", 5);
		...
		switch(match.creator) {
			...
			case "PatientInReception_p1_lies_incoming_SRC__FILTER_NAC_SRC_209_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("PatientInReception__FWD_221_localSearch", 5);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "Reception_waits_Patient": 
			{
				HMatch match = new LocalSearchMatch("PatientInReception__FWD_221_localSearch", 5);
				Object[] objs = match.getNodes();
				objs[2] = msg.source;
				objs[4] = msg.target;
				currentDepth++;
