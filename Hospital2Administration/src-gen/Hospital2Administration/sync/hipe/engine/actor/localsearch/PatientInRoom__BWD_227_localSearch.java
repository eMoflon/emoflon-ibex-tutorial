...
public class PatientInRoom__BWD_227_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						...
						edge_explorer = new EdgeExplorer(this, 4, 5, edge_explorer_methods);
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						...
						edge_explorer_3 = new CachedEdgeExplorer(this, 2, 4, edge_explorer_3_methods);
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("PatientInRoom__BWD_production"), this::returnTrue  , false ));
	}
			...
			case "Department_object_SP3": 
				{
					...
					// d
					HMatch match_0 = new LocalSearchMatch("PatientInRoom__BWD_227_localSearch", 6);
			...
			case "Hospital_object_SP1": 
				{
					...
					// h
					HMatch match_1 = new LocalSearchMatch("PatientInRoom__BWD_227_localSearch", 6);
			...
			case "HospitalToAdministration_object_SP2": 
				{
					...
					// htov
					HMatch match_2 = new LocalSearchMatch("PatientInRoom__BWD_227_localSearch", 6);
			...
			case "Room_object_SP0": 
				{
					...
					// ro
					HMatch match_3 = new LocalSearchMatch("PatientInRoom__BWD_227_localSearch", 6);
			...
			case "Administration_object_SP0": 
				{
					...
					// v
					HMatch match_4 = new LocalSearchMatch("PatientInRoom__BWD_227_localSearch", 6);
			...
			case "Patient_1_object_SP3": 
				{
					...
					// p2
					HMatch match_5 = new LocalSearchMatch("PatientInRoom__BWD_227_localSearch", 6);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "Administration_patient_Patient": 
			{
				HMatch match = new LocalSearchMatch("PatientInRoom__BWD_227_localSearch", 6);
				Object[] objs = match.getNodes();
				objs[4] = msg.source;
				objs[5] = msg.target;
				currentDepth++;
