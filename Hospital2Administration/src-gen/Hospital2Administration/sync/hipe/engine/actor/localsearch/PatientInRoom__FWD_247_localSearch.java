...
public class PatientInRoom__FWD_247_localSearch extends GenericLocalSearchActor{
			...
			case "Department_object_SP0": 
				{
					...
					// d
					HMatch match_0 = new LocalSearchMatch("PatientInRoom__FWD_247_localSearch", 6);
			...
			case "Hospital_object_SP3": 
				{
					...
					// h
					HMatch match_1 = new LocalSearchMatch("PatientInRoom__FWD_247_localSearch", 6);
			...
			case "HospitalToAdministration_object_SP0": 
				{
					...
					// htov
					HMatch match_2 = new LocalSearchMatch("PatientInRoom__FWD_247_localSearch", 6);
			...
			case "Room_object_SP2": 
				{
					...
					// ro
					HMatch match_3 = new LocalSearchMatch("PatientInRoom__FWD_247_localSearch", 6);
			...
			case "Administration_object_SP2": 
				{
					...
					// v
					HMatch match_4 = new LocalSearchMatch("PatientInRoom__FWD_247_localSearch", 6);
			...
			case "Patient_object_SP2": 
				{
					...
					// p1
					HMatch match_5 = new LocalSearchMatch("PatientInRoom__FWD_247_localSearch", 6);
		...
		switch(match.creator) {
			...
			case "PatientInRoom_p1_waits_incoming_SRC__FILTER_NAC_SRC_234_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("PatientInRoom__FWD_247_localSearch", 6);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
		...
		case "HospitalToAdministration_target_Administration": 
			{
				...
				HMatch match = new LocalSearchMatch("PatientInRoom__FWD_247_localSearch", 6);
				Object[] objs = match.getNodes();
				objs[2] = msg.source;
				objs[4] = msg.target;
				currentDepth++;
