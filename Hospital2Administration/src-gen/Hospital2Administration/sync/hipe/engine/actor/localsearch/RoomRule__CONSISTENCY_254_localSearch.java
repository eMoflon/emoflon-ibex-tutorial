...
public class RoomRule__CONSISTENCY_254_localSearch extends GenericLocalSearchActor{
			...
			case "Department_object_SP1": 
				{
					...
					// d
					HMatch match_0 = new LocalSearchMatch("RoomRule__CONSISTENCY_254_localSearch", 3);
			...
			case "Room_object_SP3": 
				{
					...
					// ro
					HMatch match_1 = new LocalSearchMatch("RoomRule__CONSISTENCY_254_localSearch", 3);
			...
			case "RoomRule__Marker_object": 
				{
					...
					HMatch match_2 = new LocalSearchMatch("RoomRule__CONSISTENCY_254_localSearch", 3);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "Department_rooms_Room": 
			{
				HMatch match = new LocalSearchMatch("RoomRule__CONSISTENCY_254_localSearch", 3);
				Object[] objs = match.getNodes();
				objs[0] = msg.source;
				objs[1] = msg.target;
				currentDepth++;
