...
public class UserDefined_incrementingID extends RuntimeTGGAttributeConstraint {
	private static int idIncrement = 1;

	/**
	 * Constraint incrementingID(v0)
	 * 
	...
	public void solve() {
		if (variables.size() != 1)
			throw new RuntimeException("The CSP -INCREMENTINGID- needs exactly 1 variables");
