...
public class UserDefined_setDefaultID extends RuntimeTGGAttributeConstraint
{

   /**
    * Constraint setDefaultID(v0, v1)
    * 
    ...
    */
	...
	public void solve() {
		if (variables.size() != 2)
			throw new RuntimeException("The CSP -SETDEFAULTID- needs exactly 2 variables");
