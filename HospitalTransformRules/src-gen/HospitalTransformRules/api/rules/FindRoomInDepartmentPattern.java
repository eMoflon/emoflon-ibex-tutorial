...
/**
 * The pattern [org.emoflon.ibex.patternmodel.IBeXPatternModel.impl.IBeXNodeImpl@4cfe582 (name: department), org.emoflon.ibex.patternmodel.IBeXPatternModel.impl.IBeXNodeImpl@53a71563 (name: otherroom)] which does the following:
...
public class FindRoomInDepartmentPattern extends GraphTransformationPattern<FindRoomInDepartmentMatch, FindRoomInDepartmentPattern> {
	...
	public String toString() {
		...
		s += "	otherroom --> " + parameters.get("otherroom") + System.lineSeparator();
		s += "}";
		return s;
	}
}
